...
_delay:
; 2 exit points
	.line	282, "main.c"; 	void delay(u16t time)
	BANKSEL	r0x1011
	MOVAR	r0x1011
	MOVR	STK00,W
	BANKSEL	r0x1012
	MOVAR	r0x1012
	.line	284, "main.c"; 	for(u16t i=0;i<time;i++);
	BANKSEL	r0x1013
	CLRR	r0x1013
	BANKSEL	r0x1014
	CLRR	r0x1014
...
_checkLVD:
; 0 exit points
	.line	266, "main.c"; 	PCON1 = C_LVD_2P4V | C_TMR0_En;
	MOVIA	0x09
	IOST	_PCON1
	.line	267, "main.c"; 	delay(80);
	MOVIA	0x50
	MOVAR	STK00
	MOVIA	0x00
	LCALL	_delay
	.line	269, "main.c"; 	if((PCON1 >> 6)&1)
	IOSTR	_PCON1
;;1	MOVAR	r0x1015
	ANDIA	0x40
	BTRSS	STATUS,2
	...
	BTRSC	STATUS,2
	LGOTO	_00261_DS_
	.line	271, "main.c"; 	lvdTime = 0;
	BANKSEL	_lvdTime
	CLRR	_lvdTime
	LGOTO	_00263_DS_
_00261_DS_:
	.line	275, "main.c"; 	if(workStep && duty > 10)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSC	STATUS,2
	LGOTO	_00256_DS_
...
;;shiftRight_Left2ResultLit:5589: shCount=1, size=1, sign=0, same=1, offr=0
	.line	276, "main.c"; 	duty = duty/2;
	BCR	STATUS,0
	RRR	_duty,F
_00256_DS_:
	.line	277, "main.c"; 	if(++lvdTime >= 20)
	BANKSEL	_lvdTime
	INCR	_lvdTime,F
...
; 2 exit points
	...
	BANKSEL	_workStep
	CLRR	_workStep
	.line	247, "main.c"; 	pwmOFF();
	LCALL	_pwmOFF
	.line	248, "main.c"; 	LAOFF();
	MOVIA	0xe3
	ANDAR	_PORTA,F
	.line	249, "main.c"; 	LBOFF();
	MOVIA	0xf8
	ANDAR	_PORTB,F
	.line	250, "main.c"; 	PB5OFF();
	BCR	_PORTB,5
	.line	251, "main.c"; 	AWUCON = 0x01;
	MOVIA	0x01
	MOVAR	_AWUCON
	.line	252, "main.c"; 	INTE =  C_INT_PABKey;
	MOVIA	0x02
	MOVAR	_INTE
	.line	253, "main.c"; 	PCON =  C_LVR_En;	
	MOVIA	0x08
	MOVAR	_PCON
	.line	254, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	255, "main.c"; 	CLRWDT();
	clrwdt
	.line	256, "main.c"; 	SLEEP();
	sleep
	.line	257, "main.c"; 	INTE =  C_INT_TMR0;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x01
	MOVAR	_INTE
	.line	258, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	260, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En;				// Enable WDT ,  Enable LVR
	MOVIA	0xa8
	MOVAR	_PCON
	.line	261, "main.c"; 	}
	RETURN	
...
_keyCtr:
; 0 exit points
	.line	229, "main.c"; 	char kclick = keyRead(0x01 & (~PORTA));
	COMR	_PORTA,W
	BANKSEL	r0x1018
	MOVAR	r0x1018
	MOVIA	0x01
	...
	BANKSEL	r0x1018
	MOVAR	r0x1018
	.line	230, "main.c"; 	if(kclick == 1)
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00244_DS_
	.line	232, "main.c"; 	if(++workStep >= 7)
	BANKSEL	_workStep
	INCR	_workStep,F
;;unsigned compare: left < lit (0x7=7), size=1
	...
	LGOTO	_00002_DS_
_00244_DS_:
	.line	235, "main.c"; 	else if(kclick == 2)
	BANKSEL	r0x1018
	MOVR	r0x1018,W
	XORIA	0x02
	BTRSS	STATUS,2
...
_keyRead:
; 2 exit points
	.line	193, "main.c"; 	char keyRead(char KeyStatus)	
	BANKSEL	r0x1017
	MOVAR	r0x1017
	...
	BTRSC	STATUS,2
	LGOTO	_00213_DS_
	.line	197, "main.c"; 	if(++keyCount >= 200)
	BANKSEL	_keyCount
	INCR	_keyCount,F
	BTRSC	STATUS,2
	INCR	(_keyCount + 1),F
...
_00232_DS_:
	BTRSS	STATUS,0
	LGOTO	_00214_DS_
	.line	199, "main.c"; 	keyCount = 200;
	MOVIA	0xc8
	BANKSEL	_keyCount
	MOVAR	_keyCount
	CLRR	(_keyCount + 1)
	.line	200, "main.c"; 	if(!longPressFlag)
	BANKSEL	_longPressFlag
	MOVR	_longPressFlag,W
	BTRSS	STATUS,2
	LGOTO	_00214_DS_
	.line	202, "main.c"; 	longPressFlag = 1;
	MOVIA	0x01
	MOVAR	_longPressFlag
	.line	203, "main.c"; 	return 2;
	MOVIA	0x02
	LGOTO	_00215_DS_
;;unsigned compare: left < lit (0xC8=200), size=2
_00213_DS_:
	.line	210, "main.c"; 	if(keyCount >= 200)
	MOVIA	0x00
	BANKSEL	_keyCount
	SUBAR	(_keyCount + 1),W
	BTRSS	STATUS,2
...
_00233_DS_:
	BTRSS	STATUS,0
	LGOTO	_00210_DS_
	.line	212, "main.c"; 	keyCount = 0;
	BANKSEL	_keyCount
	CLRR	_keyCount
	CLRR	(_keyCount + 1)
	.line	213, "main.c"; 	longPressFlag = 0;
	BANKSEL	_longPressFlag
	CLRR	_longPressFlag
	.line	214, "main.c"; 	return	0;
	MOVIA	0x00
	LGOTO	_00215_DS_
;;unsigned compare: left < lit (0x8=8), size=2
_00210_DS_:
	.line	216, "main.c"; 	else if(keyCount >= 8)
	MOVIA	0x00
	BANKSEL	_keyCount
	SUBAR	(_keyCount + 1),W
	BTRSS	STATUS,2
...
_pwmOFF:
; 2 exit points
	.line	188, "main.c"; 	PWM4DUTY = 0;
	CLRA	
	SFUN	_PWM4DUTY
	.line	189, "main.c"; 	P4CR1 = 0x00;
	SFUN	_P4CR1
	.line	190, "main.c"; 	T3CR1 = 0x00;
	SFUN	_T3CR1
	.line	191, "main.c"; 	}
	RETURN	
...
_pwmOn:
; 2 exit points
	.line	175, "main.c"; 	PWM4DUTY = duty;				// 		频率为40K
	BANKSEL	_duty
	MOVR	_duty,W
	SFUN	_PWM4DUTY
	.line	176, "main.c"; 	if(P4CR1 & 0x80)
	SFUNR	_P4CR1
	BANKSEL	r0x1019
	MOVAR	r0x1019
	BTRSC	r0x1019,7
	.line	177, "main.c"; 	return;
	LGOTO	_00194_DS_
	.line	178, "main.c"; 	TM34RH = 0x00;
	CLRR	_TM34RH
	.line	179, "main.c"; 	TMR3 = 50;
	MOVIA	0x32
	SFUN	_TMR3
	.line	180, "main.c"; 	T3CR2 = 0x00;
	CLRA	
	SFUN	_T3CR2
	.line	181, "main.c"; 	T3CR1 =  C_TMR3_Reload | C_TMR3_En;
	MOVIA	0x03
	SFUN	_T3CR1
	.line	182, "main.c"; 	P4CR1 = C_PWM4_En | C_TMR3_Reload | C_TMR3_En;
	MOVIA	0x83
	SFUN	_P4CR1
_00194_DS_:
	.line	183, "main.c"; 	}
...
_00155_DS_:
	...
	INCR	_duty,F
	.line	164, "main.c"; 	if(duty < 30)
	MOVIA	0x1e
	SUBAR	_duty,W
	BTRSC	STATUS,0
	LGOTO	_00159_DS_
	.line	165, "main.c"; 	duty = 30;
	MOVIA	0x1e
	MOVAR	_duty
;;unsigned compare: left < lit (0x384=900), size=2
_00159_DS_:
	.line	167, "main.c"; 	if(count900s >= 900 && keyCount == 0)
	MOVIA	0x03
	BANKSEL	_count900s
...
;	  350+   61 =   411 instructions (  944 byte)
