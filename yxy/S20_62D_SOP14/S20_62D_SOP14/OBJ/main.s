...
; 2 exit points
_00572_DS_:
	.line	675, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	MGOTO	_00572_DS_
	.line	677, "main.c"; 	}
	RETURN	
...
_F_AIN3_Convert:
; 2 exit points
	.line	658, "main.c"; 	void F_AIN3_Convert(char count)
	BANKSEL	r0x1028
	MOVAR	r0x1028
	.line	660, "main.c"; 	R_AIN3_DATA=R_AIN3_DATA_LB=0x00;   
	BANKSEL	_R_AIN3_DATA_LB
	CLRR	_R_AIN3_DATA_LB
	BANKSEL	_R_AIN3_DATA
	CLRR	_R_AIN3_DATA
	CLRR	(_R_AIN3_DATA + 1)
	.line	662, "main.c"; 	ADMD  = 0x90 | C_ADC_PA3;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x93
	MOVAR	_ADMD
	.line	663, "main.c"; 	delay(200);	
	MOVIA	0xc8
	MCALL	_delay
...
_00565_DS_:
	...
	BTRSS	STATUS,0
	MGOTO	_00567_DS_
	.line	666, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	667, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete
	MCALL	_F_wait_eoc
	.line	668, "main.c"; 	R_AIN3_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x102A
	BANKSEL	_R_AIN3_DATA_LB
	ADDAR	_R_AIN3_DATA_LB,F
	.line	669, "main.c"; 	R_AIN3_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x102A
	MOVAR	r0x102A
;;1	CLRR	r0x102B
...
_F_AIN4_Convert:
; 2 exit points
	.line	643, "main.c"; 	void F_AIN4_Convert(char count)
	BANKSEL	r0x102E
	MOVAR	r0x102E
	.line	645, "main.c"; 	R_AIN4_DATA=R_AIN4_DATA_LB=0x00;   
	BANKSEL	_R_AIN4_DATA_LB
	CLRR	_R_AIN4_DATA_LB
	BANKSEL	_R_AIN4_DATA
	CLRR	_R_AIN4_DATA
	CLRR	(_R_AIN4_DATA + 1)
	.line	647, "main.c"; 	ADMD  = 0x90 | C_ADC_PA4;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x94
	MOVAR	_ADMD
	.line	648, "main.c"; 	delay(200);	
	MOVIA	0xc8
	MCALL	_delay
	.line	649, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x102F
	MOVAR	r0x102F
_00556_DS_:
	...
	BTRSS	STATUS,0
	MGOTO	_00558_DS_
	.line	651, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	652, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete
	MCALL	_F_wait_eoc
	.line	653, "main.c"; 	R_AIN4_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x1030
	BANKSEL	_R_AIN4_DATA_LB
	ADDAR	_R_AIN4_DATA_LB,F
	.line	654, "main.c"; 	R_AIN4_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x1030
	MOVAR	r0x1030
;;1	CLRR	r0x1031
...
_checkOutA:
; 2 exit points
	.line	609, "main.c"; 	R_AIN3_DATA = R_AIN3_DATA_LB = 0x00;
	BANKSEL	_R_AIN3_DATA_LB
	CLRR	_R_AIN3_DATA_LB
	BANKSEL	_R_AIN3_DATA
	CLRR	_R_AIN3_DATA
	CLRR	(_R_AIN3_DATA + 1)
	.line	610, "main.c"; 	F_AIN3_Convert(8);					// execute AIN0 ADC converting 8 times
	MOVIA	0x08
	MCALL	_F_AIN3_Convert
	.line	611, "main.c"; 	R_AIN3_DATA <<= 4;					// R_AIN0_DATA shift left 4 bit
	BANKSEL	_R_AIN3_DATA
	...
	.line	612, "main.c"; 	R_AIN3_DATA_LB &= 0xF0;				// Only get Bit7~4
	MOVIA	0xf0
	BANKSEL	_R_AIN3_DATA_LB
	ANDAR	_R_AIN3_DATA_LB,F
	.line	613, "main.c"; 	R_AIN3_DATA += R_AIN4_DATA_LB;		// R_AIN0_DATA + R_AIN0_DATA_LB
	BANKSEL	_R_AIN4_DATA_LB
...
_00003_DS_:
	.line	614, "main.c"; 	R_AIN3_DATA >>=3;					// R_AIN0_DATA divided 8
	BCR	STATUS,0
	BANKSEL	_R_AIN3_DATA
...
;;shiftRight_Left2ResultLit:5590: shCount=1, size=2, sign=0, same=1, offr=0
	...
	RRR	(_R_AIN3_DATA + 1),F
	RRR	_R_AIN3_DATA,F
	.line	615, "main.c"; 	if(debug)
	BANKSEL	_debug
	MOVR	_debug,W
	BTRSC	STATUS,2
	MGOTO	_00522_DS_
	.line	616, "main.c"; 	R_AIN3_DATA = OUTA;
	MOVIA	0x2d
	BANKSEL	_R_AIN3_DATA
	MOVAR	_R_AIN3_DATA
	MOVIA	0x01
...
_00522_DS_:
	.line	617, "main.c"; 	if(R_AIN3_DATA > 640)
	MOVIA	0x02
	BANKSEL	_R_AIN3_DATA
...
_00549_DS_:
	BTRSS	STATUS,0
	MGOTO	_00530_DS_
	.line	619, "main.c"; 	if(++overCount > 10)
	BANKSEL	_overCount
	INCR	_overCount,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0xB=11), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00532_DS_
	.line	621, "main.c"; 	overCount = 10;
	MOVIA	0x0a
	MOVAR	_overCount
	.line	622, "main.c"; 	PWM2DUTY = 128;
	MOVIA	0x80
	SFUN	_PWM2DUTY
	MGOTO	_00532_DS_
_00530_DS_:
	.line	627, "main.c"; 	if(overCount > 0)
	BANKSEL	_overCount
	MOVR	_overCount,W
	BTRSC	STATUS,2
	MGOTO	_00526_DS_
	.line	629, "main.c"; 	overCount--;
	DECR	_overCount,F
	.line	630, "main.c"; 	PWM2DUTY = maxDuty;
	BANKSEL	_maxDuty
	MOVR	_maxDuty,W
	SFUN	_PWM2DUTY
_00526_DS_:
	.line	632, "main.c"; 	if(workStep > 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSC	STATUS,2
	MGOTO	_00532_DS_
	.line	633, "main.c"; 	ledStep = workStep;
	MOVR	_workStep,W
	BANKSEL	_ledStep
	MOVAR	_ledStep
_00532_DS_:
...
_checkBatAD:
; 2 exit points
	.line	499, "main.c"; 	R_AIN4_DATA = R_AIN4_DATA_LB = 0x00;
	BANKSEL	_R_AIN4_DATA_LB
	CLRR	_R_AIN4_DATA_LB
	BANKSEL	_R_AIN4_DATA
	CLRR	_R_AIN4_DATA
	CLRR	(_R_AIN4_DATA + 1)
	.line	500, "main.c"; 	F_AIN4_Convert(8);					// execute AIN0 ADC converting 8 times
	MOVIA	0x08
	MCALL	_F_AIN4_Convert
	.line	501, "main.c"; 	R_AIN4_DATA <<= 4;					// R_AIN0_DATA shift left 4 bit
	BANKSEL	_R_AIN4_DATA
	...
	.line	502, "main.c"; 	R_AIN4_DATA_LB &= 0xF0;				// Only get Bit7~4
	MOVIA	0xf0
	BANKSEL	_R_AIN4_DATA_LB
	ANDAR	_R_AIN4_DATA_LB,F
	.line	503, "main.c"; 	R_AIN4_DATA += R_AIN4_DATA_LB;		// R_AIN0_DATA + R_AIN0_DATA_LB
	MOVR	_R_AIN4_DATA_LB,W
	BANKSEL	r0x103A
	MOVAR	r0x103A
;;1	MOVAR	r0x1038
...
;;shiftRight_Left2ResultLit:5590: shCount=1, size=2, sign=0, same=1, offr=0
_00004_DS_:
	.line	504, "main.c"; 	R_AIN4_DATA >>=3;					// R_AIN0_DATA divided 8
	BCR	STATUS,0
	BANKSEL	_R_AIN4_DATA
...
;;unsigned compare: left >= lit (0x60F=1551), size=2
	.line	505, "main.c"; 	if(R_AIN4_DATA > 1550)
	MOVIA	0x06
...
_00496_DS_:
	BTRSS	STATUS,0
	MGOTO	_00359_DS_
	.line	508, "main.c"; 	lowCount = 0;
	BANKSEL	_lowCount
	CLRR	_lowCount
	MGOTO	_00360_DS_
;;unsigned compare: left < lit (0x479=1145), size=2
_00359_DS_:
	.line	510, "main.c"; 	else if(R_AIN4_DATA < 1145)
	MOVIA	0x04
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
_00497_DS_:
	BTRSC	STATUS,0
	MGOTO	_00356_DS_
	.line	512, "main.c"; 	if(++lowCount < 10)
	BANKSEL	_lowCount
	INCR	_lowCount,F
;;unsigned compare: left < lit (0xA=10), size=1
	...
	SUBAR	_lowCount,W
	BTRSS	STATUS,0
	.line	513, "main.c"; 	return;
	MGOTO	_00410_DS_
	.line	514, "main.c"; 	lowCount = 10;
	MOVIA	0x0a
	MOVAR	_lowCount
	.line	515, "main.c"; 	pwStep = 0;
	BANKSEL	_pwStep
	CLRR	_pwStep
	.line	516, "main.c"; 	R_AIN4_DATA = 1145;
	MOVIA	0x79
	BANKSEL	_R_AIN4_DATA
	MOVAR	_R_AIN4_DATA
	MOVIA	0x04
	MOVAR	(_R_AIN4_DATA + 1)
	.line	518, "main.c"; 	if(workStep > 0 && ++firstTime == 10)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSC	STATUS,2
	MGOTO	_00351_DS_
	...
	BTRSS	STATUS,2
	MGOTO	_00351_DS_
	.line	520, "main.c"; 	shanshuoTime = 16;
	MOVIA	0x10
...
_00351_DS_:
	.line	523, "main.c"; 	if(firstTime > 11)
	MOVIA	0x0c
	BANKSEL	_firstTime
	SUBAR	_firstTime,W
	BTRSS	STATUS,0
	MGOTO	_00360_DS_
	.line	524, "main.c"; 	firstTime = 11;
	MOVIA	0x0b
	MOVAR	_firstTime
	MGOTO	_00360_DS_
_00356_DS_:
	.line	528, "main.c"; 	lowCount = 0;
	BANKSEL	_lowCount
	CLRR	_lowCount
	.line	529, "main.c"; 	firstTime = 0;
	BANKSEL	_firstTime
	CLRR	_firstTime
_00360_DS_:
	.line	531, "main.c"; 	R_AIN4_DATA = R_AIN4_DATA - 1145;
	MOVIA	0x87
	BANKSEL	_R_AIN4_DATA
	ADDAR	_R_AIN4_DATA,F
	MOVIA	0xfb
...
;;unsigned compare: left < lit (0x1A6=422), size=2
	.line	533, "main.c"; 	if(R_AIN4_DATA >= 422)
	MOVIA	0x01
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
	MGOTO	_00500_DS_
...
_00408_DS_:
	.line	537, "main.c"; 	else if(R_AIN4_DATA > 350)
	MOVIA	0x01
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
_00501_DS_:
	BTRSS	STATUS,0
	MGOTO	_00405_DS_
	.line	539, "main.c"; 	fullCount = 0;
	BANKSEL	_fullCount
	CLRR	_fullCount
;;unsigned compare: left < lit (0x4=4), size=1
	.line	540, "main.c"; 	if(pwStep < 4)
	MOVIA	0x04
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSC	STATUS,0
...
;;unsigned compare: left >= lit (0x164=356), size=2
	.line	542, "main.c"; 	if(R_AIN4_DATA > 355)
	MOVIA	0x01
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
_00503_DS_:
	BTRSS	STATUS,0
	MGOTO	_00368_DS_
	.line	543, "main.c"; 	pwStep = 4;
	MOVIA	0x04
	BANKSEL	_pwStep
	MOVAR	_pwStep
	MGOTO	_00368_DS_
_00367_DS_:
	.line	545, "main.c"; 	else if(chrgTime == 0 && R_AIN4_DATA < 396)
	BANKSEL	_chrgTime
	MOVR	_chrgTime,W
	IORAR	(_chrgTime + 1),W
	BTRSS	STATUS,2
...
_00504_DS_:
	BTRSC	STATUS,0
	MGOTO	_00368_DS_
	.line	547, "main.c"; 	pwStep = 4;
	MOVIA	0x04
	BANKSEL	_pwStep
	MOVAR	_pwStep
_00368_DS_:
	.line	551, "main.c"; 	if(chrgTime > 0 && R_AIN4_DATA > 395 && chrgTime > 600)
	BANKSEL	_chrgTime
	MOVR	_chrgTime,W
	IORAR	(_chrgTime + 1),W
	BTRSC	STATUS,2
...
_00506_DS_:
	BTRSS	STATUS,0
	MGOTO	_00410_DS_
	.line	553, "main.c"; 	chrgTime = 600;
	MOVIA	0x58
	BANKSEL	_chrgTime
	MOVAR	_chrgTime
	MOVIA	0x02
	MOVAR	(_chrgTime + 1)
	.line	554, "main.c"; 	pwStep = 5;
	MOVIA	0x05
	BANKSEL	_pwStep
	MOVAR	_pwStep
	MGOTO	_00410_DS_
...
_00405_DS_:
	.line	557, "main.c"; 	else if(R_AIN4_DATA > 200)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
;;unsigned compare: left >= lit (0xD3=211), size=2
	.line	561, "main.c"; 	if(R_AIN4_DATA > 210)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
;;unsigned compare: left < lit (0x104=260), size=2
	.line	566, "main.c"; 	if(R_AIN4_DATA < 260)
	MOVIA	0x01
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
_00510_DS_:
	BTRSC	STATUS,0
	MGOTO	_00381_DS_
	.line	567, "main.c"; 	pwStep = 3;
	MOVIA	0x03
	BANKSEL	_pwStep
	MOVAR	_pwStep
	MGOTO	_00381_DS_
_00380_DS_:
	.line	570, "main.c"; 	pwStep = 3;
	MOVIA	0x03
	BANKSEL	_pwStep
	MOVAR	_pwStep
_00381_DS_:
	.line	571, "main.c"; 	chrgTime = 0;
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
	MGOTO	_00410_DS_
...
_00402_DS_:
	.line	573, "main.c"; 	else if(R_AIN4_DATA > 100)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
;;unsigned compare: left >= lit (0x6F=111), size=2
	.line	578, "main.c"; 	if(R_AIN4_DATA > 110)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
;;unsigned compare: left < lit (0xBE=190), size=2
	.line	583, "main.c"; 	if(R_AIN4_DATA < 190)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
_00514_DS_:
	BTRSC	STATUS,0
	MGOTO	_00390_DS_
	.line	584, "main.c"; 	pwStep = 2;
	MOVIA	0x02
	BANKSEL	_pwStep
	MOVAR	_pwStep
	MGOTO	_00390_DS_
_00389_DS_:
	.line	587, "main.c"; 	pwStep = 2;
	MOVIA	0x02
	BANKSEL	_pwStep
	MOVAR	_pwStep
_00390_DS_:
	.line	588, "main.c"; 	chrgTime = 0;
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
	MGOTO	_00410_DS_
_00399_DS_:
	.line	590, "main.c"; 	else  if(R_AIN4_DATA > 0)
	BANKSEL	_R_AIN4_DATA
	MOVR	_R_AIN4_DATA,W
...
;;unsigned compare: left < lit (0x5A=90), size=2
	.line	595, "main.c"; 	if(R_AIN4_DATA < 90)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
_00516_DS_:
	BTRSC	STATUS,0
	MGOTO	_00395_DS_
	.line	596, "main.c"; 	pwStep = 1;
	MOVIA	0x01
	BANKSEL	_pwStep
	MOVAR	_pwStep
	MGOTO	_00395_DS_
_00394_DS_:
	.line	599, "main.c"; 	pwStep = 1;
	MOVIA	0x01
	BANKSEL	_pwStep
	MOVAR	_pwStep
_00395_DS_:
	.line	600, "main.c"; 	chrgTime = 0;
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
_00410_DS_:
...
_initAD:
; 2 exit points
	.line	475, "main.c"; 	ADMD  = C_ADC_En | C_ADC_CH_Dis | C_ADC_PA4 ;	// Enable ADC power, Disable global ADC input channel, Select PA0 pad as ADC input (SFR "ADMD")
	MOVIA	0x84
	MOVAR	_ADMD
	.line	480, "main.c"; 	ADVREFH = C_Vrefh_2V;					// ADC reference high voltage is supplied by internal 2V  (Note: ADC clock freq. must be equal or less than 250KHz)
	CLRR	_ADVREFH
	.line	485, "main.c"; 	ADR	  = C_Ckl_Div8;						// ADC clock=Fcpu/8, Clear ADIF, disable ADC interrupt	
	MOVIA	0x10
	MOVAR	_ADR
	.line	487, "main.c"; 	ADCR  = C_Sample_1clk | C_12BIT;
	MOVIA	0x03
	MOVAR	_ADCR
	.line	490, "main.c"; 	ADMDbits.GCHS = 1;						// Enable global ADC channel	(SFR "ADMD")
	BSR	_ADMDbits,4
	.line	491, "main.c"; 	delay(100);								// Delay 0.56ms(Instruction clock=4MHz/2T) for waiting ADC stable 
	MOVIA	0x64
	MCALL	_delay
	.line	494, "main.c"; 	}
	RETURN	
...
_delay:
; 2 exit points
	.line	465, "main.c"; 	void delay(u8t time)
	BANKSEL	r0x1026
	MOVAR	r0x1026
	.line	467, "main.c"; 	for(u8t i=0;i<time;i++)
	BANKSEL	r0x1027
	CLRR	r0x1027
_00337_DS_:
	BANKSEL	r0x1026
...
_chrgCtr:
; 2 exit points
	.line	431, "main.c"; 	if(PORTA & 0x20)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	MGOTO	_00328_DS_
	.line	434, "main.c"; 	chrgFlag = 1;
	BANKSEL	_Status
	BSR	_Status,3
	.line	435, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	436, "main.c"; 	pwmStop();
	MCALL	_pwmStop
	.line	437, "main.c"; 	if(pwStep == 5)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	XORIA	0x05
	BTRSS	STATUS,2
	MGOTO	_00323_DS_
	.line	440, "main.c"; 	ledStep = 4;
	MOVIA	0x04
	BANKSEL	_ledStep
	MOVAR	_ledStep
	MGOTO	_00330_DS_
_00323_DS_:
	.line	444, "main.c"; 	if(count500ms == 0)
	BANKSEL	_count500ms
	MOVR	_count500ms,W
	BTRSS	STATUS,2
	MGOTO	_00330_DS_
	.line	446, "main.c"; 	if(++ledStep > 4)
	BANKSEL	_ledStep
	INCR	_ledStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x5=5), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00330_DS_
	.line	447, "main.c"; 	ledStep = pwStep - 1;
	BANKSEL	_pwStep
	DECR	_pwStep,W
	BANKSEL	_ledStep
	MOVAR	_ledStep
...
_00328_DS_:
	...
	BTRSS	STATUS,2
	MGOTO	_00005_DS_
	.line	457, "main.c"; 	ledStep = 0;
	BANKSEL	_ledStep
	CLRR	_ledStep
_00005_DS_:
	.line	458, "main.c"; 	chrgFlag = 0;
	BANKSEL	_Status
	BCR	_Status,3
	.line	459, "main.c"; 	chrgTime = 0;	//重置充电计数
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
_00330_DS_:
...
_keyRead:
; 2 exit points
	.line	394, "main.c"; 	char keyRead(char keyStatus)	
	BANKSEL	r0x103C
	MOVAR	r0x103C
	.line	396, "main.c"; 	if(keyStatus)
	MOVR	r0x103C,W
	BTRSC	STATUS,2
	MGOTO	_00311_DS_
	.line	398, "main.c"; 	keyCount++;
	BANKSEL	_keyCount
	INCR	_keyCount,F
;;unsigned compare: left < lit (0x64=100), size=1
	.line	399, "main.c"; 	if(keyCount >= 100)
	MOVIA	0x64
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	MGOTO	_00312_DS_
	.line	401, "main.c"; 	keyCount = 100;
	MOVIA	0x64
	MOVAR	_keyCount
	.line	402, "main.c"; 	if(!longPressFlag)
	BANKSEL	_Status
	BTRSC	_Status,1
	MGOTO	_00312_DS_
	.line	404, "main.c"; 	longPressFlag = 1;
	BSR	_Status,1
	.line	405, "main.c"; 	return 2;
	MOVIA	0x02
	MGOTO	_00313_DS_
;;unsigned compare: left < lit (0x64=100), size=1
_00311_DS_:
	.line	411, "main.c"; 	if(keyCount >= 100)
	MOVIA	0x64
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	...
	CLRR	_keyCount
	.line	414, "main.c"; 	longPressFlag = 0;
	BANKSEL	_Status
	BCR	_Status,1
...
_00308_DS_:
	.line	417, "main.c"; 	else if(keyCount >= 8)
	MOVIA	0x08
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	MGOTO	_00309_DS_
	.line	419, "main.c"; 	keyCount = 0;
	CLRR	_keyCount
	.line	420, "main.c"; 	return	1;
	MOVIA	0x01
	MGOTO	_00313_DS_
_00309_DS_:
...
; 2 exit points
	...
	BANKSEL	_Status
	BCR	_Status,2
	.line	374, "main.c"; 	IOSTA = C_PA6_Input | C_PA5_Input;
	MOVIA	0x60
	IOST	_IOSTA
	.line	375, "main.c"; 	IOSTB = 0x00;
	CLRA	
	IOST	_IOSTB
	.line	376, "main.c"; 	PORTB = 0x00;
	CLRR	_PORTB
	.line	377, "main.c"; 	PORTA = 0x60;
	MOVIA	0x60
	BANKSEL	_PORTA
	MOVAR	_PORTA
	.line	378, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_TMR1 | C_INT_PABKey;
	MOVIA	0x0b
	MOVAR	_INTE
	.line	379, "main.c"; 	PCON =  C_LVR_En | 0x10;	
	MOVIA	0x18
	MOVAR	_PCON
	.line	380, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	381, "main.c"; 	CLRWDT();
	clrwdt
	.line	382, "main.c"; 	ENI();
	ENI
	.line	383, "main.c"; 	SLEEP();
	sleep
	.line	384, "main.c"; 	AWUCON = 0x00;
	CLRR	_AWUCON
	.line	385, "main.c"; 	IOSTA = C_PA6_Input | C_PA5_Input | C_PA4_Input;
	MOVIA	0x70
	IOST	_IOSTA
	.line	386, "main.c"; 	INTE =  C_INT_TMR0 ;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x01
	MOVAR	_INTE
	.line	387, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	389, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En | 0x10;				// Enable WDT ,  Enable LVR
	MOVIA	0xb8
	MOVAR	_PCON
	.line	391, "main.c"; 	}
	RETURN	
...
;	  902+  217 =  1119 instructions ( 2672 byte)
