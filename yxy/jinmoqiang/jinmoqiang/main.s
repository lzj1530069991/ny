...
; 2 exit points
_00484_DS_:
	.line	651, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	LGOTO	_00484_DS_
	.line	653, "main.c"; 	}
	RETURN	
...
_F_AIN5_Convert:
; 2 exit points
	.line	634, "main.c"; 	void F_AIN5_Convert(char count)
	BANKSEL	r0x101D
	MOVAR	r0x101D
	.line	636, "main.c"; 	R_AIN5_DATA=R_AIN5_DATA_LB=0x00;   
	BANKSEL	_R_AIN5_DATA_LB
	CLRR	_R_AIN5_DATA_LB
	BANKSEL	_R_AIN5_DATA
	CLRR	_R_AIN5_DATA
	CLRR	(_R_AIN5_DATA + 1)
	.line	638, "main.c"; 	ADMD  = 0x90 | C_ADC_PA4;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x94
	MOVAR	_ADMD
	.line	639, "main.c"; 	delay(200);	
	MOVIA	0xc8
	LCALL	_delay
	.line	640, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x101E
	MOVAR	r0x101E
_00477_DS_:
	...
	BTRSS	STATUS,0
	LGOTO	_00479_DS_
	.line	642, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	643, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete
	LCALL	_F_wait_eoc
	.line	644, "main.c"; 	R_AIN5_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x101F
	BANKSEL	_R_AIN5_DATA_LB
	ADDAR	_R_AIN5_DATA_LB,F
	.line	645, "main.c"; 	R_AIN5_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x101F
	MOVAR	r0x101F
;;1	CLRR	r0x1020
...
_checkBatAD:
; 2 exit points
	.line	576, "main.c"; 	R_AIN5_DATA = R_AIN5_DATA_LB = 0x00;
	BANKSEL	_R_AIN5_DATA_LB
	CLRR	_R_AIN5_DATA_LB
	BANKSEL	_R_AIN5_DATA
	CLRR	_R_AIN5_DATA
	CLRR	(_R_AIN5_DATA + 1)
	.line	577, "main.c"; 	F_AIN5_Convert(8);					// execute AIN0 ADC converting 8 times
	MOVIA	0x08
	LCALL	_F_AIN5_Convert
	.line	578, "main.c"; 	R_AIN5_DATA <<= 4;					// R_AIN0_DATA shift left 4 bit
	BANKSEL	_R_AIN5_DATA
	...
	.line	579, "main.c"; 	R_AIN5_DATA_LB &= 0xF0;				// Only get Bit7~4
	MOVIA	0xf0
	BANKSEL	_R_AIN5_DATA_LB
	ANDAR	_R_AIN5_DATA_LB,F
	.line	580, "main.c"; 	R_AIN5_DATA += R_AIN5_DATA_LB;		// R_AIN0_DATA + R_AIN0_DATA_LB
...
_00002_DS_:
	.line	581, "main.c"; 	R_AIN5_DATA >>=3;					// R_AIN0_DATA divided 8	
	BCR	STATUS,0
	BANKSEL	_R_AIN5_DATA
...
;;unsigned compare: left >= lit (0x614=1556), size=2
	.line	582, "main.c"; 	if(R_AIN5_DATA > 1555)
	MOVIA	0x06
...
_00436_DS_:
	.line	586, "main.c"; 	else if(R_AIN5_DATA > 1392)
	MOVIA	0x05
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
;;unsigned compare: left < lit (0x5DC=1500), size=2
	.line	591, "main.c"; 	if(R_AIN5_DATA < 1500)
	MOVIA	0x05
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
_00466_DS_:
	...
	LGOTO	_00420_DS_
_00419_DS_:
	.line	596, "main.c"; 	pwStep = 5;
	MOVIA	0x05
	BANKSEL	_pwStep
	MOVAR	_pwStep
_00420_DS_:
	.line	598, "main.c"; 	if(++chrgTime > 1800)
	BANKSEL	_chrgTime
	INCR	_chrgTime,F
	BTRSC	STATUS,2
	INCR	(_chrgTime + 1),F
...
_00467_DS_:
	BTRSS	STATUS,0
	LGOTO	_00438_DS_
	.line	600, "main.c"; 	chrgTime = 1800;
	MOVIA	0x08
	BANKSEL	_chrgTime
	MOVAR	_chrgTime
	MOVIA	0x07
	MOVAR	(_chrgTime + 1)
	.line	601, "main.c"; 	pwStep = 6;
	MOVIA	0x06
	BANKSEL	_pwStep
	MOVAR	_pwStep
	LGOTO	_00438_DS_
...
_00433_DS_:
	.line	604, "main.c"; 	else if(R_AIN5_DATA > 927)
	MOVIA	0x03
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
_00468_DS_:
	BTRSS	STATUS,0
	LGOTO	_00430_DS_
	.line	607, "main.c"; 	pwStep = 4;
	MOVIA	0x04
	BANKSEL	_pwStep
	MOVAR	_pwStep
	.line	608, "main.c"; 	chrgTime = 0;
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
	LGOTO	_00438_DS_
...
_00430_DS_:
	.line	610, "main.c"; 	else if(R_AIN5_DATA > 463)
	MOVIA	0x01
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
_00469_DS_:
	BTRSS	STATUS,0
	LGOTO	_00427_DS_
	.line	613, "main.c"; 	pwStep = 3;
	MOVIA	0x03
	BANKSEL	_pwStep
	MOVAR	_pwStep
	.line	614, "main.c"; 	chrgTime = 0;
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
	LGOTO	_00438_DS_
...
_00427_DS_:
	.line	616, "main.c"; 	else if(R_AIN5_DATA > 154)
	MOVIA	0x00
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
_00470_DS_:
	BTRSS	STATUS,0
	LGOTO	_00424_DS_
	.line	619, "main.c"; 	pwStep = 2;
	MOVIA	0x02
	BANKSEL	_pwStep
	MOVAR	_pwStep
	.line	620, "main.c"; 	chrgTime = 0;
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
	LGOTO	_00438_DS_
_00424_DS_:
	.line	625, "main.c"; 	pwStep = 1;
	MOVIA	0x01
	BANKSEL	_pwStep
	MOVAR	_pwStep
...
_initAD:
; 2 exit points
	.line	552, "main.c"; 	ADMD  = C_ADC_En | C_ADC_CH_Dis | C_ADC_PA4 ;	// Enable ADC power, Disable global ADC input channel, Select PA0 pad as ADC input (SFR "ADMD")
	MOVIA	0x84
	MOVAR	_ADMD
	.line	557, "main.c"; 	ADVREFH = C_Vrefh_2V;					// ADC reference high voltage is supplied by internal 2V  (Note: ADC clock freq. must be equal or less than 250KHz)
	CLRR	_ADVREFH
	.line	562, "main.c"; 	ADR	  = C_Ckl_Div8;						// ADC clock=Fcpu/8, Clear ADIF, disable ADC interrupt	
	MOVIA	0x10
	MOVAR	_ADR
	.line	564, "main.c"; 	ADCR  = C_Sample_1clk | C_12BIT;
	MOVIA	0x03
	MOVAR	_ADCR
	.line	567, "main.c"; 	ADMDbits.GCHS = 1;						// Enable global ADC channel	(SFR "ADMD")
	BSR	_ADMDbits,4
	.line	568, "main.c"; 	delay(100);								// Delay 0.56ms(Instruction clock=4MHz/2T) for waiting ADC stable 
	MOVIA	0x64
	LCALL	_delay
	.line	571, "main.c"; 	}
	RETURN	
...
_delay:
; 2 exit points
	.line	542, "main.c"; 	void delay(u8t time)
	BANKSEL	r0x101B
	MOVAR	r0x101B
	.line	544, "main.c"; 	for(u8t i=0;i<time;i++)
	BANKSEL	r0x101C
	CLRR	r0x101C
_00405_DS_:
	BANKSEL	r0x101B
...
_chrgCtr:
; 2 exit points
	.line	506, "main.c"; 	if(PORTA & 0x20)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	LGOTO	_00396_DS_
	.line	509, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	510, "main.c"; 	ledStep = 0;
	BANKSEL	_ledStep
	CLRR	_ledStep
	...
	LCALL	_LedInput
	.line	513, "main.c"; 	PORTB &= 0xFD;
	BCR	_PORTB,1
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x6=6), size=1
	.line	514, "main.c"; 	if(pwStep > 5)
	MOVIA	0x06
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSS	STATUS,0
	LGOTO	_00391_DS_
	.line	517, "main.c"; 	LEDLOFF();
	LCALL	_LEDLOFF
	.line	518, "main.c"; 	LEDHON();
	LCALL	_LEDHON
	LGOTO	_00398_DS_
_00391_DS_:
	.line	522, "main.c"; 	if(pwStep == 6)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	XORIA	0x06
	BTRSS	STATUS,2
	LGOTO	_00389_DS_
	.line	524, "main.c"; 	pwStep = 5;
	MOVIA	0x05
	MOVAR	_pwStep
_00389_DS_:
	.line	526, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	.line	527, "main.c"; 	PORTA ^= 0x08;
	MOVIA	0x08
	BANKSEL	_PORTA
	XORAR	_PORTA,F
	LGOTO	_00398_DS_
_00396_DS_:
	.line	532, "main.c"; 	if(workStartFlag == 0)
	BANKSEL	_workStartFlag
	MOVR	_workStartFlag,W
	BTRSS	STATUS,2
	LGOTO	_00398_DS_
	.line	534, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	.line	535, "main.c"; 	LEDLOFF();	
	LCALL	_LEDLOFF
_00398_DS_:
	.line	539, "main.c"; 	}
	RETURN	
...
_keyRead:
; 2 exit points
	.line	469, "main.c"; 	char keyRead(char keyStatus)	
	BANKSEL	r0x1028
	MOVAR	r0x1028
	.line	471, "main.c"; 	if(keyStatus)
	MOVR	r0x1028,W
	BTRSC	STATUS,2
	LGOTO	_00381_DS_
	.line	473, "main.c"; 	keyCount++;
	BANKSEL	_keyCount
	INCR	_keyCount,F
;;unsigned compare: left < lit (0xC8=200), size=1
	.line	474, "main.c"; 	if(keyCount >= 200)
	MOVIA	0xc8
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00382_DS_
	.line	476, "main.c"; 	keyCount = 200;
	MOVIA	0xc8
	MOVAR	_keyCount
	.line	477, "main.c"; 	if(!longPressFlag)
	BANKSEL	_Status
	BTRSC	_Status,1
	LGOTO	_00382_DS_
	.line	479, "main.c"; 	longPressFlag = 1;
	BSR	_Status,1
	.line	480, "main.c"; 	return 2;
	MOVIA	0x02
	LGOTO	_00383_DS_
;;unsigned compare: left < lit (0xC8=200), size=1
_00381_DS_:
	.line	486, "main.c"; 	if(keyCount >= 200)
	MOVIA	0xc8
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00378_DS_
	.line	488, "main.c"; 	keyCount = 0;
	CLRR	_keyCount
	.line	489, "main.c"; 	longPressFlag = 0;
	BANKSEL	_Status
	BCR	_Status,1
	.line	490, "main.c"; 	return	0;
	MOVIA	0x00
	LGOTO	_00383_DS_
;;unsigned compare: left < lit (0x8=8), size=1
_00378_DS_:
	.line	492, "main.c"; 	else if(keyCount >= 8)
	MOVIA	0x08
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00379_DS_
	.line	494, "main.c"; 	keyCount = 0;
	CLRR	_keyCount
	.line	495, "main.c"; 	return	1;
	MOVIA	0x01
	LGOTO	_00383_DS_
_00379_DS_:
...
; 2 exit points
	...
	LCALL	_LedInput
	.line	450, "main.c"; 	sleepTime = 0;
	BANKSEL	_sleepTime
	CLRR	_sleepTime
	CLRR	(_sleepTime + 1)
	.line	451, "main.c"; 	pwmStop();
	LCALL	_pwmStop
	.line	452, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	453, "main.c"; 	AWUCON = 0x60;
	MOVIA	0x60
	MOVAR	_AWUCON
	.line	454, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_TMR1 | C_INT_PABKey;
	MOVIA	0x0b
	MOVAR	_INTE
	.line	455, "main.c"; 	PCON =  C_LVR_En;	
	MOVIA	0x08
	MOVAR	_PCON
	.line	456, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	457, "main.c"; 	CLRWDT();
	clrwdt
	.line	458, "main.c"; 	ENI();
	ENI
	.line	459, "main.c"; 	SLEEP();
	sleep
	.line	460, "main.c"; 	AWUCON = 0x00;
	CLRR	_AWUCON
	.line	461, "main.c"; 	INTE =  C_INT_TMR0 ;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x01
	MOVAR	_INTE
	.line	462, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	464, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En;				// Enable WDT ,  Enable LVR
	MOVIA	0xa8
	MOVAR	_PCON
	.line	466, "main.c"; 	}
	RETURN	
...
; 2 exit points
	...
	LGOTO	_00339_DS_
_00338_DS_:
	.line	398, "main.c"; 	PORTB &= 0xFD;
	BCR	_PORTB,1
_00339_DS_:
	.line	401, "main.c"; 	char kclick = keyRead(0x40 & (~PORTA));
	BANKSEL	_PORTA
	COMR	_PORTA,W
	BANKSEL	r0x102A
	MOVAR	r0x102A
	...
	BANKSEL	r0x102A
	MOVAR	r0x102A
	.line	402, "main.c"; 	if(kclick == 1 && workStep > 0)
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00359_DS_
	BANKSEL	_workStep
	...
	BTRSC	STATUS,2
	LGOTO	_00359_DS_
	.line	404, "main.c"; 	count500ms = 0;
	BANKSEL	_count500ms
	CLRR	_count500ms
	.line	405, "main.c"; 	if(++workStep > 4)
	BANKSEL	_workStep
	INCR	_workStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x5=5), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00341_DS_
	.line	406, "main.c"; 	workStep = 1;
	MOVIA	0x01
	MOVAR	_workStep
_00341_DS_:
	.line	407, "main.c"; 	pwmInit();
	LCALL	_pwmInit
	.line	408, "main.c"; 	duty = 1;
	MOVIA	0x01
	BANKSEL	_duty
	MOVAR	_duty
	CLRR	(_duty + 1)
	.line	409, "main.c"; 	fgCount = 0;
	BANKSEL	_fgCount
	CLRR	_fgCount
	CLRR	(_fgCount + 1)
	.line	410, "main.c"; 	workStartFlag = 0;
	BANKSEL	_workStartFlag
	CLRR	_workStartFlag
...
_00352_DS_:
	...
	LGOTO	_00362_DS_
_00359_DS_:
	.line	421, "main.c"; 	else if(kclick == 2)
	BANKSEL	r0x102A
	MOVR	r0x102A,W
	XORIA	0x02
	BTRSS	STATUS,2
	LGOTO	_00362_DS_
	.line	423, "main.c"; 	if(workStep > 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSC	STATUS,2
	LGOTO	_00354_DS_
	...
	CLRR	_workStep
	.line	426, "main.c"; 	pwmStop();
	LCALL	_pwmStop
	.line	427, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	.line	428, "main.c"; 	LEDLOFF();
	LCALL	_LEDLOFF
	.line	429, "main.c"; 	ledStep = 5;
	MOVIA	0x05
	BANKSEL	_ledStep
	MOVAR	_ledStep
	.line	430, "main.c"; 	workStartFlag = 2;
	MOVIA	0x02
	BANKSEL	_workStartFlag
	MOVAR	_workStartFlag
	LGOTO	_00362_DS_
_00354_DS_:
	.line	434, "main.c"; 	workStartFlag = 1;
	MOVIA	0x01
	BANKSEL	_workStartFlag
	MOVAR	_workStartFlag
	.line	435, "main.c"; 	maxDuty = 46;
	MOVIA	0x2e
	BANKSEL	_maxDuty
	MOVAR	_maxDuty
	...
	BANKSEL	_workStep
	MOVAR	_workStep
	.line	437, "main.c"; 	ledStep = 0;
	BANKSEL	_ledStep
	CLRR	_ledStep
	.line	438, "main.c"; 	count500ms = 0;
	BANKSEL	_count500ms
	CLRR	_count500ms
	.line	439, "main.c"; 	pwmInit();
	LCALL	_pwmInit
	.line	440, "main.c"; 	duty = 1;
	MOVIA	0x01
	BANKSEL	_duty
	MOVAR	_duty
	CLRR	(_duty + 1)
	.line	441, "main.c"; 	fgCount = 0;
	BANKSEL	_fgCount
	CLRR	_fgCount
	CLRR	(_fgCount + 1)
_00362_DS_:
...
_ledCtr:
; 0 exit points
	.line	361, "main.c"; 	if(workStartFlag == 1)
	BANKSEL	_workStartFlag
	MOVR	_workStartFlag,W
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00330_DS_
	.line	364, "main.c"; 	if(++ledStep > 4)
	BANKSEL	_ledStep
	INCR	_ledStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x5=5), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00332_DS_
	.line	366, "main.c"; 	ledStep = workStep;
	BANKSEL	_workStep
	MOVR	_workStep,W
	BANKSEL	_ledStep
	MOVAR	_ledStep
	.line	367, "main.c"; 	workStartFlag = 3;
	MOVIA	0x03
	BANKSEL	_workStartFlag
	MOVAR	_workStartFlag
	LGOTO	_00332_DS_
_00330_DS_:
	.line	371, "main.c"; 	else if(workStartFlag == 2)
	BANKSEL	_workStartFlag
	MOVR	_workStartFlag,W
	XORIA	0x02
	BTRSS	STATUS,2
	LGOTO	_00327_DS_
	.line	373, "main.c"; 	if(ledStep > 0)
	BANKSEL	_ledStep
	MOVR	_ledStep,W
	BTRSC	STATUS,2
	LGOTO	_00332_DS_
	.line	375, "main.c"; 	ledStep--;
	DECRSZ	_ledStep,F
	.line	376, "main.c"; 	if(ledStep == 0)
	LGOTO	_00332_DS_
	.line	377, "main.c"; 	workStartFlag = 0;
	BANKSEL	_workStartFlag
	CLRR	_workStartFlag
	LGOTO	_00332_DS_
_00327_DS_:
	.line	382, "main.c"; 	ledStep = workStep;
	BANKSEL	_workStep
	MOVR	_workStep,W
	BANKSEL	_ledStep
	MOVAR	_ledStep
	.line	383, "main.c"; 	if(workStep)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSS	STATUS,2
...
_LedCtr2:
; 2 exit points
	.line	316, "main.c"; 	if(++startStep > 6)
	BANKSEL	_startStep
	INCR	_startStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x7=7), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00290_DS_
	.line	318, "main.c"; 	workStartFlag = 0;
	BANKSEL	_workStartFlag
	CLRR	_workStartFlag
	.line	319, "main.c"; 	startStep = 0;
	BANKSEL	_startStep
	CLRR	_startStep
	...
	MOVAR	_ledStep
_00290_DS_:
	.line	324, "main.c"; 	if(startStep == 1)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00311_DS_
	.line	326, "main.c"; 	if(pwStep == 1)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00294_DS_
	.line	328, "main.c"; 	LEDLON();
	LCALL	_LEDLON
	LGOTO	_00313_DS_
;;unsigned compare: left < lit (0x2=2), size=1
_00294_DS_:
	.line	330, "main.c"; 	else if(pwStep >= 2)
	MOVIA	0x02
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSS	STATUS,0
	LGOTO	_00313_DS_
	.line	332, "main.c"; 	LEDHON();
	LCALL	_LEDHON
	LGOTO	_00313_DS_
_00311_DS_:
	.line	335, "main.c"; 	else if(startStep == 2)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x02
	BTRSS	STATUS,2
	LGOTO	_00308_DS_
	.line	337, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	.line	338, "main.c"; 	LEDLOFF();
	LCALL	_LEDLOFF
	LGOTO	_00313_DS_
_00308_DS_:
	.line	340, "main.c"; 	else if(startStep == 3 && pwStep >= 3)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x03
	BTRSS	STATUS,2
...
;;unsigned compare: left < lit (0x3=3), size=1
	...
	LGOTO	_00313_DS_
_00304_DS_:
	.line	344, "main.c"; 	else if(startStep == 4)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x04
	BTRSS	STATUS,2
	...
	LGOTO	_00313_DS_
_00301_DS_:
	.line	348, "main.c"; 	else if(startStep == 5 && pwStep >= 4)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x05
	BTRSS	STATUS,2
...
_00283_DS_:
	BTRSS	STATUS,0
	LGOTO	_00271_DS_
	.line	299, "main.c"; 	--duty;
	MOVIA	0xff
	BANKSEL	_duty
	ADDAR	_duty,F
	BTRSS	STATUS,0
	DECR	(_duty + 1),F
	.line	300, "main.c"; 	PWM2DUTY = duty;
	MOVR	_duty,W
	BANKSEL	r0x102B
	MOVAR	r0x102B
	SFUN	_PWM2DUTY
	LGOTO	_00271_DS_
_00269_DS_:
	.line	305, "main.c"; 	if(++duty >= maxDuty)
	BANKSEL	_duty
	INCR	_duty,F
	BTRSC	STATUS,2
	INCR	(_duty + 1),F
...
;	  786+  186 =   972 instructions ( 2316 byte)
