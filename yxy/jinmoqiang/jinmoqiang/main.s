...
; 2 exit points
_00507_DS_:
	.line	660, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	LGOTO	_00507_DS_
	.line	662, "main.c"; 	}
	RETURN	
...
_F_AIN5_Convert:
; 2 exit points
	.line	643, "main.c"; 	void F_AIN5_Convert(char count)
	BANKSEL	r0x101D
	MOVAR	r0x101D
	.line	645, "main.c"; 	R_AIN5_DATA=R_AIN5_DATA_LB=0x00;   
...
_00500_DS_:
	...
	LCALL	_F_wait_eoc
	.line	653, "main.c"; 	R_AIN5_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x101F
	BANKSEL	_R_AIN5_DATA_LB
	ADDAR	_R_AIN5_DATA_LB,F
	.line	654, "main.c"; 	R_AIN5_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x101F
	MOVAR	r0x101F
;;1	CLRR	r0x1020
...
_checkBatAD:
; 2 exit points
	.line	585, "main.c"; 	R_AIN5_DATA = R_AIN5_DATA_LB = 0x00;
	BANKSEL	_R_AIN5_DATA_LB
	CLRR	_R_AIN5_DATA_LB
	BANKSEL	_R_AIN5_DATA
	CLRR	_R_AIN5_DATA
	CLRR	(_R_AIN5_DATA + 1)
	.line	586, "main.c"; 	F_AIN5_Convert(8);					// execute AIN0 ADC converting 8 times
	MOVIA	0x08
	LCALL	_F_AIN5_Convert
	.line	587, "main.c"; 	R_AIN5_DATA <<= 4;					// R_AIN0_DATA shift left 4 bit
	BANKSEL	_R_AIN5_DATA
	...
	.line	588, "main.c"; 	R_AIN5_DATA_LB &= 0xF0;				// Only get Bit7~4
	MOVIA	0xf0
	BANKSEL	_R_AIN5_DATA_LB
	ANDAR	_R_AIN5_DATA_LB,F
	.line	589, "main.c"; 	R_AIN5_DATA += R_AIN5_DATA_LB;		// R_AIN0_DATA + R_AIN0_DATA_LB
...
_00002_DS_:
	.line	590, "main.c"; 	R_AIN5_DATA >>=3;					// R_AIN0_DATA divided 8	
	BCR	STATUS,0
	BANKSEL	_R_AIN5_DATA
...
;;unsigned compare: left >= lit (0x614=1556), size=2
	.line	591, "main.c"; 	if(R_AIN5_DATA > 1555)
	MOVIA	0x06
...
_00459_DS_:
	.line	595, "main.c"; 	else if(R_AIN5_DATA > 1392)
	MOVIA	0x05
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
;;unsigned compare: left < lit (0x5DC=1500), size=2
	.line	600, "main.c"; 	if(R_AIN5_DATA < 1500)
	MOVIA	0x05
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
_00489_DS_:
	BTRSC	STATUS,0
	LGOTO	_00443_DS_
	.line	601, "main.c"; 	pwStep = 5;
	MOVIA	0x05
	BANKSEL	_pwStep
	MOVAR	_pwStep
	LGOTO	_00443_DS_
_00442_DS_:
	.line	605, "main.c"; 	pwStep = 5;
	MOVIA	0x05
	BANKSEL	_pwStep
	MOVAR	_pwStep
_00443_DS_:
	.line	607, "main.c"; 	if(++chrgTime > 1800)
	BANKSEL	_chrgTime
	INCR	_chrgTime,F
	BTRSC	STATUS,2
	INCR	(_chrgTime + 1),F
...
_00490_DS_:
	BTRSS	STATUS,0
	LGOTO	_00461_DS_
	.line	609, "main.c"; 	chrgTime = 1800;
	MOVIA	0x08
	BANKSEL	_chrgTime
	MOVAR	_chrgTime
	MOVIA	0x07
	MOVAR	(_chrgTime + 1)
	.line	610, "main.c"; 	pwStep = 6;
	MOVIA	0x06
	BANKSEL	_pwStep
	MOVAR	_pwStep
	LGOTO	_00461_DS_
...
_00456_DS_:
	.line	613, "main.c"; 	else if(R_AIN5_DATA > 927)
	MOVIA	0x03
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
_00491_DS_:
	BTRSS	STATUS,0
	LGOTO	_00453_DS_
	.line	616, "main.c"; 	pwStep = 4;
	MOVIA	0x04
	BANKSEL	_pwStep
	MOVAR	_pwStep
	.line	617, "main.c"; 	chrgTime = 0;
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
	LGOTO	_00461_DS_
...
_00453_DS_:
	.line	619, "main.c"; 	else if(R_AIN5_DATA > 463)
	MOVIA	0x01
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
_00450_DS_:
	.line	625, "main.c"; 	else if(R_AIN5_DATA > 154)
	MOVIA	0x00
	BANKSEL	_R_AIN5_DATA
	SUBAR	(_R_AIN5_DATA + 1),W
	BTRSS	STATUS,2
...
_00493_DS_:
	...
	LGOTO	_00461_DS_
_00447_DS_:
	.line	634, "main.c"; 	pwStep = 1;
	MOVIA	0x01
	BANKSEL	_pwStep
	MOVAR	_pwStep
	.line	635, "main.c"; 	chrgTime = 0;
	BANKSEL	_chrgTime
	CLRR	_chrgTime
	CLRR	(_chrgTime + 1)
_00461_DS_:
...
_initAD:
; 2 exit points
	.line	561, "main.c"; 	ADMD  = C_ADC_En | C_ADC_CH_Dis | C_ADC_PA4 ;	// Enable ADC power, Disable global ADC input channel, Select PA0 pad as ADC input (SFR "ADMD")
	MOVIA	0x84
	MOVAR	_ADMD
	.line	566, "main.c"; 	ADVREFH = C_Vrefh_2V;					// ADC reference high voltage is supplied by internal 2V  (Note: ADC clock freq. must be equal or less than 250KHz)
	CLRR	_ADVREFH
	.line	571, "main.c"; 	ADR	  = C_Ckl_Div8;						// ADC clock=Fcpu/8, Clear ADIF, disable ADC interrupt	
	MOVIA	0x10
	MOVAR	_ADR
	.line	573, "main.c"; 	ADCR  = C_Sample_1clk | C_12BIT;
	MOVIA	0x03
	MOVAR	_ADCR
	.line	576, "main.c"; 	ADMDbits.GCHS = 1;						// Enable global ADC channel	(SFR "ADMD")
	BSR	_ADMDbits,4
	.line	577, "main.c"; 	delay(100);								// Delay 0.56ms(Instruction clock=4MHz/2T) for waiting ADC stable 
	MOVIA	0x64
	LCALL	_delay
	.line	580, "main.c"; 	}
	RETURN	
...
_delay:
; 2 exit points
	.line	551, "main.c"; 	void delay(u8t time)
	BANKSEL	r0x101B
	MOVAR	r0x101B
	.line	553, "main.c"; 	for(u8t i=0;i<time;i++)
	BANKSEL	r0x101C
	CLRR	r0x101C
_00428_DS_:
	BANKSEL	r0x101B
...
_chrgCtr:
; 2 exit points
	.line	515, "main.c"; 	if(PORTA & 0x20)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	LGOTO	_00419_DS_
	.line	518, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	519, "main.c"; 	ledStep = 0;
	BANKSEL	_ledStep
	CLRR	_ledStep
	.line	520, "main.c"; 	pwmStop();
	LCALL	_pwmStop
	.line	521, "main.c"; 	LedInput();
	LCALL	_LedInput
	.line	522, "main.c"; 	PORTB &= 0xFD;
	BCR	_PORTB,1
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x6=6), size=1
	.line	523, "main.c"; 	if(pwStep > 5)
	MOVIA	0x06
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSS	STATUS,0
	LGOTO	_00414_DS_
	.line	526, "main.c"; 	LEDLOFF();
	LCALL	_LEDLOFF
	.line	527, "main.c"; 	LEDHON();
	LCALL	_LEDHON
	LGOTO	_00421_DS_
_00414_DS_:
	.line	531, "main.c"; 	if(pwStep == 6)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	XORIA	0x06
	BTRSS	STATUS,2
	LGOTO	_00412_DS_
	.line	533, "main.c"; 	pwStep = 5;
	MOVIA	0x05
	MOVAR	_pwStep
_00412_DS_:
	.line	535, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	.line	536, "main.c"; 	PORTA ^= 0x08;
	MOVIA	0x08
	BANKSEL	_PORTA
	XORAR	_PORTA,F
	LGOTO	_00421_DS_
_00419_DS_:
	.line	541, "main.c"; 	if(workStartFlag == 0)
	BANKSEL	_workStartFlag
	MOVR	_workStartFlag,W
	BTRSS	STATUS,2
	LGOTO	_00421_DS_
	.line	543, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	.line	544, "main.c"; 	LEDLOFF();	
	LCALL	_LEDLOFF
_00421_DS_:
	.line	548, "main.c"; 	}
	RETURN	
...
_keyRead:
; 2 exit points
	.line	478, "main.c"; 	char keyRead(char keyStatus)	
	BANKSEL	r0x1028
	MOVAR	r0x1028
	.line	480, "main.c"; 	if(keyStatus)
	MOVR	r0x1028,W
	BTRSC	STATUS,2
	LGOTO	_00404_DS_
	.line	482, "main.c"; 	keyCount++;
	BANKSEL	_keyCount
	INCR	_keyCount,F
;;unsigned compare: left < lit (0xC8=200), size=1
	.line	483, "main.c"; 	if(keyCount >= 200)
	MOVIA	0xc8
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00405_DS_
	.line	485, "main.c"; 	keyCount = 200;
	MOVIA	0xc8
	MOVAR	_keyCount
	.line	486, "main.c"; 	if(!longPressFlag)
	BANKSEL	_Status
	BTRSC	_Status,1
	LGOTO	_00405_DS_
	.line	488, "main.c"; 	longPressFlag = 1;
	BSR	_Status,1
	.line	489, "main.c"; 	return 2;
	MOVIA	0x02
	LGOTO	_00406_DS_
;;unsigned compare: left < lit (0xC8=200), size=1
_00404_DS_:
	...
	BTRSS	STATUS,0
	LGOTO	_00401_DS_
	.line	497, "main.c"; 	keyCount = 0;
	CLRR	_keyCount
	.line	498, "main.c"; 	longPressFlag = 0;
	BANKSEL	_Status
	BCR	_Status,1
	.line	499, "main.c"; 	return	0;
	MOVIA	0x00
	LGOTO	_00406_DS_
;;unsigned compare: left < lit (0x8=8), size=1
_00401_DS_:
	.line	501, "main.c"; 	else if(keyCount >= 8)
	MOVIA	0x08
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00402_DS_
	.line	503, "main.c"; 	keyCount = 0;
	CLRR	_keyCount
	.line	504, "main.c"; 	return	1;
	MOVIA	0x01
	LGOTO	_00406_DS_
_00402_DS_:
	.line	506, "main.c"; 	keyCount = 0;
	BANKSEL	_keyCount
	CLRR	_keyCount
_00405_DS_:
	.line	508, "main.c"; 	return 0;
	MOVIA	0x00
_00406_DS_:
	.line	509, "main.c"; 	}
	RETURN	
...
; 2 exit points
	...
	LCALL	_LedInput
	.line	459, "main.c"; 	sleepTime = 0;
	BANKSEL	_sleepTime
	CLRR	_sleepTime
	CLRR	(_sleepTime + 1)
	.line	460, "main.c"; 	pwmStop();
	LCALL	_pwmStop
	.line	461, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	462, "main.c"; 	AWUCON = 0x60;
	MOVIA	0x60
	MOVAR	_AWUCON
	.line	463, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_TMR1 | C_INT_PABKey;
	MOVIA	0x0b
	MOVAR	_INTE
	.line	464, "main.c"; 	PCON =  C_LVR_En;	
	MOVIA	0x08
	MOVAR	_PCON
	.line	465, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	466, "main.c"; 	CLRWDT();
	clrwdt
	.line	467, "main.c"; 	ENI();
	ENI
	.line	468, "main.c"; 	SLEEP();
	sleep
	.line	469, "main.c"; 	AWUCON = 0x00;
	CLRR	_AWUCON
	.line	470, "main.c"; 	INTE =  C_INT_TMR0 ;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x01
	MOVAR	_INTE
	.line	471, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	473, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En;				// Enable WDT ,  Enable LVR
	MOVIA	0xa8
	MOVAR	_PCON
	.line	475, "main.c"; 	}
	RETURN	
...
_keyCtr:
; 2 exit points
	.line	401, "main.c"; 	if(workStep > 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSC	STATUS,2
	LGOTO	_00361_DS_
	.line	403, "main.c"; 	PORTB |= 0x02;
	BSR	_PORTB,1
	LGOTO	_00362_DS_
_00361_DS_:
	.line	407, "main.c"; 	PORTB &= 0xFD;
	BCR	_PORTB,1
_00362_DS_:
	.line	410, "main.c"; 	char kclick = keyRead(0x40 & (~PORTA));
	BANKSEL	_PORTA
	COMR	_PORTA,W
	BANKSEL	r0x102A
	MOVAR	r0x102A
	...
	BANKSEL	r0x102A
	MOVAR	r0x102A
	.line	411, "main.c"; 	if(kclick == 1 && workStep > 0)
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00382_DS_
	BANKSEL	_workStep
	...
	BTRSC	STATUS,2
	LGOTO	_00382_DS_
	.line	413, "main.c"; 	count500ms = 0;
	BANKSEL	_count500ms
	CLRR	_count500ms
	.line	414, "main.c"; 	if(++workStep > 4)
	BANKSEL	_workStep
	INCR	_workStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x5=5), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00364_DS_
	.line	415, "main.c"; 	workStep = 1;
	MOVIA	0x01
	MOVAR	_workStep
_00364_DS_:
	.line	416, "main.c"; 	pwmInit();
	LCALL	_pwmInit
	.line	417, "main.c"; 	duty = 1;
	MOVIA	0x01
	BANKSEL	_duty
	MOVAR	_duty
	CLRR	(_duty + 1)
	.line	418, "main.c"; 	fgCount = 0;
	BANKSEL	_fgCount
	CLRR	_fgCount
	CLRR	(_fgCount + 1)
	.line	419, "main.c"; 	workStartFlag = 0;
	BANKSEL	_workStartFlag
	CLRR	_workStartFlag
...
_00368_DS_:
	...
	BTRSS	STATUS,2
	LGOTO	_00375_DS_
	.line	427, "main.c"; 	maxDuty = 60;
	MOVIA	0x3c
	BANKSEL	_maxDuty
	MOVAR	_maxDuty
_00375_DS_:
	.line	428, "main.c"; 	PWM2DUTY = maxDuty;
	BANKSEL	_maxDuty
	MOVR	_maxDuty,W
	SFUN	_PWM2DUTY
	LGOTO	_00385_DS_
_00382_DS_:
	.line	430, "main.c"; 	else if(kclick == 2)
	BANKSEL	r0x102A
	MOVR	r0x102A,W
	XORIA	0x02
	BTRSS	STATUS,2
	...
	BTRSC	STATUS,2
	LGOTO	_00377_DS_
	.line	434, "main.c"; 	workStep = 0;
	CLRR	_workStep
	.line	435, "main.c"; 	pwmStop();
	LCALL	_pwmStop
	.line	436, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	.line	437, "main.c"; 	LEDLOFF();
	LCALL	_LEDLOFF
	.line	438, "main.c"; 	ledStep = 5;
	MOVIA	0x05
	BANKSEL	_ledStep
	MOVAR	_ledStep
	.line	439, "main.c"; 	workStartFlag = 2;
	MOVIA	0x02
	BANKSEL	_workStartFlag
	MOVAR	_workStartFlag
	LGOTO	_00385_DS_
_00377_DS_:
	.line	443, "main.c"; 	workStartFlag = 1;
	MOVIA	0x01
	BANKSEL	_workStartFlag
	MOVAR	_workStartFlag
	.line	444, "main.c"; 	maxDuty = 90;
	MOVIA	0x5a
	BANKSEL	_maxDuty
	MOVAR	_maxDuty
	.line	445, "main.c"; 	workStep = 1;
	MOVIA	0x01
	BANKSEL	_workStep
	MOVAR	_workStep
	.line	446, "main.c"; 	ledStep = 0;
	BANKSEL	_ledStep
	CLRR	_ledStep
	.line	447, "main.c"; 	count500ms = 0;
	BANKSEL	_count500ms
	CLRR	_count500ms
	.line	448, "main.c"; 	pwmInit();
	LCALL	_pwmInit
	.line	449, "main.c"; 	duty = 1;
	MOVIA	0x01
	BANKSEL	_duty
	MOVAR	_duty
	CLRR	(_duty + 1)
	.line	450, "main.c"; 	fgCount = 0;
	BANKSEL	_fgCount
	CLRR	_fgCount
	CLRR	(_fgCount + 1)
_00385_DS_:
...
_ledCtr:
; 0 exit points
	.line	370, "main.c"; 	if(workStartFlag == 1)
	BANKSEL	_workStartFlag
	MOVR	_workStartFlag,W
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00353_DS_
	.line	373, "main.c"; 	if(++ledStep > 4)
	BANKSEL	_ledStep
	INCR	_ledStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x5=5), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00355_DS_
	.line	375, "main.c"; 	ledStep = workStep;
	BANKSEL	_workStep
	MOVR	_workStep,W
	BANKSEL	_ledStep
	MOVAR	_ledStep
	.line	376, "main.c"; 	workStartFlag = 3;
	MOVIA	0x03
	BANKSEL	_workStartFlag
	MOVAR	_workStartFlag
	LGOTO	_00355_DS_
_00353_DS_:
	.line	380, "main.c"; 	else if(workStartFlag == 2)
	BANKSEL	_workStartFlag
	MOVR	_workStartFlag,W
	XORIA	0x02
	BTRSS	STATUS,2
	LGOTO	_00350_DS_
	.line	382, "main.c"; 	if(ledStep > 0)
	BANKSEL	_ledStep
	MOVR	_ledStep,W
	BTRSC	STATUS,2
	LGOTO	_00355_DS_
	.line	384, "main.c"; 	ledStep--;
	DECRSZ	_ledStep,F
	.line	385, "main.c"; 	if(ledStep == 0)
	LGOTO	_00355_DS_
...
_00350_DS_:
	...
	BANKSEL	_ledStep
	MOVAR	_ledStep
	.line	392, "main.c"; 	if(workStep)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSS	STATUS,2
	.line	393, "main.c"; 	pwmInit();
	LCALL	_pwmInit
_00355_DS_:
	.line	396, "main.c"; 	}
	RETURN	
...
_LedCtr2:
; 2 exit points
	.line	325, "main.c"; 	if(++startStep > 6)
	BANKSEL	_startStep
	INCR	_startStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x7=7), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00313_DS_
	.line	327, "main.c"; 	workStartFlag = 0;
	BANKSEL	_workStartFlag
	CLRR	_workStartFlag
	.line	328, "main.c"; 	startStep = 0;
	BANKSEL	_startStep
	CLRR	_startStep
	...
	MOVAR	_ledStep
_00313_DS_:
	.line	333, "main.c"; 	if(startStep == 1)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00334_DS_
	.line	335, "main.c"; 	if(pwStep == 1)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00317_DS_
	.line	337, "main.c"; 	LEDLON();
	LCALL	_LEDLON
	LGOTO	_00336_DS_
;;unsigned compare: left < lit (0x2=2), size=1
_00317_DS_:
	.line	339, "main.c"; 	else if(pwStep >= 2)
	MOVIA	0x02
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSS	STATUS,0
	LGOTO	_00336_DS_
	.line	341, "main.c"; 	LEDHON();
	LCALL	_LEDHON
	LGOTO	_00336_DS_
_00334_DS_:
	.line	344, "main.c"; 	else if(startStep == 2)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x02
	BTRSS	STATUS,2
	LGOTO	_00331_DS_
	.line	346, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	.line	347, "main.c"; 	LEDLOFF();
	LCALL	_LEDLOFF
	LGOTO	_00336_DS_
_00331_DS_:
	.line	349, "main.c"; 	else if(startStep == 3 && pwStep >= 3)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x03
	BTRSS	STATUS,2
...
;;unsigned compare: left < lit (0x3=3), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00327_DS_
	.line	351, "main.c"; 	LEDHON();
	LCALL	_LEDHON
	LGOTO	_00336_DS_
_00327_DS_:
	.line	353, "main.c"; 	else if(startStep == 4)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x04
	BTRSS	STATUS,2
	LGOTO	_00324_DS_
	.line	355, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
	LGOTO	_00336_DS_
_00324_DS_:
	.line	357, "main.c"; 	else if(startStep == 5 && pwStep >= 4)
	BANKSEL	_startStep
	MOVR	_startStep,W
	XORIA	0x05
	BTRSS	STATUS,2
...
;;unsigned compare: left < lit (0x4=4), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00320_DS_
	.line	359, "main.c"; 	LEDHON();
	LCALL	_LEDHON
	LGOTO	_00336_DS_
_00320_DS_:
	.line	363, "main.c"; 	LEDLOFF();
	LCALL	_LEDLOFF
	.line	364, "main.c"; 	LEDHOFF();
	LCALL	_LEDHOFF
_00336_DS_:
	.line	366, "main.c"; 	}
	RETURN	
...
_00267_DS_:
	...
	MOVAR	r0x102B
_00274_DS_:
	.line	306, "main.c"; 	if(duty > minDuty)
	BANKSEL	r0x102B
	MOVR	r0x102B,W
	BANKSEL	r0x102C
	MOVAR	r0x102C
...
_00306_DS_:
	BTRSC	STATUS,0
	LGOTO	_00282_DS_
	.line	308, "main.c"; 	--duty;
	MOVIA	0xff
	BANKSEL	_duty
	ADDAR	_duty,F
	BTRSS	STATUS,0
	DECR	(_duty + 1),F
	.line	309, "main.c"; 	PWM2DUTY = duty;
	MOVR	_duty,W
	BANKSEL	r0x102B
	MOVAR	r0x102B
	SFUN	_PWM2DUTY
	LGOTO	_00282_DS_
_00280_DS_:
	.line	314, "main.c"; 	if(++duty >= maxDuty)
	BANKSEL	_duty
	INCR	_duty,F
	BTRSC	STATUS,2
	INCR	(_duty + 1),F
...
;	  818+  201 =  1019 instructions ( 2440 byte)
