...
; 2 exit points
_00507_DS_:
	.line	631, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	LGOTO	_00507_DS_
	.line	633, "main.c"; 	}
	RETURN	
...
_F_AIN3_Convert:
; 2 exit points
	.line	614, "main.c"; 	void F_AIN3_Convert(char count)
	BANKSEL	r0x1024
	MOVAR	r0x1024
	.line	616, "main.c"; 	R_AIN3_DATA=R_AIN3_DATA_LB=0x00;   
	BANKSEL	_R_AIN3_DATA_LB
	CLRR	_R_AIN3_DATA_LB
	BANKSEL	_R_AIN3_DATA
	CLRR	_R_AIN3_DATA
	CLRR	(_R_AIN3_DATA + 1)
	.line	618, "main.c"; 	ADMD  = 0x90 | C_ADC_PA3;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x93
	MOVAR	_ADMD
	.line	619, "main.c"; 	delay(200);	
	MOVIA	0xc8
	LCALL	_delay
	.line	620, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x1025
	MOVAR	r0x1025
_00500_DS_:
	...
	BTRSS	STATUS,0
	LGOTO	_00502_DS_
	.line	622, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	623, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete
	LCALL	_F_wait_eoc
	.line	624, "main.c"; 	R_AIN3_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x1026
	BANKSEL	_R_AIN3_DATA_LB
	ADDAR	_R_AIN3_DATA_LB,F
	.line	625, "main.c"; 	R_AIN3_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x1026
	MOVAR	r0x1026
;;1	CLRR	r0x1027
...
_F_AIN4_Convert:
; 2 exit points
	.line	599, "main.c"; 	void F_AIN4_Convert(char count)
	BANKSEL	r0x102A
	MOVAR	r0x102A
	.line	601, "main.c"; 	R_AIN4_DATA=R_AIN4_DATA_LB=0x00;   
	BANKSEL	_R_AIN4_DATA_LB
	CLRR	_R_AIN4_DATA_LB
	BANKSEL	_R_AIN4_DATA
	CLRR	_R_AIN4_DATA
	CLRR	(_R_AIN4_DATA + 1)
	.line	603, "main.c"; 	ADMD  = 0x90 | C_ADC_PA4;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x94
	MOVAR	_ADMD
	.line	604, "main.c"; 	delay(200);	
	MOVIA	0xc8
	LCALL	_delay
	.line	605, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x102B
	MOVAR	r0x102B
_00491_DS_:
	...
	BTRSS	STATUS,0
	LGOTO	_00493_DS_
	.line	607, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	608, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete
	LCALL	_F_wait_eoc
	.line	609, "main.c"; 	R_AIN4_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x102C
	BANKSEL	_R_AIN4_DATA_LB
	ADDAR	_R_AIN4_DATA_LB,F
	.line	610, "main.c"; 	R_AIN4_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x102C
	MOVAR	r0x102C
;;1	CLRR	r0x102D
...
_00465_DS_:
	...
	DECR	_overCount,F
	.line	586, "main.c"; 	PWM2DUTY = maxDuty;
	BANKSEL	_maxDuty
	MOVR	_maxDuty,W
	SFUN	_PWM2DUTY
_00461_DS_:
	...
	BTRSC	STATUS,2
	LGOTO	_00467_DS_
	.line	589, "main.c"; 	ledStep = workStep;
	MOVR	_workStep,W
	BANKSEL	_ledStep
	MOVAR	_ledStep
_00467_DS_:
...
;	  823+  191 =  1014 instructions ( 2410 byte)
