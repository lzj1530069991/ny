...
_main:
; 2 exit points
	.line	394, "main.c"; 	IOSTA =   C_PA2_Input | C_PA4_Input | C_PA5_Input; 
	MOVIA	0x34
	IOST	_IOSTA
	.line	395, "main.c"; 	IOSTB =   0x00;     // Set PB0 & PB1 to input mode,others set to output mode
	CLRA	
	IOST	_IOSTB
	.line	396, "main.c"; 	APHCON = 0xEB;
	MOVIA	0xeb
	IOST	_APHCON
	.line	397, "main.c"; 	BPHCON = 0xFF;
	MOVIA	0xff
	MOVAR	_BPHCON
	.line	398, "main.c"; 	ABPLCON = 0xFF;
	MOVAR	_ABPLCON
	.line	399, "main.c"; 	PORTA = 0x00;    
	CLRR	_PORTA
	.line	400, "main.c"; 	PORTB = 0x00;                           // PB0、PB1 & PB2 are output High
	CLRR	_PORTB
	.line	401, "main.c"; 	DISI();
	DISI
	.line	403, "main.c"; 	PCON1 = C_TMR0_Dis;						// Disable Timer0
	CLRA	
	IOST	_PCON1
	.line	407, "main.c"; 	TMR1 = 0xFF;
	MOVIA	0xff
	SFUN	_TMR1
	.line	408, "main.c"; 	T1CR2 = C_PS1_Div64 | C_PS1_EN | C_TMR1_ClkSrc_Inst;
	MOVIA	0x05
	SFUN	_T1CR2
	.line	409, "main.c"; 	T1CR1 = C_TMR1_En | C_TMR1_Reload;
	MOVIA	0x03
	SFUN	_T1CR1
	.line	412, "main.c"; 	INT1Level = 1;
	BANKSEL	_Status
	BSR	_Status,5
	.line	415, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_TMR1 | C_INT_PABKey;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x0b
	MOVAR	_INTE
	.line	417, "main.c"; 	TMR0 = 55;
	MOVIA	0x37
	MOVAR	_TMR0
	.line	418, "main.c"; 	T0MD =  C_PS0_TMR0 | C_PS0_Div2;
	CLRA	
	T0MD	
	.line	421, "main.c"; 	PCON = C_WDT_En | C_LVR_En;				// Enable WDT ,  Enable LVR
	MOVIA	0x88
	MOVAR	_PCON
	.line	424, "main.c"; 	PCON1 = C_TMR0_En;						// Enable Timer0
	MOVIA	0x01
	IOST	_PCON1
	.line	425, "main.c"; 	ENI();									// Enable all unmasked interrupts			
	ENI
	.line	426, "main.c"; 	data1 = data2 = data3 = data4 = 0;
	BANKSEL	_data4
	CLRR	_data4
	BANKSEL	_data3
	CLRR	_data3
	...
	CLRR	_data1
_00370_DS_:
	.line	429, "main.c"; 	if(ReadOver)
	BANKSEL	_Status
	BTRSC	_Status,4
	.line	431, "main.c"; 	proData();
	MCALL	_proData
_00343_DS_:
	.line	433, "main.c"; 	if(INT1Level && (PORTA & 0x04))
	BANKSEL	_Status
	BTRSS	_Status,5
	MGOTO	_00348_DS_
	BTRSS	_PORTA,2
	MGOTO	_00348_DS_
	.line	435, "main.c"; 	INT1Level = 0;
	BCR	_Status,5
	.line	436, "main.c"; 	proLow();
	MCALL	_proLow
	MGOTO	_00349_DS_
_00348_DS_:
	.line	438, "main.c"; 	else if(INT1Level == 0 && (PORTA & 0x04) == 0)
	BANKSEL	_Status
	BTRSC	_Status,5
	MGOTO	_00349_DS_
	BTRSC	_PORTA,2
	MGOTO	_00349_DS_
	.line	441, "main.c"; 	INT1Level = 1;
	BSR	_Status,5
	.line	442, "main.c"; 	proHight();
	MCALL	_proHight
_00349_DS_:
	.line	444, "main.c"; 	if(workStep == 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSS	STATUS,2
	MGOTO	_00352_DS_
	.line	445, "main.c"; 	red = green = blue = white = 0;
	BANKSEL	_white
	CLRR	_white
	BANKSEL	_blue
	CLRR	_blue
	...
	CLRR	_red
_00352_DS_:
	.line	446, "main.c"; 	showRGB();
	MCALL	_showRGB
	.line	447, "main.c"; 	CLRWDT();
	clrwdt
	.line	448, "main.c"; 	if(!IntFlag)
	BANKSEL	_IntFlag
	MOVR	_IntFlag,W
	BTRSC	STATUS,2
	MGOTO	_00370_DS_
	.line	450, "main.c"; 	IntFlag = 0;		//10ms执行一次
	CLRR	_IntFlag
	.line	451, "main.c"; 	keyCtr();
	MCALL	_keyCtr
	.line	452, "main.c"; 	if(workStep > 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSS	STATUS,2
	.line	453, "main.c"; 	workCtr();
	MCALL	_workCtr
	.line	454, "main.c"; 	if(bitIndex == 0 &&  keyCount == 0 && workStep == 0 && ++sleepCount >= 250)
	BANKSEL	_bitIndex
	MOVR	_bitIndex,W
	BTRSS	STATUS,2
	MGOTO	_00358_DS_
...
_00422_DS_:
	BTRSS	STATUS,0
	MGOTO	_00358_DS_
	.line	456, "main.c"; 	gotoSleep();
	MCALL	_gotoSleep
_00358_DS_:
	.line	458, "main.c"; 	if(++count1s > 100)
	BANKSEL	_count1s
	INCR	_count1s,F
...
;;unsigned compare: left >= lit (0x65=101), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00370_DS_
	.line	460, "main.c"; 	count1s = 0;
	CLRR	_count1s
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x5=5), size=1
	.line	461, "main.c"; 	if(workStep > 4)
	MOVIA	0x05
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSS	STATUS,0
	MGOTO	_00370_DS_
	.line	464, "main.c"; 	if(lowTime > 0)
	BANKSEL	_lowTime
	MOVR	_lowTime,W
	IORAR	(_lowTime + 1),W
	BTRSC	STATUS,2
	MGOTO	_00363_DS_
	.line	466, "main.c"; 	--lowTime;
	MOVIA	0xff
	ADDAR	_lowTime,F
	BTRSS	STATUS,0
	DECR	(_lowTime + 1),F
	MGOTO	_00370_DS_
_00363_DS_:
	.line	470, "main.c"; 	sleepFlag = 1;
	MOVIA	0x01
	BANKSEL	_sleepFlag
	MOVAR	_sleepFlag
	.line	471, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	MGOTO	_00370_DS_
	.line	479, "main.c"; 	}
...
_rainbow:
; 2 exit points
	.line	729, "main.c"; 	if(colorStep == 1)
	BANKSEL	_colorStep
	MOVR	_colorStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00586_DS_
	.line	731, "main.c"; 	lastRed = 250;
	MOVIA	0xfa
	BANKSEL	_lastRed
	MOVAR	_lastRed
	.line	732, "main.c"; 	lastGreen = 0;
	BANKSEL	_lastGreen
	CLRR	_lastGreen
	.line	733, "main.c"; 	lastBlue = 0;
	BANKSEL	_lastBlue
	CLRR	_lastBlue
	MGOTO	_00587_DS_
_00586_DS_:
	.line	735, "main.c"; 	else if(colorStep == 2)
	BANKSEL	_colorStep
	MOVR	_colorStep,W
	XORIA	0x02
	BTRSS	STATUS,2
	MGOTO	_00583_DS_
	.line	737, "main.c"; 	lastRed = 250;
	MOVIA	0xfa
	BANKSEL	_lastRed
	MOVAR	_lastRed
	.line	738, "main.c"; 	lastGreen = 150;
	MOVIA	0x96
	BANKSEL	_lastGreen
	MOVAR	_lastGreen
	.line	739, "main.c"; 	lastBlue = 0;
	BANKSEL	_lastBlue
	CLRR	_lastBlue
	MGOTO	_00587_DS_
_00583_DS_:
	.line	741, "main.c"; 	else if(colorStep == 3)
	BANKSEL	_colorStep
	MOVR	_colorStep,W
	XORIA	0x03
	BTRSS	STATUS,2
	MGOTO	_00580_DS_
	.line	743, "main.c"; 	lastRed = 250;
	MOVIA	0xfa
	BANKSEL	_lastRed
	MOVAR	_lastRed
	.line	744, "main.c"; 	lastGreen = 250;
	BANKSEL	_lastGreen
	MOVAR	_lastGreen
	.line	745, "main.c"; 	lastBlue = 0;
	BANKSEL	_lastBlue
	CLRR	_lastBlue
	MGOTO	_00587_DS_
_00580_DS_:
	.line	747, "main.c"; 	else if(colorStep == 4)
	BANKSEL	_colorStep
	MOVR	_colorStep,W
	XORIA	0x04
	BTRSS	STATUS,2
	MGOTO	_00577_DS_
	.line	749, "main.c"; 	lastRed = 0;
	BANKSEL	_lastRed
	CLRR	_lastRed
	.line	750, "main.c"; 	lastGreen = 250;
	MOVIA	0xfa
	BANKSEL	_lastGreen
	MOVAR	_lastGreen
	.line	751, "main.c"; 	lastBlue = 0;
	BANKSEL	_lastBlue
	CLRR	_lastBlue
	MGOTO	_00587_DS_
_00577_DS_:
	.line	753, "main.c"; 	else if(colorStep == 5)
	BANKSEL	_colorStep
	MOVR	_colorStep,W
	XORIA	0x05
	BTRSS	STATUS,2
	MGOTO	_00574_DS_
	.line	755, "main.c"; 	lastRed = 0;
	BANKSEL	_lastRed
	CLRR	_lastRed
	.line	756, "main.c"; 	lastGreen = 250;
	MOVIA	0xfa
	BANKSEL	_lastGreen
	MOVAR	_lastGreen
	.line	757, "main.c"; 	lastBlue = 250;
	BANKSEL	_lastBlue
	MOVAR	_lastBlue
	MGOTO	_00587_DS_
_00574_DS_:
	.line	759, "main.c"; 	else if(colorStep == 6)
	BANKSEL	_colorStep
	MOVR	_colorStep,W
	XORIA	0x06
	BTRSS	STATUS,2
	MGOTO	_00571_DS_
	.line	761, "main.c"; 	lastRed = 0;
	BANKSEL	_lastRed
	CLRR	_lastRed
	.line	762, "main.c"; 	lastGreen = 0;
	BANKSEL	_lastGreen
	CLRR	_lastGreen
	.line	763, "main.c"; 	lastBlue = 250;
	MOVIA	0xfa
	BANKSEL	_lastBlue
	MOVAR	_lastBlue
	MGOTO	_00587_DS_
_00571_DS_:
	.line	765, "main.c"; 	else if(colorStep == 7)
	BANKSEL	_colorStep
	MOVR	_colorStep,W
	XORIA	0x07
	BTRSS	STATUS,2
	MGOTO	_00587_DS_
	.line	767, "main.c"; 	lastRed = 150;
	MOVIA	0x96
	BANKSEL	_lastRed
	MOVAR	_lastRed
	.line	768, "main.c"; 	lastGreen = 0;
	BANKSEL	_lastGreen
	CLRR	_lastGreen
	.line	769, "main.c"; 	lastBlue = 250;
	MOVIA	0xfa
	BANKSEL	_lastBlue
	MOVAR	_lastBlue
_00587_DS_:
	.line	772, "main.c"; 	if(red > lastRed)
	BANKSEL	_red
	MOVR	_red,W
	BANKSEL	_lastRed
	SUBAR	_lastRed,W
	...
	DECR	_red,F
_00001_DS_:
	.line	774, "main.c"; 	if(green > lastGreen)
	BANKSEL	_green
	MOVR	_green,W
	BANKSEL	_lastGreen
	SUBAR	_lastGreen,W
	BTRSC	STATUS,0
	MGOTO	_00002_DS_
	.line	775, "main.c"; 	green--;
	BANKSEL	_green
	DECR	_green,F
_00002_DS_:
	.line	776, "main.c"; 	if(blue > lastBlue)
	BANKSEL	_blue
	MOVR	_blue,W
	BANKSEL	_lastBlue
	SUBAR	_lastBlue,W
	BTRSC	STATUS,0
	MGOTO	_00003_DS_
	.line	777, "main.c"; 	blue--;
	BANKSEL	_blue
	DECR	_blue,F
_00003_DS_:
	.line	778, "main.c"; 	if(red < lastRed)
	BANKSEL	_lastRed
	MOVR	_lastRed,W
	BANKSEL	_red
	SUBAR	_red,W
	...
	.line	779, "main.c"; 	red++;
	INCR	_red,F
	.line	780, "main.c"; 	if(green < lastGreen)
	BANKSEL	_lastGreen
	MOVR	_lastGreen,W
	BANKSEL	_green
	SUBAR	_green,W
	BTRSS	STATUS,0
	.line	781, "main.c"; 	green++;
	INCR	_green,F
	.line	782, "main.c"; 	if(blue < lastBlue)
	BANKSEL	_lastBlue
	MOVR	_lastBlue,W
	BANKSEL	_blue
	SUBAR	_blue,W
	BTRSS	STATUS,0
	.line	783, "main.c"; 	blue++;
	INCR	_blue,F
	.line	785, "main.c"; 	if(red == lastRed && blue == lastBlue && green == lastGreen)
	BANKSEL	_lastRed
	MOVR	_lastRed,W
	BANKSEL	_red
	XORAR	_red,W
	...
	BTRSS	STATUS,2
	MGOTO	_00606_DS_
	.line	787, "main.c"; 	if(++colorStep > 7)
	BANKSEL	_colorStep
	INCR	_colorStep,F
;;swapping arguments (AOP_TYPEs 1/3)
...
_colorChange:
; 2 exit points
	.line	661, "main.c"; 	if(++colorStep > 16)
	BANKSEL	_colorStep
	INCR	_colorStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x11=17), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00531_DS_
	.line	662, "main.c"; 	colorStep = 1;
	MOVIA	0x01
	MOVAR	_colorStep
_00531_DS_:
	.line	663, "main.c"; 	white = red = green = blue = 0;
	BANKSEL	_blue
	CLRR	_blue
	BANKSEL	_green
	CLRR	_green
...
;;unsigned compare: left < lit (0x1=1), size=1
	.line	664, "main.c"; 	switch(colorStep)
	MOVIA	0x01
	BANKSEL	_colorStep
	SUBAR	_colorStep,W
	BTRSS	STATUS,0
...
_00535_DS_:
	...
	MGOTO	_00549_DS_
_00536_DS_:
	.line	679, "main.c"; 	red = green = 250;
	MOVIA	0xfa
	BANKSEL	_green
	MOVAR	_green
	BANKSEL	_red
	MOVAR	_red
	.line	680, "main.c"; 	break;
	MGOTO	_00549_DS_
_00537_DS_:
	.line	682, "main.c"; 	green = blue = 250;
	MOVIA	0xfa
	BANKSEL	_blue
	MOVAR	_blue
	BANKSEL	_green
	MOVAR	_green
	.line	683, "main.c"; 	break;
	MGOTO	_00549_DS_
_00538_DS_:
	.line	685, "main.c"; 	red = blue = 250;
	MOVIA	0xfa
	BANKSEL	_blue
	MOVAR	_blue
	BANKSEL	_red
	...
	MGOTO	_00549_DS_
_00539_DS_:
	.line	688, "main.c"; 	red =  250;
	MOVIA	0xfa
	BANKSEL	_red
	MOVAR	_red
	.line	689, "main.c"; 	green = 100;
	MOVIA	0x64
	BANKSEL	_green
	MOVAR	_green
	...
	MGOTO	_00549_DS_
_00540_DS_:
	.line	692, "main.c"; 	green = 100;
	MOVIA	0x64
	BANKSEL	_green
	MOVAR	_green
	.line	693, "main.c"; 	blue = 250;
	MOVIA	0xfa
	BANKSEL	_blue
	MOVAR	_blue
	.line	694, "main.c"; 	break;
	MGOTO	_00549_DS_
_00541_DS_:
	.line	696, "main.c"; 	red = 100;
	MOVIA	0x64
	BANKSEL	_red
	MOVAR	_red
	.line	697, "main.c"; 	blue = 250;
	MOVIA	0xfa
	BANKSEL	_blue
	MOVAR	_blue
	.line	698, "main.c"; 	break;
	MGOTO	_00549_DS_
_00542_DS_:
	.line	700, "main.c"; 	red =  100;
	MOVIA	0x64
	BANKSEL	_red
	MOVAR	_red
	.line	701, "main.c"; 	green = 250;
	MOVIA	0xfa
	BANKSEL	_green
	MOVAR	_green
	.line	702, "main.c"; 	break;
	MGOTO	_00549_DS_
_00543_DS_:
	.line	704, "main.c"; 	green = 250;
	MOVIA	0xfa
	BANKSEL	_green
	MOVAR	_green
	.line	705, "main.c"; 	blue = 100;
	MOVIA	0x64
	BANKSEL	_blue
	MOVAR	_blue
	.line	706, "main.c"; 	break;
	MGOTO	_00549_DS_
_00544_DS_:
	.line	708, "main.c"; 	red = 250;
	MOVIA	0xfa
	BANKSEL	_red
	MOVAR	_red
	.line	709, "main.c"; 	blue = 100;
	MOVIA	0x64
	BANKSEL	_blue
	MOVAR	_blue
	.line	710, "main.c"; 	break;
	MGOTO	_00549_DS_
_00545_DS_:
	.line	712, "main.c"; 	red =  50;
	MOVIA	0x32
	BANKSEL	_red
	MOVAR	_red
	.line	713, "main.c"; 	green = 250;
	MOVIA	0xfa
	BANKSEL	_green
	MOVAR	_green
	.line	714, "main.c"; 	break;
	MGOTO	_00549_DS_
_00546_DS_:
	.line	716, "main.c"; 	green = 250;
	MOVIA	0xfa
	BANKSEL	_green
	MOVAR	_green
	.line	717, "main.c"; 	blue = 50;
	MOVIA	0x32
	BANKSEL	_blue
	MOVAR	_blue
	.line	718, "main.c"; 	break;
	MGOTO	_00549_DS_
_00547_DS_:
	.line	720, "main.c"; 	red = 250;
	MOVIA	0xfa
	BANKSEL	_red
	MOVAR	_red
	.line	721, "main.c"; 	blue = 50;
	MOVIA	0x32
	BANKSEL	_blue
	MOVAR	_blue
_00549_DS_:
...
_keyCtr:
; 2 exit points
	.line	638, "main.c"; 	char kclick = keyRead(0x30 & (~PORTA));
	COMR	_PORTA,W
	BANKSEL	r0x1025
	MOVAR	r0x1025
	MOVIA	0x30
	...
	BANKSEL	r0x1025
	MOVAR	r0x1025
	.line	639, "main.c"; 	if(kclick == 1)
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00525_DS_
	.line	641, "main.c"; 	if(++workStep > 5)
	BANKSEL	_workStep
	INCR	_workStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x6=6), size=1
	...
	SUBAR	_workStep,W
	BTRSC	STATUS,0
	.line	642, "main.c"; 	workStep = 0;
	CLRR	_workStep
	.line	643, "main.c"; 	ledFlag = 1;
	MOVIA	0x01
	BANKSEL	_ledFlag
	MOVAR	_ledFlag
	.line	644, "main.c"; 	if(workStep == 1)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00521_DS_
	.line	646, "main.c"; 	light = 5;
	MOVIA	0x05
	BANKSEL	_light
	MOVAR	_light
	.line	647, "main.c"; 	lightValue = 25*light;
	MOVIA	0x7d
	BANKSEL	_lightValue
	MOVAR	_lightValue
	.line	648, "main.c"; 	colorStep = 0;
	BANKSEL	_colorStep
	CLRR	_colorStep
	MGOTO	_00525_DS_
_00521_DS_:
	.line	650, "main.c"; 	else if(workStep == 5)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x05
	BTRSS	STATUS,2
	MGOTO	_00525_DS_
	.line	652, "main.c"; 	lowTime = 600;
	MOVIA	0x58
	BANKSEL	_lowTime
	MOVAR	_lowTime
	MOVIA	0x02
...
_keyRead:
; 2 exit points
	.line	588, "main.c"; 	char keyRead(uint8 keyStatus)	
	BANKSEL	r0x1024
	MOVAR	r0x1024
...
;;unsigned compare: left < lit (0xC8=200), size=1
	...
	MOVIA	0xc8
	MOVAR	_keyCount
	.line	597, "main.c"; 	if(keyStatus & 0x10)
	BANKSEL	r0x1024
	BTRSS	r0x1024,4
	MGOTO	_00497_DS_
	.line	599, "main.c"; 	if(++lightValue > 250)
	BANKSEL	_lightValue
	INCR	_lightValue,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0xFB=251), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00491_DS_
	.line	600, "main.c"; 	lightValue = 250;
	MOVIA	0xfa
	MOVAR	_lightValue
_00491_DS_:
	.line	601, "main.c"; 	light = lightValue/25;
	MOVIA	0x19
	MOVAR	STK00
	BANKSEL	_lightValue
	MOVR	_lightValue,W
	...
	MGOTO	_00498_DS_
_00497_DS_:
	.line	603, "main.c"; 	else if(keyStatus &= 0x20)
	BANKSEL	r0x1024
	BTRSS	r0x1024,5
	MGOTO	_00498_DS_
	.line	605, "main.c"; 	if(--lightValue < 25)
	BANKSEL	_lightValue
	DECR	_lightValue,F
;;unsigned compare: left < lit (0x19=25), size=1
	...
	BTRSC	STATUS,0
	MGOTO	_00493_DS_
	.line	606, "main.c"; 	lightValue = 25;
	MOVIA	0x19
	MOVAR	_lightValue
_00493_DS_:
	.line	607, "main.c"; 	light = lightValue/25;
	MOVIA	0x19
	MOVAR	STK00
	BANKSEL	_lightValue
	MOVR	_lightValue,W
...
;;unsigned compare: left < lit (0x8=8), size=1
_00506_DS_:
	.line	624, "main.c"; 	else if(keyCount >= 8)
	MOVIA	0x08
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
...
_workCtr:
; 0 exit points
	.line	531, "main.c"; 	if(lightValue == 0)
	BANKSEL	_lightValue
	MOVR	_lightValue,W
	BTRSS	STATUS,2
	MGOTO	_00449_DS_
	.line	532, "main.c"; 	lightValue = 25*light;
	MOVIA	0x19
	MOVAR	STK00
	BANKSEL	_light
	MOVR	_light,W
	...
	MOVAR	_lightValue
_00449_DS_:
	.line	533, "main.c"; 	if(workStep == 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSS	STATUS,2
	MGOTO	_00483_DS_
	.line	535, "main.c"; 	white = red = green = blue = 0;
	BANKSEL	_blue
	CLRR	_blue
	BANKSEL	_green
	CLRR	_green
	...
	BANKSEL	_white
	CLRR	_white
	.line	536, "main.c"; 	PORTB &= 0xBE;
	MOVIA	0xbe
	ANDAR	_PORTB,F
	.line	537, "main.c"; 	PORTA &= 0xFC;
	MOVIA	0xfc
	ANDAR	_PORTA,F
	MGOTO	_00485_DS_
_00483_DS_:
	.line	539, "main.c"; 	else if(workStep == 1)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00480_DS_
	.line	541, "main.c"; 	white = lightValue;
	BANKSEL	_lightValue
	MOVR	_lightValue,W
	BANKSEL	_white
	MOVAR	_white
	.line	542, "main.c"; 	red = green = blue = 0;
	BANKSEL	_blue
	CLRR	_blue
	BANKSEL	_green
	CLRR	_green
	...
	MGOTO	_00485_DS_
_00480_DS_:
	.line	544, "main.c"; 	else if(workStep == 2)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x02
	BTRSS	STATUS,2
	MGOTO	_00477_DS_
	.line	546, "main.c"; 	red = lightValue;
	BANKSEL	_lightValue
	MOVR	_lightValue,W
	BANKSEL	_red
	MOVAR	_red
	.line	547, "main.c"; 	white = green = blue = 0;
	BANKSEL	_blue
	CLRR	_blue
	BANKSEL	_green
	CLRR	_green
	...
	MGOTO	_00485_DS_
_00477_DS_:
	.line	549, "main.c"; 	else if(workStep == 3)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x03
	BTRSS	STATUS,2
	MGOTO	_00474_DS_
	.line	551, "main.c"; 	green = lightValue;
	BANKSEL	_lightValue
	MOVR	_lightValue,W
	BANKSEL	_green
	MOVAR	_green
	.line	552, "main.c"; 	white = red = blue = 0;
	BANKSEL	_blue
	CLRR	_blue
	BANKSEL	_red
	CLRR	_red
	...
	MGOTO	_00485_DS_
_00474_DS_:
	.line	554, "main.c"; 	else if(workStep == 4)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x04
	BTRSS	STATUS,2
	MGOTO	_00471_DS_
	.line	556, "main.c"; 	blue = lightValue;
	BANKSEL	_lightValue
	MOVR	_lightValue,W
	BANKSEL	_blue
	MOVAR	_blue
	.line	557, "main.c"; 	white = green = red = 0;
	BANKSEL	_red
	CLRR	_red
	BANKSEL	_green
	CLRR	_green
	...
	MGOTO	_00485_DS_
_00471_DS_:
	.line	559, "main.c"; 	else if(workStep == 5)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x05
	BTRSS	STATUS,2
	MGOTO	_00468_DS_
	.line	561, "main.c"; 	if(count1s == 0)
	BANKSEL	_count1s
	MOVR	_count1s,W
	BTRSS	STATUS,2
	MGOTO	_00485_DS_
	.line	562, "main.c"; 	colorChange();
	MCALL	_colorChange
	MGOTO	_00485_DS_
_00468_DS_:
	.line	564, "main.c"; 	else if(workStep == 6)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x06
	BTRSS	STATUS,2
	MGOTO	_00465_DS_
	.line	566, "main.c"; 	if(count1s == 0)
	BANKSEL	_count1s
	MOVR	_count1s,W
	BTRSS	STATUS,2
	MGOTO	_00455_DS_
	.line	568, "main.c"; 	ledFlag = 1;
	MOVIA	0x01
	BANKSEL	_ledFlag
	MOVAR	_ledFlag
	.line	569, "main.c"; 	colorChange();
	MCALL	_colorChange
	MGOTO	_00485_DS_
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x33=51), size=1
_00455_DS_:
	.line	571, "main.c"; 	else if(count1s > 50)
	MOVIA	0x33
	BANKSEL	_count1s
	SUBAR	_count1s,W
	BTRSS	STATUS,0
	MGOTO	_00485_DS_
	.line	573, "main.c"; 	ledFlag = 0;
	BANKSEL	_ledFlag
	CLRR	_ledFlag
	MGOTO	_00485_DS_
_00465_DS_:
	.line	576, "main.c"; 	else if(workStep == 7)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x07
	BTRSS	STATUS,2
	MGOTO	_00462_DS_
	.line	578, "main.c"; 	if(count1s %2 == 0)
	BANKSEL	_count1s
	BTRSC	_count1s,0
	MGOTO	_00485_DS_
	.line	579, "main.c"; 	rainbow();
	MCALL	_rainbow
	MGOTO	_00485_DS_
_00462_DS_:
	.line	581, "main.c"; 	else if(workStep == 8)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x08
	BTRSC	STATUS,2
	.line	583, "main.c"; 	rainbow();
	MCALL	_rainbow
_00485_DS_:
	.line	585, "main.c"; 	}
	RETURN	
...
_showRGB:
; 0 exit points
	.line	484, "main.c"; 	if(ledFlag == 0)
	BANKSEL	_ledFlag
	MOVR	_ledFlag,W
	BTRSS	STATUS,2
	MGOTO	_00428_DS_
	.line	486, "main.c"; 	PORTB &= 0xDE;
	MOVIA	0xde
	ANDAR	_PORTB,F
	.line	487, "main.c"; 	PORTA &= 0xFC;
	MOVIA	0xfc
	ANDAR	_PORTA,F
	.line	488, "main.c"; 	return;
	MGOTO	_00443_DS_
_00428_DS_:
	.line	490, "main.c"; 	if(white > ledCount)
	BANKSEL	_white
	MOVR	_white,W
	BANKSEL	_ledCount
	SUBAR	_ledCount,W
	BTRSC	STATUS,0
	MGOTO	_00430_DS_
	.line	492, "main.c"; 	PORTB |= 0x20;
	BSR	_PORTB,5
	MGOTO	_00431_DS_
_00430_DS_:
	.line	496, "main.c"; 	PORTB &= 0xDF;
	BCR	_PORTB,5
_00431_DS_:
	.line	499, "main.c"; 	if(blue > ledCount)
	BANKSEL	_blue
	MOVR	_blue,W
	BANKSEL	_ledCount
	SUBAR	_ledCount,W
	BTRSC	STATUS,0
	MGOTO	_00433_DS_
	.line	501, "main.c"; 	PORTA |= 0x01;
	BSR	_PORTA,0
	MGOTO	_00434_DS_
_00433_DS_:
	.line	505, "main.c"; 	PORTA &= 0xFE;
	BCR	_PORTA,0
_00434_DS_:
	.line	508, "main.c"; 	if(green > ledCount)
	BANKSEL	_green
	MOVR	_green,W
	BANKSEL	_ledCount
	SUBAR	_ledCount,W
	BTRSC	STATUS,0
	MGOTO	_00436_DS_
	.line	510, "main.c"; 	PORTA |= 0x02;
	BSR	_PORTA,1
	MGOTO	_00437_DS_
_00436_DS_:
	.line	514, "main.c"; 	PORTA &= 0xFD;
	BCR	_PORTA,1
_00437_DS_:
	.line	517, "main.c"; 	if(red > ledCount)
	BANKSEL	_red
	MOVR	_red,W
	BANKSEL	_ledCount
	SUBAR	_ledCount,W
	BTRSC	STATUS,0
	MGOTO	_00439_DS_
	.line	519, "main.c"; 	PORTB |= 0x01;
	BSR	_PORTB,0
	MGOTO	_00440_DS_
_00439_DS_:
	.line	523, "main.c"; 	PORTB &= 0xFE;
	BCR	_PORTB,0
_00440_DS_:
	.line	525, "main.c"; 	if(++ledCount > 254)
	BANKSEL	_ledCount
	INCR	_ledCount,F
;;swapping arguments (AOP_TYPEs 1/3)
...
; 2 exit points
	...
	MOVIA	0x34
	MOVAR	_AWUCON
	.line	375, "main.c"; 	BWUCON = 0X00;
	CLRR	_BWUCON
	.line	376, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_TMR1 | C_INT_PABKey;
	MOVIA	0x0b
	MOVAR	_INTE
	...
	sleep
	.line	381, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_TMR1 | C_INT_PABKey;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x0b
	MOVAR	_INTE
	.line	382, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	384, "main.c"; 	PCON = C_WDT_En;				// Enable WDT ,  Enable LVR
	MOVIA	0x80
	MOVAR	_PCON
	.line	385, "main.c"; 	sleepFlag = 0;
	BANKSEL	_sleepFlag
	CLRR	_sleepFlag
	.line	386, "main.c"; 	bitIndex = 0;
	BANKSEL	_bitIndex
	CLRR	_bitIndex
	.line	387, "main.c"; 	value = 0;
	BANKSEL	_value
	CLRR	_value
	.line	388, "main.c"; 	}
	RETURN	
...
;	 1065+  333 =  1398 instructions ( 3462 byte)
