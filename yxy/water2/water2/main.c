...
//;Enable Timer0 & Global interrupt bit 
    ...
    while(1)
    {
    	...
    	IntFlag = 0;
//    	showBaiwei();
//    	showNubShiwei(numArray[2]);
//    	showNubGewei(numArray[2]);
         refreshNub();
...
{	
        ...
        sumR_AIN5_DATA += R_AIN5_DATA;
        if(++addtime >=10)
        {
        	R_AIN5_DATA = sumR_AIN5_DATA/addtime;
        	sumR_AIN5_DATA = 0;
        	addtime = 0;
        	checkLowWater();
        }
