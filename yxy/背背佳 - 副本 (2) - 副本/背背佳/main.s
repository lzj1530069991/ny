...
; 2 exit points
	...
	LCALL	_msa_init
	.line	65, "main.c"; 	IOSTA = C_PA3_Input;     // Set PB0 & PB1 to input mode,others set to output mode
	MOVIA	0x08
	IOST	_IOSTA
	.line	66, "main.c"; 	IOSTB = C_PB0_Input | C_PB1_Input;
	MOVIA	0x03
	IOST	_IOSTB
	.line	67, "main.c"; 	APHCON = 0xB7;
	MOVIA	0xb7
	IOST	_APHCON
	.line	68, "main.c"; 	BPHCON = 0xFE;		//PB0拉高	CHRG
	MOVIA	0xfe
	MOVAR	_BPHCON
	.line	69, "main.c"; 	ABPLCON = 0xDF;		//PB1拉低  USB
	MOVIA	0xdf
	MOVAR	_ABPLCON
...
_00134_DS_:
	...
	CLRR	_IntFlag
	.line	94, "main.c"; 	if(keyRead(0x08 & (~PORTA)))
	COMR	_PORTA,W
	BANKSEL	r0x102C
	MOVAR	r0x102C
	MOVIA	0x08
...
_00125_DS_:
	...
	BTRSS	STATUS,2
	LGOTO	_00134_DS_
	.line	114, "main.c"; 	if(++sleepTime > 500)
	BANKSEL	_sleepTime
	INCR	_sleepTime,F
	BTRSC	STATUS,2
	INCR	(_sleepTime + 1),F
...
; 2 exit points
	...
	BANKSEL	_workStep
	CLRR	_workStep
	.line	350, "main.c"; 	rockStep = 0;
	BANKSEL	_rockStep
	CLRR	_rockStep
	.line	351, "main.c"; 	AWUCON = 0x08;
	MOVIA	0x08
	MOVAR	_AWUCON
	.line	352, "main.c"; 	BWUCON = 0x03;
	MOVIA	0x03
	MOVAR	_BWUCON
	.line	353, "main.c"; 	sleepTime = 0;	
	BANKSEL	_sleepTime
	CLRR	_sleepTime
	CLRR	(_sleepTime + 1)
	.line	354, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_PABKey;
	MOVIA	0x03
	MOVAR	_INTE
	.line	355, "main.c"; 	PCON =  C_LVR_En;	
	MOVIA	0x08
	MOVAR	_PCON
	.line	356, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	357, "main.c"; 	CLRWDT();
	clrwdt
	.line	358, "main.c"; 	ENI();
	ENI
	.line	359, "main.c"; 	SLEEP();
	sleep
	.line	360, "main.c"; 	AWUCON = 0x00;
	CLRR	_AWUCON
	.line	361, "main.c"; 	BWUCON = 0x00;
	CLRR	_BWUCON
	.line	362, "main.c"; 	IOSTA &= 0xFC;
	IOSTR	_IOSTA
	BANKSEL	r0x1020
	MOVAR	r0x1020
	MOVIA	0xfc
	...
	MOVR	r0x1020,W
	IOST	_IOSTA
	.line	363, "main.c"; 	IOSTB &= 0xDF;
	IOSTR	_IOSTB
	MOVAR	r0x1020
	BCR	r0x1020,5
	MOVR	r0x1020,W
	IOST	_IOSTB
	.line	364, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_PABKey;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x03
	MOVAR	_INTE
	.line	365, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	370, "main.c"; 	}
	RETURN	
...
;local variable name mapping:
	.debuginfo variable _udata=r0x1022
	.debuginfo variable _Count0=r0x1023
_ind_light_disp:
; 2 exit points
...
;	  766+  138 =   904 instructions ( 2084 byte)
