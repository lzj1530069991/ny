...
; 2 exit points
	...
	MOVIA	0x08
	MOVAR	_PCON
	.line	114, "common.c"; 	PCON &= 0xEF;		//PA5打开上拉
	BCR	_PCON,4
	...
	MOVIA	0xa8
	MOVAR	_PCON
	.line	122, "common.c"; 	PCON &= 0xEF;		//PA5打开上拉
	BCR	_PCON,4
	.line	123, "common.c"; 	}
	RETURN	
...
; 2 exit points
	...
	MOVIA	0x30
	MOVAR	_PORTB
	.line	25, "common.c"; 	BPHCON &= 0xFE;		//PB0上拉	
	BCR	_BPHCON,0
	.line	26, "common.c"; 	APHCON &= 0x20;		//PA5 关闭下拉 PA4 PA6 PA7关闭上拉
	IOSTR	_APHCON
	BANKSEL	r0x1009
	MOVAR	r0x1009
	MOVIA	0x20
	...
	MOVR	r0x1009,W
	IOST	_APHCON
	.line	29, "common.c"; 	IOSTA =  C_PA6_Input | C_PA7_Input | C_PA5_Input | C_PA4_Input;	
	MOVIA	0xf0
	IOST	_IOSTA
	.line	30, "common.c"; 	IOSTB = C_PB0_Input;
	MOVIA	0x01
	IOST	_IOSTB
	...
	MOVIA	0xa8
	MOVAR	_PCON
	.line	34, "common.c"; 	PCON &= 0xEF;			//PA5打开下拉
	BCR	_PCON,4
...
;	  140+   23 =   163 instructions (  372 byte)
