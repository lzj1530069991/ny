...
_00116_DS_:
	...
	LCALL	_ledCon
	.line	86, "main.c"; 	if(countLed == 0 && lockLedCount == 0 && ledFlag == 0 && key2Count == 0)
	BANKSEL	_countLed
	MOVR	_countLed,W
	BTRSS	STATUS,2
	LGOTO	_00122_DS_
...
;;unsigned compare: left >= lit (0x6=6), size=1
	...
	BTRSC	STATUS,0
	LGOTO	_00277_DS_
	.line	250, "main.c"; 	resetbit(PORTA,0);
	BCR	_PORTA,0
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00277_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00274_DS_
	.line	253, "main.c"; 	setbit(PORTA,0);
	BSR	_PORTA,0
	.line	254, "main.c"; 	resetbit(PORTB,7);
	BCR	_PORTB,7
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00274_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00271_DS_
	.line	258, "main.c"; 	setbit(PORTB,7);
	BSR	_PORTB,7
	.line	259, "main.c"; 	resetbit(PORTB,6);
	BCR	_PORTB,6
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00271_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00268_DS_
	.line	263, "main.c"; 	setbit(PORTB,6);
	BSR	_PORTB,6
	.line	264, "main.c"; 	resetbit(PORTB,5);
	BCR	_PORTB,5
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00268_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00265_DS_
	.line	268, "main.c"; 	setbit(PORTB,5);
	BSR	_PORTB,5
	.line	269, "main.c"; 	resetbit(PORTB,4);
	BCR	_PORTB,4
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00259_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00256_DS_
	.line	282, "main.c"; 	setbit(PORTB,4);
	BSR	_PORTB,4
	.line	283, "main.c"; 	resetbit(PORTB,3);
	BCR	_PORTB,3
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00256_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00253_DS_
	.line	287, "main.c"; 	setbit(PORTB,3);
	BSR	_PORTB,3
	.line	288, "main.c"; 	resetbit(PORTB,4);
	BCR	_PORTB,4
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00253_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00250_DS_
	.line	292, "main.c"; 	setbit(PORTB,4);
	BSR	_PORTB,4
	.line	293, "main.c"; 	resetbit(PORTB,5);
	BCR	_PORTB,5
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00250_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00247_DS_
	.line	297, "main.c"; 	setbit(PORTB,5);
	BSR	_PORTB,5
	.line	298, "main.c"; 	resetbit(PORTB,6);
	BCR	_PORTB,6
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00247_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00244_DS_
	.line	302, "main.c"; 	setbit(PORTB,6);
	BSR	_PORTB,6
	.line	303, "main.c"; 	resetbit(PORTB,7);
	BCR	_PORTB,7
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00244_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00241_DS_
	.line	307, "main.c"; 	setbit(PORTB,7);
	BSR	_PORTB,7
	.line	308, "main.c"; 	resetbit(PORTA,0);
	BCR	_PORTA,0
	LGOTO	_00279_DS_
;;swapping arguments (AOP_TYPEs 1/3)
...
_00241_DS_:
	...
	SUBAR	_lockLedCount,W
	BTRSS	STATUS,0
	.line	312, "main.c"; 	setbit(PORTA,0);
	BSR	_PORTA,0
_00279_DS_:
	.line	315, "main.c"; 	}
	RETURN	
...
;;unsigned compare: left < lit (0x5=5), size=1
	...
	BTRSC	STATUS,0
	LGOTO	_00231_DS_
	.line	213, "main.c"; 	resetbit(PORTA,0);
	BCR	_PORTA,0
	LGOTO	_00233_DS_
;;unsigned compare: left < lit (0xA=10), size=1
_00231_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00228_DS_
	.line	216, "main.c"; 	setbit(PORTA,0);
	BSR	_PORTA,0
	.line	217, "main.c"; 	resetbit(PORTB,7);
	BCR	_PORTB,7
	LGOTO	_00233_DS_
...
_00228_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00225_DS_
	.line	221, "main.c"; 	setbit(PORTB,7);
	BSR	_PORTB,7
	.line	222, "main.c"; 	resetbit(PORTB,6);
	BCR	_PORTB,6
	LGOTO	_00233_DS_
...
_00225_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00222_DS_
	.line	226, "main.c"; 	setbit(PORTB,6);
	BSR	_PORTB,6
	.line	227, "main.c"; 	resetbit(PORTB,5);
	BCR	_PORTB,5
	LGOTO	_00233_DS_
...
_00222_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00219_DS_
	.line	231, "main.c"; 	setbit(PORTB,5);
	BSR	_PORTB,5
	.line	232, "main.c"; 	resetbit(PORTB,4);
	BCR	_PORTB,4
	LGOTO	_00233_DS_
...
_00219_DS_:
	...
	BTRSC	STATUS,0
	LGOTO	_00216_DS_
	.line	236, "main.c"; 	setbit(PORTB,4);
	BSR	_PORTB,4
	.line	237, "main.c"; 	resetbit(PORTB,3);
	BCR	_PORTB,3
	LGOTO	_00233_DS_
...
_00216_DS_:
	...
	SUBAR	_lockLedCount,W
	BTRSS	STATUS,0
	.line	241, "main.c"; 	setbit(PORTB,3);
	BSR	_PORTB,3
_00233_DS_:
	.line	244, "main.c"; 	}
	RETURN	
...
;	  560+  117 =   677 instructions ( 1588 byte)
