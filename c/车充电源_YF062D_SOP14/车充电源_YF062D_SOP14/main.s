...
_00181_DS_:
	...
	MOVIA	0x03
	IORAR	_PORTB,F
	.line	124, "main.c"; 	startFlag = 1;
	MOVIA	0x01
	BANKSEL	_startFlag
	MOVAR	_startFlag
	.line	125, "main.c"; 	halfChrg();
	LCALL	_halfChrg
	.line	126, "main.c"; 	resetbit(PORTA,6);		//关闭风扇
	BCR	_PORTA,6
	.line	127, "main.c"; 	continue;
	LGOTO	_00143_DS_
_00125_DS_:
	.line	129, "main.c"; 	checkA();
	LCALL	_checkA
;;unsigned compare: left < lit (0x1=1), size=2
	.line	131, "main.c"; 	if(chrgCount < 1)
	MOVIA	0x00
	BANKSEL	_chrgCount
	SUBAR	(_chrgCount + 1),W
	BTRSS	STATUS,2
...
_00182_DS_:
	BTRSC	STATUS,0
	LGOTO	_00127_DS_
	.line	133, "main.c"; 	maxDuty = 66;
	MOVIA	0x42
	BANKSEL	_maxDuty
	MOVAR	_maxDuty
	LGOTO	_00128_DS_
_00127_DS_:
	.line	137, "main.c"; 	maxDuty = 126;
	MOVIA	0x7e
	BANKSEL	_maxDuty
	MOVAR	_maxDuty
_00128_DS_:
	.line	140, "main.c"; 	if(tempDuty < duty)
	BANKSEL	_duty
	MOVR	_duty,W
	BANKSEL	_tempDuty
	SUBAR	_tempDuty,W
	BTRSC	STATUS,0
	LGOTO	_00132_DS_
	.line	142, "main.c"; 	tempDuty++;
	INCR	_tempDuty,F
	LGOTO	_00006_DS_
_00132_DS_:
	.line	144, "main.c"; 	else if(tempDuty > duty)
	BANKSEL	_tempDuty
	MOVR	_tempDuty,W
	BANKSEL	_duty
	SUBAR	_duty,W
	BTRSC	STATUS,0
	LGOTO	_00006_DS_
	.line	146, "main.c"; 	tempDuty--;
	BANKSEL	_tempDuty
	DECR	_tempDuty,F
_00006_DS_:
	.line	148, "main.c"; 	PWM2DUTY = tempDuty - 1;
	BANKSEL	_tempDuty
	DECR	_tempDuty,W
	BANKSEL	r0x103C
	MOVAR	r0x103C
	SFUN	_PWM2DUTY
	.line	151, "main.c"; 	if(count1S % 5 == 0)
	MOVIA	0x05
	MOVAR	STK00
	BANKSEL	_count1S
	MOVR	_count1S,W
	...
	BTRSS	STATUS,2
	LGOTO	_00141_DS_
	.line	153, "main.c"; 	dutyFlag = 0;
	BANKSEL	_dutyFlag
	CLRR	_dutyFlag
	.line	154, "main.c"; 	avaA = sumA/adTime;
	BANKSEL	_adTime
	MOVR	_adTime,W
	BANKSEL	r0x103C
	MOVAR	r0x103C
...
;;unsigned compare: left >= lit (0xCD=205), size=2
	.line	155, "main.c"; 	if(avaA > 204)				//电流大于2.76A
	MOVIA	0x00
	SUBAR	(_avaA + 1),W
	BTRSS	STATUS,2
	LGOTO	_00185_DS_
...
_00138_DS_:
	.line	159, "main.c"; 	else if(avaA < 190)
	MOVIA	0x00
	BANKSEL	_avaA
	SUBAR	(_avaA + 1),W
	BTRSS	STATUS,2
...
_00186_DS_:
	BTRSC	STATUS,0
	LGOTO	_00135_DS_
	.line	161, "main.c"; 	addFlag = 1;
	MOVIA	0x01
	BANKSEL	_addFlag
	MOVAR	_addFlag
	LGOTO	_00139_DS_
_00135_DS_:
	.line	165, "main.c"; 	addFlag = 0;
	BANKSEL	_addFlag
	CLRR	_addFlag
_00139_DS_:
	.line	167, "main.c"; 	setDuty();
	LCALL	_setDuty
	.line	168, "main.c"; 	sumA = 0;
	BANKSEL	_sumA
	CLRR	_sumA
	CLRR	(_sumA + 1)
	.line	169, "main.c"; 	adTime = 0;		//重置采样次数
	BANKSEL	_adTime
	CLRR	_adTime
_00141_DS_:
	.line	173, "main.c"; 	ledCtr();
	LCALL	_ledCtr
	.line	174, "main.c"; 	ledCon();
	LCALL	_ledCon
	LGOTO	_00143_DS_
	.line	176, "main.c"; 	}
	RETURN	
...
_closeChrg:
; 2 exit points
	.line	445, "main.c"; 	BPHCON |= 0x08;		
	BSR	_BPHCON,3
	.line	446, "main.c"; 	ABPLCON |= 0x80;
	BSR	_ABPLCON,7
	.line	447, "main.c"; 	setbit(PORTB,3);		//3 5脚高电平，关闭充电
	BSR	_PORTB,3
	.line	448, "main.c"; 	setbit(PORTA,7);
	BSR	_PORTA,7
	.line	449, "main.c"; 	}
	RETURN	
...
_halfChrg:
; 2 exit points
	.line	437, "main.c"; 	BPHCON &= 0xF7;		//PB3上拉
	BCR	_BPHCON,3
	.line	438, "main.c"; 	ABPLCON &= 0x7F;
	BCR	_ABPLCON,7
	.line	439, "main.c"; 	IOSTB =  C_PB3_Input;	
	MOVIA	0x08
	IOST	_IOSTB
	.line	440, "main.c"; 	setbit(PORTB,3);		//5脚高电平，降压涓充
	BSR	_PORTB,3
	.line	441, "main.c"; 	resetbit(PORTA,7);
	BCR	_PORTA,7
	.line	442, "main.c"; 	}
	RETURN	
...
_fullChrg:
; 2 exit points
	.line	429, "main.c"; 	BPHCON |= 0x08;		
	BSR	_BPHCON,3
	.line	430, "main.c"; 	ABPLCON |= 0x80;
	BSR	_ABPLCON,7
	.line	431, "main.c"; 	IOSTB =  0;	
	CLRA	
	IOST	_IOSTB
	.line	432, "main.c"; 	resetbit(PORTB,3);
	BCR	_PORTB,3
	.line	433, "main.c"; 	resetbit(PORTA,7);
	BCR	_PORTA,7
	.line	434, "main.c"; 	}
	RETURN	
...
_delay:
; 2 exit points
	.line	421, "main.c"; 	void delay(uint16_t time)
	BANKSEL	r0x1026
	MOVAR	r0x1026
	MOVR	STK00,W
	BANKSEL	r0x1027
	MOVAR	r0x1027
	.line	423, "main.c"; 	for(uint16_t i=0;i<time;i++);
	BANKSEL	r0x1028
	CLRR	r0x1028
	BANKSEL	r0x1029
	CLRR	r0x1029
...
; 2 exit points
_00382_DS_:
	.line	417, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	LGOTO	_00382_DS_
	.line	419, "main.c"; 	}
	RETURN	
...
_F_AIN0_Convert:
; 2 exit points
	.line	401, "main.c"; 	void F_AIN0_Convert(char count)
	BANKSEL	r0x102A
	MOVAR	r0x102A
	...
	MOVIA	0x00
	LCALL	_delay
	.line	406, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x102B
	MOVAR	r0x102B
_00375_DS_:
	...
	BTRSS	STATUS,0
	LGOTO	_00377_DS_
	.line	408, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	409, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete
	LCALL	_F_wait_eoc
	.line	410, "main.c"; 	R_AIN0_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x102C
	BANKSEL	_R_AIN0_DATA_LB
	ADDAR	_R_AIN0_DATA_LB,F
	.line	411, "main.c"; 	R_AIN0_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x102C
	MOVAR	r0x102C
;;1	CLRR	r0x102D
...
_checkA:
; 2 exit points
	.line	387, "main.c"; 	PACON = C_PA0_AIN0;
	MOVIA	0x01
	MOVAR	_PACON
	.line	388, "main.c"; 	R_AIN0_DATA=R_AIN0_DATA_LB=0x00;
	BANKSEL	_R_AIN0_DATA_LB
	CLRR	_R_AIN0_DATA_LB
	BANKSEL	_R_AIN0_DATA
	CLRR	_R_AIN0_DATA
	CLRR	(_R_AIN0_DATA + 1)
	.line	389, "main.c"; 	F_AIN0_Convert(8);					// execute AIN0 ADC converting 8 times
	MOVIA	0x08
	LCALL	_F_AIN0_Convert
	.line	390, "main.c"; 	R_AIN0_DATA <<= 4;					// R_AIN0_DATA shift left 4 bit
	BANKSEL	_R_AIN0_DATA
	...
	.line	391, "main.c"; 	R_AIN0_DATA_LB &= 0xF0;				// Only get Bit7~4
	MOVIA	0xf0
	BANKSEL	_R_AIN0_DATA_LB
	ANDAR	_R_AIN0_DATA_LB,F
	.line	392, "main.c"; 	R_AIN0_DATA += R_AIN0_DATA_LB;		// R_AIN0_DATA + R_AIN0_DATA_LB
...
_00003_DS_:
	.line	393, "main.c"; 	R_AIN0_DATA >>=3;					// R_AIN0_DATA divided 8
	BCR	STATUS,0
	BANKSEL	_R_AIN0_DATA
...
;;shiftRight_Left2ResultLit:5586: shCount=1, size=2, sign=0, same=1, offr=0
	...
	RRR	(_R_AIN0_DATA + 1),F
	RRR	_R_AIN0_DATA,F
	.line	394, "main.c"; 	sumA += R_AIN0_DATA;
	MOVR	_R_AIN0_DATA,W
	BANKSEL	_sumA
	ADDAR	_sumA,F
	BANKSEL	_R_AIN0_DATA
...
_initAD:
; 2 exit points
	.line	363, "main.c"; 	ADMD  = C_ADC_En | C_ADC_CH_Dis | C_ADC_PA0 ;	// Enable ADC power, Disable global ADC input channel, Select PA0 pad as ADC input (SFR "ADMD")
	MOVIA	0x80
	MOVAR	_ADMD
	.line	366, "main.c"; 	ADVREFH = C_Vrefh_2V;					// ADC reference high voltage is supplied by internal 4V  (Note: ADC clock freq. must be equal or less than 1MHz)
	CLRR	_ADVREFH
	.line	373, "main.c"; 	ADR	  = C_Ckl_Div8;						// ADC clock=Fcpu/8, Clear ADIF, disable ADC interrupt	
	MOVIA	0x10
	MOVAR	_ADR
	.line	375, "main.c"; 	ADCR  = C_Sample_1clk | C_12BIT;
	MOVIA	0x03
	MOVAR	_ADCR
	.line	378, "main.c"; 	ADMDbits.GCHS = 1;						// Enable global ADC channel	(SFR "ADMD")
	BSR	_ADMDbits,4
	.line	379, "main.c"; 	delay(100);								// Delay 0.56ms(Instruction clock=4MHz/2T) for waiting ADC stable 
	MOVIA	0x64
	MOVAR	STK00
	MOVIA	0x00
	LCALL	_delay
...
_00342_DS_:
	...
	LGOTO	_00344_DS_
_00343_DS_:
	.line	353, "main.c"; 	ledMin = 0;
	BANKSEL	_ledMin
	CLRR	_ledMin
_00344_DS_:
	.line	356, "main.c"; 	if(ledCount < ledMin)
	BANKSEL	_ledMin
	MOVR	_ledMin,W
	BANKSEL	r0x1034
	MOVAR	r0x1034
...
_00360_DS_:
	BTRSC	STATUS,0
	LGOTO	_00347_DS_
	.line	357, "main.c"; 	ledCount = ledMin;
	BANKSEL	r0x1034
	MOVR	r0x1034,W
	BANKSEL	_ledCount
	MOVAR	_ledCount
...
_pwmStart:
; 2 exit points
	.line	317, "main.c"; 	TMRH = 0;
	CLRR	_TMRH
	.line	318, "main.c"; 	TMR2 = 127;
	MOVIA	0x7f
	SFUN	_TMR2
	.line	319, "main.c"; 	PWM2DUTY = 1;
	MOVIA	0x01
	SFUN	_PWM2DUTY
	.line	320, "main.c"; 	T2CR1 = C_PWM2_En | C_TMR2_Reload | C_TMR2_En;	    //reloaded from TMR2, non-stop mode
	MOVIA	0x83
	SFUN	_T2CR1
	.line	321, "main.c"; 	T2CR2 = C_TMR2_ClkSrc_Inst | C_PS2_Div2;	// Enable Prescaler2, Prescaler2 dividing rate = 1:2, Timer2 clock source is instruction clock 
	CLRA	
	SFUN	_T2CR2
	.line	322, "main.c"; 	}
	RETURN	
...
_ledCon:
; 2 exit points
	.line	298, "main.c"; 	if(ledCount < ledMin)
	BANKSEL	_ledMin
	MOVR	_ledMin,W
	BANKSEL	r0x1036
	MOVAR	r0x1036
...
_00316_DS_:
	BTRSC	STATUS,0
	LGOTO	_00275_DS_
	.line	299, "main.c"; 	ledCount = ledMin;
	BANKSEL	r0x1036
	MOVR	r0x1036,W
	BANKSEL	_ledCount
	MOVAR	_ledCount
	...
	MOVAR	(_ledCount + 1)
_00275_DS_:
	.line	300, "main.c"; 	ledLock = 1;		//锁定
	MOVIA	0x01
	BANKSEL	_ledLock
	MOVAR	_ledLock
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x33=51), size=2
	.line	301, "main.c"; 	ledCount > 50 ? (setbit(PORTB,1)) : (resetbit(PORTB,1));
	MOVIA	0x00
	BANKSEL	_ledCount
	SUBAR	(_ledCount + 1),W
	BTRSS	STATUS,2
...
_00283_DS_:
	.line	302, "main.c"; 	ledCount > 100 ? (setbit(PORTB,0)) : (resetbit(PORTB,0));
	MOVIA	0x00
	BANKSEL	_ledCount
	SUBAR	(_ledCount + 1),W
	BTRSS	STATUS,2
...
_00285_DS_:
	.line	303, "main.c"; 	ledCount > 150 ? (setbit(PORTA,2)) : (resetbit(PORTA,2));
	MOVIA	0x00
	BANKSEL	_ledCount
	SUBAR	(_ledCount + 1),W
	BTRSS	STATUS,2
...
_00287_DS_:
	.line	304, "main.c"; 	ledCount > 200 ? (setbit(PORTA,3)) : (resetbit(PORTA,3));
	MOVIA	0x00
	BANKSEL	_ledCount
	SUBAR	(_ledCount + 1),W
	BTRSS	STATUS,2
...
_00289_DS_:
	.line	305, "main.c"; 	ledCount > 250 ? (setbit(PORTA,4)) : (resetbit(PORTA,4));
	MOVIA	0x00
	BANKSEL	_ledCount
	SUBAR	(_ledCount + 1),W
	BTRSS	STATUS,2
...
_00291_DS_:
	.line	306, "main.c"; 	if(ledCount > 300)
	MOVIA	0x01
	BANKSEL	_ledCount
	SUBAR	(_ledCount + 1),W
	BTRSS	STATUS,2
...
_00322_DS_:
	BTRSS	STATUS,0
	LGOTO	_00280_DS_
	.line	308, "main.c"; 	if(ledCount > ledMax)
	BANKSEL	_ledCount
	MOVR	(_ledCount + 1),W
	BANKSEL	_ledMax
	SUBAR	(_ledMax + 1),W
...
_00323_DS_:
	BTRSC	STATUS,0
	LGOTO	_00277_DS_
	.line	309, "main.c"; 	ledCount = ledMin;
	BANKSEL	r0x1036
	MOVR	r0x1036,W
	BANKSEL	_ledCount
	MOVAR	_ledCount
...
_initTimer0:
; 2 exit points
	.line	270, "main.c"; 	PORTA = 0x23;
	MOVIA	0x23
	MOVAR	_PORTA
	.line	271, "main.c"; 	PORTB = 0xF8;
	MOVIA	0xf8
	MOVAR	_PORTB
	.line	272, "main.c"; 	BPHCON = 0xFE;
	MOVIA	0xfe
	MOVAR	_BPHCON
	.line	274, "main.c"; 	IOSTA = C_PA0_Input;
	MOVIA	0x01
	IOST	_IOSTA
	.line	275, "main.c"; 	IOSTB =  0;	
	CLRA	
	IOST	_IOSTB
	.line	276, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En;				// Enable WDT & LVR
	MOVIA	0xa8
	MOVAR	_PCON
	.line	277, "main.c"; 	INTE =  C_INT_TMR0;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x01
	MOVAR	_INTE
	.line	278, "main.c"; 	INTF = 0;
	CLRR	_INTF
	...
	CLRA	
	T0MD	
	.line	286, "main.c"; 	PCON1 = C_LVD_3P0V | C_TMR0_En;
	MOVIA	0x11
	IOST	_PCON1
	.line	288, "main.c"; 	PORTA &= 0x23;
	MOVIA	0x23
	ANDAR	_PORTA,F
	.line	289, "main.c"; 	PORTB &= 0xF0;
	MOVIA	0xf0
	ANDAR	_PORTB,F
	.line	290, "main.c"; 	resetbit(PORTB,3);		
	BCR	_PORTB,3
	.line	291, "main.c"; 	resetbit(PORTA,7);
	BCR	_PORTA,7
	.line	292, "main.c"; 	ENI();	
	ENI
	.line	294, "main.c"; 	}
...
_setDuty:
; 2 exit points
	.line	181, "main.c"; 	if(dutyFlag == 0)
	BANKSEL	_dutyFlag
	MOVR	_dutyFlag,W
	BTRSS	STATUS,2
	LGOTO	_00223_DS_
	.line	183, "main.c"; 	dutyFlag = 1;
	MOVIA	0x01
	MOVAR	_dutyFlag
	.line	184, "main.c"; 	if(addFlag == 1)
	BANKSEL	_addFlag
	MOVR	_addFlag,W
	XORIA	0x01
	BTRSS	STATUS,2
	LGOTO	_00198_DS_
	.line	187, "main.c"; 	if(--duty == 0)
	BANKSEL	_duty
	DECRSZ	_duty,F
	LGOTO	_00199_DS_
	.line	189, "main.c"; 	duty = 1;
	MOVIA	0x01
	MOVAR	_duty
	LGOTO	_00199_DS_
_00198_DS_:
	.line	192, "main.c"; 	else if(addFlag == 2)
	BANKSEL	_addFlag
	MOVR	_addFlag,W
	XORIA	0x02
	BTRSS	STATUS,2
	LGOTO	_00199_DS_
	.line	195, "main.c"; 	if(++duty > maxDuty)
	BANKSEL	_duty
	INCR	_duty,F
	MOVR	_duty,W
	BANKSEL	_maxDuty
	...
	BTRSC	STATUS,0
	LGOTO	_00199_DS_
	.line	197, "main.c"; 	duty = maxDuty;
	MOVR	_maxDuty,W
	BANKSEL	_duty
	MOVAR	_duty
;;unsigned compare: left < lit (0x41=65), size=2
_00199_DS_:
	.line	201, "main.c"; 	if(avaA < 65)
	MOVIA	0x00
	BANKSEL	_avaA
	SUBAR	(_avaA + 1),W
	BTRSS	STATUS,2
...
_00265_DS_:
	BTRSC	STATUS,0
	LGOTO	_00219_DS_
	.line	203, "main.c"; 	if(duty == 126 && (++fullCount > 200))		//未充电
	BANKSEL	_duty
	MOVR	_duty,W
	XORIA	0x7e
	BTRSS	STATUS,2
...
;;unsigned compare: left >= lit (0xC9=201), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00201_DS_
	.line	205, "main.c"; 	fullChrg();
	LCALL	_fullChrg
	.line	206, "main.c"; 	workStep = 2;
	MOVIA	0x02
	BANKSEL	_workStep
	MOVAR	_workStep
	.line	207, "main.c"; 	resetbit(PORTA,6);		//关闭风扇
	BCR	_PORTA,6
	.line	208, "main.c"; 	startFlag = 0;
	BANKSEL	_startFlag
	CLRR	_startFlag
	.line	209, "main.c"; 	ledStep = 0;
	BANKSEL	_ledStep
	CLRR	_ledStep
	.line	210, "main.c"; 	chrgCount = 0;
	BANKSEL	_chrgCount
	CLRR	_chrgCount
	CLRR	(_chrgCount + 1)
	...
	LGOTO	_00223_DS_
_00201_DS_:
	.line	215, "main.c"; 	startFlag = 1;
	MOVIA	0x01
	BANKSEL	_startFlag
	MOVAR	_startFlag
	.line	216, "main.c"; 	halfChrg();
	LCALL	_halfChrg
	.line	217, "main.c"; 	duty = 1;
	MOVIA	0x01
	BANKSEL	_duty
	MOVAR	_duty
	.line	218, "main.c"; 	resetbit(PORTA,6);		//关闭风扇,涓流充电
	BCR	_PORTA,6
	.line	219, "main.c"; 	workStep = 3;
	MOVIA	0x03
	BANKSEL	_workStep
	MOVAR	_workStep
	...
	LGOTO	_00223_DS_
_00219_DS_:
	.line	226, "main.c"; 	setbit(PORTA,6);		//打开风扇
	BSR	_PORTA,6
	.line	227, "main.c"; 	fullChrg();
	LCALL	_fullChrg
	.line	228, "main.c"; 	sleepCount = 0;
	BANKSEL	_sleepCount
	CLRR	_sleepCount
	CLRR	(_sleepCount + 1)
	.line	229, "main.c"; 	fullCount = 0;
	BANKSEL	_fullCount
	CLRR	_fullCount
	.line	230, "main.c"; 	workStep = 1;
	MOVIA	0x01
	BANKSEL	_workStep
	MOVAR	_workStep
	.line	231, "main.c"; 	sumDuty += duty;
	BANKSEL	_duty
	MOVR	_duty,W
	BANKSEL	r0x1038
	MOVAR	r0x1038
...
;;100	MOVR	r0x103A,W
	...
	ADDAR	(_sumDuty + 1),F
_00005_DS_:
	.line	232, "main.c"; 	if(++dutyTime >=10)
	BANKSEL	_dutyTime
	INCR	_dutyTime,F
;;unsigned compare: left < lit (0xA=10), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00223_DS_
	.line	234, "main.c"; 	avaDuty = sumDuty/dutyTime;
	MOVR	_dutyTime,W
	BANKSEL	r0x1038
	MOVAR	r0x1038
	BANKSEL	r0x1039
	...
	BANKSEL	_avaDuty
	MOVAR	_avaDuty
	.line	235, "main.c"; 	dutyTime = 0;
	BANKSEL	_dutyTime
	CLRR	_dutyTime
	.line	236, "main.c"; 	sumDuty = 0;
	BANKSEL	_sumDuty
	CLRR	_sumDuty
	CLRR	(_sumDuty + 1)
;;unsigned compare: left < lit (0x2=2), size=1
	.line	237, "main.c"; 	if(avaDuty < 2)
	MOVIA	0x02
	BANKSEL	_avaDuty
	SUBAR	_avaDuty,W
	BTRSC	STATUS,0
	LGOTO	_00214_DS_
	.line	239, "main.c"; 	ledStep = 1;
	MOVIA	0x01
	BANKSEL	_ledStep
	MOVAR	_ledStep
	LGOTO	_00223_DS_
...
_00214_DS_:
	.line	241, "main.c"; 	else if(avaDuty < 18)
	MOVIA	0x12
	BANKSEL	_avaDuty
	SUBAR	_avaDuty,W
	BTRSC	STATUS,0
	LGOTO	_00211_DS_
	.line	243, "main.c"; 	ledStep = 2;
	MOVIA	0x02
	BANKSEL	_ledStep
	MOVAR	_ledStep
	LGOTO	_00223_DS_
...
_00211_DS_:
	.line	245, "main.c"; 	else if(avaDuty < 32)
	MOVIA	0x20
	BANKSEL	_avaDuty
	SUBAR	_avaDuty,W
	BTRSC	STATUS,0
	LGOTO	_00208_DS_
	.line	247, "main.c"; 	ledStep = 3;
	MOVIA	0x03
	BANKSEL	_ledStep
	MOVAR	_ledStep
	LGOTO	_00223_DS_
...
_00208_DS_:
	.line	249, "main.c"; 	else if(avaDuty < 36)
	MOVIA	0x24
	BANKSEL	_avaDuty
	SUBAR	_avaDuty,W
	BTRSC	STATUS,0
	LGOTO	_00205_DS_
	.line	251, "main.c"; 	ledStep = 4;
	MOVIA	0x04
	BANKSEL	_ledStep
	MOVAR	_ledStep
	LGOTO	_00223_DS_
_00205_DS_:
	.line	255, "main.c"; 	ledStep = 5;
	MOVIA	0x05
	BANKSEL	_ledStep
	MOVAR	_ledStep
_00223_DS_:
...
;	  653+  176 =   829 instructions ( 2010 byte)
