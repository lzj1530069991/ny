...
_delayms:
; 2 exit points
	.line	268, "number.c"; 	void delayms(u8t time)
	BANKSEL	r0x1000
	MOVAR	r0x1000
	.line	270, "number.c"; 	for(u8t i=0;i<time;i++);
	BANKSEL	r0x1001
	CLRR	r0x1001
_00336_DS_:
	BANKSEL	r0x1000
...
_setInput:
; 2 exit points
	.line	265, "number.c"; 	IOSTA |= 0x1F;		//PA0-PA2设为输入脚
	IOSTR	_IOSTA
	BANKSEL	r0x1002
	MOVAR	r0x1002
	MOVIA	0x1f
...
_setOutput:
; 2 exit points
	.line	241, "number.c"; 	void setOutput(char outPut)
	BANKSEL	r0x1003
	MOVAR	r0x1003
;;unsigned compare: left < lit (0x1=1), size=1
	.line	243, "number.c"; 	switch(outPut)
	MOVIA	0x01
	SUBAR	r0x1003,W
	BTRSS	STATUS,0
	LGOTO	_00315_DS_
...
_00311_DS_:
	...
	MOVR	r0x1003,W
	IOST	_IOSTA
	.line	253, "number.c"; 	break;
	LGOTO	_00315_DS_
_00312_DS_:
	.line	255, "number.c"; 	IOSTA &= 0xFD;
	IOSTR	_IOSTA
	BANKSEL	r0x1003
	MOVAR	r0x1003
	BCR	r0x1003,1
	MOVR	r0x1003,W
	IOST	_IOSTA
	.line	256, "number.c"; 	break;
	LGOTO	_00315_DS_
_00313_DS_:
	.line	258, "number.c"; 	IOSTA &= 0xFE;
	IOSTR	_IOSTA
	BANKSEL	r0x1003
	MOVAR	r0x1003
	BCR	r0x1003,0
...
_setlowOutput:
; 2 exit points
	.line	218, "number.c"; 	void setlowOutput(char outPut)
	BANKSEL	r0x1004
	MOVAR	r0x1004
;;unsigned compare: left < lit (0x1=1), size=1
	.line	220, "number.c"; 	switch(outPut)
	MOVIA	0x01
	SUBAR	r0x1004,W
	BTRSS	STATUS,0
	LGOTO	_00294_DS_
...
_00304_DS_:
	...
	LGOTO	_00288_DS_
_00288_DS_:
	.line	223, "number.c"; 	PORTA &= 0xEF;
	BCR	_PORTA,4
	.line	224, "number.c"; 	break;
	LGOTO	_00294_DS_
_00289_DS_:
	.line	226, "number.c"; 	PORTA &= 0xF7;
	BCR	_PORTA,3
	.line	227, "number.c"; 	break;
	LGOTO	_00294_DS_
_00290_DS_:
	.line	229, "number.c"; 	PORTA &= 0xFB;
	BCR	_PORTA,2
	.line	230, "number.c"; 	break;
	LGOTO	_00294_DS_
_00291_DS_:
	.line	232, "number.c"; 	PORTA &= 0xFD;
	BCR	_PORTA,1
	.line	233, "number.c"; 	break;
	LGOTO	_00294_DS_
_00292_DS_:
	.line	235, "number.c"; 	PORTA &= 0xFE;
	BCR	_PORTA,0
_00294_DS_:
	.line	238, "number.c"; 	}
	RETURN	
...
_setHightOutput:
; 2 exit points
	.line	195, "number.c"; 	void setHightOutput(char outPut)
	BANKSEL	r0x1005
	MOVAR	r0x1005
;;unsigned compare: left < lit (0x1=1), size=1
	.line	197, "number.c"; 	switch(outPut)
	MOVIA	0x01
	SUBAR	r0x1005,W
	BTRSS	STATUS,0
	LGOTO	_00273_DS_
...
_00283_DS_:
	...
	LGOTO	_00267_DS_
_00267_DS_:
	.line	200, "number.c"; 	PORTA |= 0x10;
	BSR	_PORTA,4
	.line	201, "number.c"; 	break;
	LGOTO	_00273_DS_
_00268_DS_:
	.line	203, "number.c"; 	PORTA |= 0x08;
	BSR	_PORTA,3
	.line	204, "number.c"; 	break;
	LGOTO	_00273_DS_
_00269_DS_:
	.line	206, "number.c"; 	PORTA |= 0x04;
	BSR	_PORTA,2
	.line	207, "number.c"; 	break;
	LGOTO	_00273_DS_
_00270_DS_:
	.line	209, "number.c"; 	PORTA |= 0x02;
	BSR	_PORTA,1
	.line	210, "number.c"; 	break;
	LGOTO	_00273_DS_
_00271_DS_:
	.line	212, "number.c"; 	PORTA |= 0x01;
	BSR	_PORTA,0
_00273_DS_:
	.line	215, "number.c"; 	}
	RETURN	
...
; 2 exit points
	...
	MOVIA	0xe0
	ANDAR	_PORTA,F
	.line	185, "number.c"; 	setOutput(hight);	//设置输出方向
	BANKSEL	r0x1006
	MOVR	r0x1006,W
	LCALL	_setOutput
	.line	186, "number.c"; 	setHightOutput(hight);
	BANKSEL	r0x1006
	MOVR	r0x1006,W
	LCALL	_setHightOutput
	.line	187, "number.c"; 	setOutput(low);		//设置输出方向
	BANKSEL	r0x1007
	MOVR	r0x1007,W
	LCALL	_setOutput
	.line	188, "number.c"; 	setlowOutput(low);
	BANKSEL	r0x1007
	MOVR	r0x1007,W
	LCALL	_setlowOutput
	.line	189, "number.c"; 	delayms(10);
	MOVIA	0x0a
	LCALL	_delayms
	.line	190, "number.c"; 	CLRWDT(); 
	clrwdt
	.line	191, "number.c"; 	PORTA &= 0xE0;	
	MOVIA	0xe0
	ANDAR	_PORTA,F
	.line	192, "number.c"; 	}
	RETURN	
...
;	  350+   41 =   391 instructions (  864 byte)
