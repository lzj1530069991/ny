...
_00161_DS_:
	.line	240, "main.c"; 	else if(revCount < 1)
	MOVIA	0x01
	BANKSEL	_revCount
	SUBAR	_revCount,W
	BTRSC	STATUS,0
...
_delay:
; 2 exit points
	.line	828, "main.c"; 	void delay(u8t count)
	BANKSEL	r0x1037
	MOVAR	r0x1037
...
; 2 exit points
_00538_DS_:
	.line	824, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	MGOTO	_00538_DS_
	.line	826, "main.c"; 	}
	RETURN	
...
; 2 exit points
	.line	809, "main.c"; 	void F_Quarter_VDD_Convert(char count)
	BANKSEL	r0x1039
	MOVAR	r0x1039
	.line	812, "main.c"; 	ADMD  = 0x90 | C_Quarter_VDD;			// Select internal 1/4VDD as ADC input
	MOVIA	0x9b
	MOVAR	_ADMD
	.line	813, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x103A
	MOVAR	r0x103A
_00531_DS_:
	...
	BTRSS	STATUS,0
	MGOTO	_00533_DS_
	.line	815, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	816, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete	
	MCALL	_F_wait_eoc
	.line	817, "main.c"; 	R_Quarter_VDD_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x103B
	BANKSEL	_R_Quarter_VDD_DATA_LB
	ADDAR	_R_Quarter_VDD_DATA_LB,F
	.line	818, "main.c"; 	R_Quarter_VDD_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x103B
	MOVAR	r0x103B
;;1	CLRR	r0x103C
...
;;unsigned compare: left >= lit (0x867=2151), size=2
	.line	699, "main.c"; 	if(R_Quarter_VDD_DATA > 2150)
	MOVIA	0x08
...
;;unsigned compare: left < lit (0x7CE=1998), size=2
	.line	724, "main.c"; 	if(R_Quarter_VDD_DATA >= 1998)
	MOVIA	0x07
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00510_DS_:
	BTRSS	STATUS,0
	MGOTO	_00399_DS_
	.line	726, "main.c"; 	tempValue = (R_Quarter_VDD_DATA - 1998)/2 + 49;
	MOVIA	0x32
	BANKSEL	_R_Quarter_VDD_DATA
...
_00399_DS_:
	.line	728, "main.c"; 	else if(R_Quarter_VDD_DATA >= 1886)
	MOVIA	0x07
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00511_DS_:
	BTRSS	STATUS,0
	MGOTO	_00396_DS_
	.line	730, "main.c"; 	tempValue = ((R_Quarter_VDD_DATA - 1886)/4) + 21;
	MOVIA	0xa2
	BANKSEL	_R_Quarter_VDD_DATA
	ADDAR	_R_Quarter_VDD_DATA,W
	BANKSEL	r0x1041
...
_00396_DS_:
	.line	732, "main.c"; 	else if(R_Quarter_VDD_DATA > 1550)
	MOVIA	0x06
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00512_DS_:
	BTRSS	STATUS,0
	MGOTO	_00393_DS_
	.line	734, "main.c"; 	tempValue = (R_Quarter_VDD_DATA - 1550)/16;
	MOVIA	0xf2
	BANKSEL	_R_Quarter_VDD_DATA
	ADDAR	_R_Quarter_VDD_DATA,W
	BANKSEL	r0x1041
...
_00005_DS_:
	...
	MGOTO	_00400_DS_
_00393_DS_:
	.line	738, "main.c"; 	tempValue = 0;
	BANKSEL	r0x103F
	CLRR	r0x103F
	BANKSEL	r0x1040
	CLRR	r0x1040
_00400_DS_:
	.line	740, "main.c"; 	if(0x20 & PORTA)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	MGOTO	_00434_DS_
;;unsigned compare: left < lit (0x5=5), size=2
	.line	744, "main.c"; 	if(tempValue < 5)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00419_DS_:
	.line	748, "main.c"; 	else if(tempValue < 20)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00514_DS_:
	BTRSC	STATUS,0
	MGOTO	_00416_DS_
	.line	750, "main.c"; 	tempValue = tempValue - 5;
	MOVIA	0xfb
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00416_DS_:
	.line	752, "main.c"; 	else if(tempValue < 30)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00515_DS_:
	BTRSC	STATUS,0
	MGOTO	_00413_DS_
	.line	754, "main.c"; 	tempValue = tempValue - 10;
	MOVIA	0xf6
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00413_DS_:
	.line	756, "main.c"; 	else if(tempValue < 40)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00516_DS_:
	BTRSC	STATUS,0
	MGOTO	_00410_DS_
	.line	758, "main.c"; 	tempValue = tempValue - 15;
	MOVIA	0xf1
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00410_DS_:
	.line	760, "main.c"; 	else if(tempValue < 50)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00517_DS_:
	BTRSC	STATUS,0
	MGOTO	_00407_DS_
	.line	762, "main.c"; 	tempValue = tempValue - 21;
	MOVIA	0xeb
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00407_DS_:
	.line	764, "main.c"; 	else if(tempValue < 70)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00518_DS_:
	BTRSC	STATUS,0
	MGOTO	_00404_DS_
	.line	766, "main.c"; 	tempValue = tempValue - 22;
	MOVIA	0xea
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00404_DS_:
	.line	768, "main.c"; 	else if(tempValue < 120)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00519_DS_:
	BTRSC	STATUS,0
	MGOTO	_00011_DS_
	.line	770, "main.c"; 	tempValue = tempValue - 23;
	MOVIA	0xe9
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00520_DS_:
	...
	CLRR	r0x1040
_00422_DS_:
	.line	777, "main.c"; 	if(pwStep < tempValue)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BANKSEL	r0x1041
	MOVAR	r0x1041
...
_00522_DS_:
	...
	CLRR	r0x1040
_00426_DS_:
	.line	788, "main.c"; 	if(pwStep == 0)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BTRSS	STATUS,2
	MGOTO	_00428_DS_
	.line	790, "main.c"; 	pwStep = tempValue;
	BANKSEL	r0x103F
	MOVR	r0x103F,W
	BANKSEL	_pwStep
	MOVAR	_pwStep
_00428_DS_:
	.line	792, "main.c"; 	if(pwStep > tempValue)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BANKSEL	r0x1041
	MOVAR	r0x1041
...
_00524_DS_:
	BTRSS	STATUS,0
	MGOTO	_00442_DS_
	.line	796, "main.c"; 	count5s = 0;
	BANKSEL	_count5s
	CLRR	_count5s
	CLRR	(_count5s + 1)
	.line	797, "main.c"; 	pwStep--;
	BANKSEL	_pwStep
	DECR	_pwStep,F
_00442_DS_:
	.line	805, "main.c"; 	}
...
;	 1114+  366 =  1480 instructions ( 3692 byte)
