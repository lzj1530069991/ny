...
void checkBat()
{
    ...
    {
    	u16t tempValue = 0;
    	if(R_Quarter_VDD_DATA >= 720)
    	{
    		tempValue = (R_Quarter_VDD_DATA - 720) + 40;
    	}
    	else if(R_Quarter_VDD_DATA >= 630)
    	{
    		tempValue = ((R_Quarter_VDD_DATA - 630)/3) + 10;
    	}
    	else if(R_Quarter_VDD_DATA > 550)
    	{
    		tempValue = (R_Quarter_VDD_DATA - 630)/8;
    	}
    	else
    	{
    		tempValue = 0;
