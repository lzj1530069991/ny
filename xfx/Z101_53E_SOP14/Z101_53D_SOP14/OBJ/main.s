...
_gotoSleep:
; 2 exit points
	.line	416, "main.c"; 	sleepTime = 0;
	BANKSEL	_sleepTime
	CLRR	_sleepTime
	.line	418, "main.c"; 	workStop();
	MCALL	_workStop
	.line	419, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	420, "main.c"; 	BWUCON = 0x18;
	MOVIA	0x18
	MOVAR	_BWUCON
	.line	421, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_TMR1 | C_INT_PBKey;
	MOVIA	0x0b
	MOVAR	_INTE
	.line	422, "main.c"; 	PCON =  C_LVR_En;	
	MOVIA	0x08
	MOVAR	_PCON
	.line	423, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	424, "main.c"; 	CLRWDT();
	clrwdt
	.line	425, "main.c"; 	ENI();
	ENI
	.line	426, "main.c"; 	SLEEP();
	sleep
	.line	427, "main.c"; 	BWUCON = 0x00;
	CLRR	_BWUCON
	.line	428, "main.c"; 	INTE =  C_INT_TMR0 ;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x01
	MOVAR	_INTE
	.line	429, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	431, "main.c"; 	PCON = C_WDT_En | C_LVR_En;				// Enable WDT ,  Enable LVR
	MOVIA	0x88
	MOVAR	_PCON
	.line	433, "main.c"; 	}
	RETURN	
...
_pwm1Stop:
; 2 exit points
	.line	408, "main.c"; 	T1CR1 = C_TMR1_Dis;
	CLRA	
	SFUN	_T1CR1
	.line	409, "main.c"; 	pwmFlag = 0;
	BANKSEL	_Status
	BCR	_Status,4
	.line	410, "main.c"; 	}
	RETURN	
...
_00286_DS_:
	...
	BANKSEL	_Status
	BSR	_Status,4
	.line	398, "main.c"; 	TMRH = 0x00;
	CLRA	
	SFUN	_TMRH
	.line	399, "main.c"; 	TMR1 = 199;							//频率为110K
	MOVIA	0xc7
	SFUN	_TMR1
	.line	402, "main.c"; 	T1CR2 = C_TMR1_ClkSrc_Inst | C_PS1_Div256;	// Enable Prescaler1, Prescaler1 dividing rate = 1:2, Timer1 clock source is instruction clock 
	MOVIA	0x07
	SFUN	_T1CR2
	.line	403, "main.c"; 	T1CR1 = C_PWM1_En | C_TMR1_Reload | C_TMR1_En;	// PWM1 output will be present on PB6 , PWM1 output is active high, reloaded from TMR1, non-stop mode
	MOVIA	0x83
	SFUN	_T1CR1
_00287_DS_:
	.line	404, "main.c"; 	}
...
;	  464+  123 =   587 instructions ( 1420 byte)
