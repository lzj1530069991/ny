...
_revOKCount:
	dw	0x00
	.debuginfo gvariable name=_revOKCount,1byte,array=0,entsize=1,ext=1,enc=unsigned
...
_00136_DS_:
	...
	BANKSEL	_powerGe
	MOVAR	_powerGe
	.line	176, "main.c"; 	if(pwFlag)
	BANKSEL	_pwFlag
	MOVR	_pwFlag,W
	BTRSC	STATUS,2
	MGOTO	_00158_DS_
	.line	179, "main.c"; 	if((++count250ms >= 35) || revCountFlag || irStep)
	BANKSEL	_count250ms
	INCR	_count250ms,F
;;unsigned compare: left < lit (0x23=35), size=1
	...
	BTRSC	STATUS,0
	MGOTO	_00153_DS_
	BANKSEL	_revCountFlag
	MOVR	_revCountFlag,W
	BTRSS	STATUS,2
	MGOTO	_00153_DS_
	BANKSEL	_irStep
	MOVR	_irStep,W
	...
	MGOTO	_00158_DS_
_00153_DS_:
	.line	182, "main.c"; 	count250ms = 0;
	BANKSEL	_count250ms
	CLRR	_count250ms
	.line	183, "main.c"; 	zhedangCount = 0;
	BANKSEL	_zhedangCount
	CLRR	_zhedangCount
	.line	185, "main.c"; 	revCount = 0;
	BANKSEL	_revCount
	CLRR	_revCount
	.line	186, "main.c"; 	PORTBbits.PB1 = 1;						// Set PB[1]= 1
	BSR	_PORTBbits,1
	.line	187, "main.c"; 	IRCR = C_IR_38K | C_IR_En;	
	MOVIA	0x01
	SFUN	_IRCR
	.line	188, "main.c"; 	delay(10);
	MOVIA	0x0a
	MCALL	_delay
	.line	189, "main.c"; 	PORTA |= 0x40;
	BANKSEL	_PORTA
	BSR	_PORTA,6
	.line	190, "main.c"; 	for(i=0;i<6;i++)
	BANKSEL	r0x1050
	CLRR	r0x1050
_00178_DS_:
	.line	192, "main.c"; 	delay(10);
	MOVIA	0x0a
	MCALL	_delay
	.line	190, "main.c"; 	for(i=0;i<6;i++)
	BANKSEL	r0x1050
...
;;unsigned compare: left < lit (0x6=6), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00178_DS_
	.line	195, "main.c"; 	PORTBbits.PB1 = 0;						// Set PB[1]= 1
	BCR	_PORTBbits,1
	.line	196, "main.c"; 	IRCR = C_IR_38K;
	CLRA	
	SFUN	_IRCR
	.line	197, "main.c"; 	PORTA &= 0xBF;
	BANKSEL	_PORTA
	BCR	_PORTA,6
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x6=6), size=1
	.line	198, "main.c"; 	if(revCount > 5)
	MOVIA	0x06
	BANKSEL	_revCount
	SUBAR	_revCount,W
	BTRSS	STATUS,0
	MGOTO	_00151_DS_
	.line	200, "main.c"; 	revCountTime = 0;
	BANKSEL	_revCountTime
	CLRR	_revCountTime
	.line	201, "main.c"; 	revCount = 0;
	BANKSEL	_revCount
	CLRR	_revCount
	.line	202, "main.c"; 	revCountFlag = 1;
	MOVIA	0x01
	BANKSEL	_revCountFlag
	MOVAR	_revCountFlag
	.line	203, "main.c"; 	delay(30);
	MOVIA	0x1e
	MCALL	_delay
	.line	204, "main.c"; 	PORTBbits.PB1 = 1;						// Set PB[1]= 1
	BSR	_PORTBbits,1
	.line	205, "main.c"; 	IRCR = C_IR_38K | C_IR_En;	
	MOVIA	0x01
	SFUN	_IRCR
	.line	206, "main.c"; 	delay(10);
	MOVIA	0x0a
	MCALL	_delay
	.line	207, "main.c"; 	PORTA |= 0x40;
	BANKSEL	_PORTA
	BSR	_PORTA,6
	.line	208, "main.c"; 	zhedangCount = 0;
	BANKSEL	_zhedangCount
	CLRR	_zhedangCount
	.line	211, "main.c"; 	while(PORTBbits.PB3 == 1)
	BANKSEL	r0x1050
	CLRR	r0x1050
_00140_DS_:
	BANKSEL	r0x1051
...
;;1	MOVAR	r0x1052
	...
	BTRSS	STATUS,2
	MGOTO	_00181_DS_
	.line	213, "main.c"; 	zhedangCount++;
	BANKSEL	_zhedangCount
	INCR	_zhedangCount,F
	MGOTO	_00140_DS_
_00181_DS_:
	.line	209, "main.c"; 	for(i=0;i<50;i++)
	BANKSEL	r0x1050
	INCR	r0x1050,F
;;unsigned compare: left < lit (0x32=50), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00140_DS_
	.line	217, "main.c"; 	PORTA &= 0xBF;
	BANKSEL	_PORTA
	BCR	_PORTA,6
	.line	218, "main.c"; 	checkIRKey();
	MCALL	_checkIRKey
	.line	219, "main.c"; 	PORTBbits.PB1 = 0;						// Set PB[1]= 1
	BCR	_PORTBbits,1
	.line	220, "main.c"; 	IRCR = C_IR_38K;
	CLRA	
	SFUN	_IRCR
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x6=6), size=1
	.line	222, "main.c"; 	if(zhedangCount > 5)
	MOVIA	0x06
	BANKSEL	_zhedangCount
	SUBAR	_zhedangCount,W
	BTRSS	STATUS,0
	MGOTO	_00152_DS_
	.line	224, "main.c"; 	if(++zhedangTime > 40)
...
;;unsigned compare: left >= lit (0x29=41), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00152_DS_
	.line	226, "main.c"; 	zhedangTime = 40;
	MOVIA	0x28
	MOVAR	_zhedangTime
	MGOTO	_00152_DS_
_00151_DS_:
	.line	232, "main.c"; 	if(++revCountTime > 50)
	BANKSEL	_revCountTime
	INCR	_revCountTime,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x33=51), size=1
	MOVIA	0x33
	SUBAR	_revCountTime,W
	BTRSS	STATUS,0
	MGOTO	_00152_DS_
	.line	234, "main.c"; 	revCountTime = 0;
	CLRR	_revCountTime
	.line	235, "main.c"; 	revCountFlag = 0;
	BANKSEL	_revCountFlag
	CLRR	_revCountFlag
	.line	236, "main.c"; 	zhedangTime = 0;
	BANKSEL	_zhedangTime
	CLRR	_zhedangTime
	.line	237, "main.c"; 	irStep = 0;			//移开了
	BANKSEL	_irStep
	CLRR	_irStep
_00152_DS_:
...
_00158_DS_:
	...
	MCALL	_keyCtr
	.line	246, "main.c"; 	if(++checkBatTime >= 20)
...
;;unsigned compare: left < lit (0x14=20), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00162_DS_
	.line	248, "main.c"; 	checkBatTime = 0;
	CLRR	_checkBatTime
	.line	249, "main.c"; 	if(workTime == 0)
	BANKSEL	_workTime
	MOVR	_workTime,W
	BTRSC	STATUS,2
...
_00162_DS_:
	...
	MCALL	_chrgCtr
	.line	254, "main.c"; 	if((0x20 & ~PORTA) && keyCount == 0 && pwFlag == 0 && stepShowTime == 0 && pwShowTime == 0 && offShowTime == 0 && startTime == 0)
	BANKSEL	_PORTA
	MOVR	_PORTA,W
	BANKSEL	r0x1050
	MOVAR	r0x1050
	...
	BTRSS	STATUS,2
	MGOTO	_00166_DS_
	.line	257, "main.c"; 	if(++sleepTime > 100)
	BANKSEL	_sleepTime
	INCR	_sleepTime,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x65=101), size=1
	...
	SUBAR	_sleepTime,W
	BTRSC	STATUS,0
	.line	258, "main.c"; 	gotoSleep();
	MCALL	_gotoSleep
_00166_DS_:
	.line	260, "main.c"; 	if(sleepFlag)
	BANKSEL	_sleepFlag
	MOVR	_sleepFlag,W
	BTRSS	STATUS,2
	.line	262, "main.c"; 	gotoSleep();
	MCALL	_gotoSleep
	.line	264, "main.c"; 	delay(100);
	MOVIA	0x64
	MCALL	_delay
	.line	264, "main.c"; 	//    	if(getbit(PORTB, 3) == 0)
	MGOTO	_00176_DS_
	.line	286, "main.c"; 	}
	RETURN	
; exit point of _main
...
;local variable name mapping:
	.debuginfo variable _tempValue[0]=r0x1042,enc=unsigned
	.debuginfo variable _tempValue[1]=r0x1043,enc=unsigned
_checkBat:
; 2 exit points
	.line	697, "main.c"; 	R_Quarter_VDD_DATA=R_Quarter_VDD_DATA_LB=0x00;
	BANKSEL	_R_Quarter_VDD_DATA_LB
	CLRR	_R_Quarter_VDD_DATA_LB
	BANKSEL	_R_Quarter_VDD_DATA
	CLRR	_R_Quarter_VDD_DATA
	CLRR	(_R_Quarter_VDD_DATA + 1)
	.line	698, "main.c"; 	F_Quarter_VDD_Convert(8);			// execute 1/4VDD input channel ADC converting 8 times
	MOVIA	0x08
	MCALL	_F_Quarter_VDD_Convert
	.line	699, "main.c"; 	R_Quarter_VDD_DATA <<= 4;			// R_Quarter_VDD_DATA shift left 4 bit
	BANKSEL	_R_Quarter_VDD_DATA
	...
	.line	700, "main.c"; 	R_Quarter_VDD_DATA_LB &= 0xF0;		// Only get Bit7~4
	MOVIA	0xf0
	BANKSEL	_R_Quarter_VDD_DATA_LB
	ANDAR	_R_Quarter_VDD_DATA_LB,F
	.line	701, "main.c"; 	R_Quarter_VDD_DATA += R_Quarter_VDD_DATA_LB; //// R_Quarter_VDD_DATA + R_Quarter_VDD_DATA_LB
...
_00002_DS_:
	.line	702, "main.c"; 	R_Quarter_VDD_DATA >>=3;			// R_Quarter_VDD_DATA dividing 8
	BCR	STATUS,0
	BANKSEL	_R_Quarter_VDD_DATA
...
;;unsigned compare: left >= lit (0x835=2101), size=2
	.line	703, "main.c"; 	if(R_Quarter_VDD_DATA > 2100)
	MOVIA	0x08
...
_00501_DS_:
	BTRSS	STATUS,0
	MGOTO	_00434_DS_
	.line	705, "main.c"; 	if(++fullTime > 200)
	BANKSEL	_fullTime
	INCR	_fullTime,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0xC9=201), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00436_DS_
	.line	707, "main.c"; 	fullFlag = 1;
	MOVIA	0x01
	BANKSEL	_fullFlag
	MOVAR	_fullFlag
	.line	708, "main.c"; 	pwStep = 100;
	MOVIA	0x64
	BANKSEL	_pwStep
	MOVAR	_pwStep
	MGOTO	_00436_DS_
...
_00434_DS_:
	.line	711, "main.c"; 	else if(R_Quarter_VDD_DATA < 1550)
	MOVIA	0x06
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00503_DS_:
	BTRSC	STATUS,0
	MGOTO	_00431_DS_
	.line	713, "main.c"; 	pwStep = 0;
	BANKSEL	_pwStep
	CLRR	_pwStep
	.line	714, "main.c"; 	fullTime = 0;
	BANKSEL	_fullTime
	CLRR	_fullTime
	.line	715, "main.c"; 	if((0x20 & PORTA) == 0)
	BANKSEL	_PORTA
	BTRSC	_PORTA,5
	MGOTO	_00436_DS_
	.line	717, "main.c"; 	pwFlag = 0;		//关机
	BANKSEL	_pwFlag
	CLRR	_pwFlag
	.line	718, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	719, "main.c"; 	pwShowTime = 0;
	BANKSEL	_pwShowTime
	CLRR	_pwShowTime
	.line	720, "main.c"; 	stepShowTime = 0;
	BANKSEL	_stepShowTime
	CLRR	_stepShowTime
	.line	721, "main.c"; 	offShowTime = 0;
	BANKSEL	_offShowTime
	CLRR	_offShowTime
	MGOTO	_00436_DS_
_00431_DS_:
	.line	727, "main.c"; 	fullTime = 0;
	BANKSEL	_fullTime
	CLRR	_fullTime
;;unsigned compare: left < lit (0x802=2050), size=2
	.line	728, "main.c"; 	if(R_Quarter_VDD_DATA >= 2050)
	MOVIA	0x08
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00504_DS_:
	BTRSS	STATUS,0
	MGOTO	_00396_DS_
	.line	730, "main.c"; 	tempValue = (R_Quarter_VDD_DATA - 2050) + 75;
	MOVIA	0x49
	BANKSEL	_R_Quarter_VDD_DATA
...
_00396_DS_:
	.line	732, "main.c"; 	else if(R_Quarter_VDD_DATA >= 1998)
	MOVIA	0x07
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00505_DS_:
	BTRSS	STATUS,0
	MGOTO	_00393_DS_
	.line	734, "main.c"; 	tempValue = (R_Quarter_VDD_DATA - 1998)/2 + 49;
	MOVIA	0x32
	BANKSEL	_R_Quarter_VDD_DATA
	ADDAR	_R_Quarter_VDD_DATA,W
	BANKSEL	r0x1044
...
_00393_DS_:
	.line	736, "main.c"; 	else if(R_Quarter_VDD_DATA >= 1886)
	MOVIA	0x07
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00506_DS_:
	BTRSS	STATUS,0
	MGOTO	_00390_DS_
	.line	738, "main.c"; 	tempValue = ((R_Quarter_VDD_DATA - 1886)/4) + 21;
	MOVIA	0xa2
	BANKSEL	_R_Quarter_VDD_DATA
	ADDAR	_R_Quarter_VDD_DATA,W
	BANKSEL	r0x1044
...
_00390_DS_:
	.line	740, "main.c"; 	else if(R_Quarter_VDD_DATA > 1550)
	MOVIA	0x06
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00507_DS_:
	BTRSS	STATUS,0
	MGOTO	_00387_DS_
	.line	742, "main.c"; 	tempValue = (R_Quarter_VDD_DATA - 1550)/16;
	MOVIA	0xf2
	BANKSEL	_R_Quarter_VDD_DATA
	ADDAR	_R_Quarter_VDD_DATA,W
	BANKSEL	r0x1044
...
_00006_DS_:
	...
	MGOTO	_00397_DS_
_00387_DS_:
	.line	746, "main.c"; 	tempValue = 0;
	BANKSEL	r0x1042
	CLRR	r0x1042
	BANKSEL	r0x1043
	CLRR	r0x1043
_00397_DS_:
	.line	748, "main.c"; 	if(0x20 & PORTA)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	MGOTO	_00428_DS_
;;unsigned compare: left < lit (0x5=5), size=2
	.line	752, "main.c"; 	if(tempValue < 5)
	MOVIA	0x00
	BANKSEL	r0x1043
	SUBAR	r0x1043,W
	BTRSS	STATUS,2
...
_00413_DS_:
	.line	756, "main.c"; 	else if(tempValue < 20)
	MOVIA	0x00
	BANKSEL	r0x1043
	SUBAR	r0x1043,W
	BTRSS	STATUS,2
...
_00509_DS_:
	BTRSC	STATUS,0
	MGOTO	_00410_DS_
	.line	758, "main.c"; 	tempValue = tempValue - 5;
	MOVIA	0xfb
	BANKSEL	r0x1042
	ADDAR	r0x1042,F
	BTRSC	STATUS,0
...
_00410_DS_:
	.line	760, "main.c"; 	else if(tempValue < 30)
	MOVIA	0x00
	BANKSEL	r0x1043
	SUBAR	r0x1043,W
	BTRSS	STATUS,2
...
_00510_DS_:
	BTRSC	STATUS,0
	MGOTO	_00407_DS_
	.line	762, "main.c"; 	tempValue = tempValue - 10;
	MOVIA	0xf6
	BANKSEL	r0x1042
	ADDAR	r0x1042,F
	BTRSC	STATUS,0
...
_00407_DS_:
	.line	764, "main.c"; 	else if(tempValue < 40)
	MOVIA	0x00
	BANKSEL	r0x1043
	SUBAR	r0x1043,W
	BTRSS	STATUS,2
...
_00511_DS_:
	BTRSC	STATUS,0
	MGOTO	_00404_DS_
	.line	766, "main.c"; 	tempValue = tempValue - 15;
	MOVIA	0xf1
	BANKSEL	r0x1042
	ADDAR	r0x1042,F
	BTRSC	STATUS,0
...
_00404_DS_:
	.line	768, "main.c"; 	else if(tempValue < 50)
	MOVIA	0x00
	BANKSEL	r0x1043
	SUBAR	r0x1043,W
	BTRSS	STATUS,2
...
_00512_DS_:
	BTRSC	STATUS,0
	MGOTO	_00401_DS_
	.line	770, "main.c"; 	tempValue = tempValue - 21;
	MOVIA	0xeb
	BANKSEL	r0x1042
	ADDAR	r0x1042,F
	BTRSC	STATUS,0
...
_initAD:
; 2 exit points
	.line	669, "main.c"; 	ADMD  = C_ADC_En | C_ADC_CH_Dis;	// Enable ADC power, Disable global ADC input channel, Select PA0 pad as ADC input (SFR "ADMD")
	MOVIA	0x80
	MOVAR	_ADMD
	.line	674, "main.c"; 	ADVREFH = C_Vrefh_2V;					// ADC reference high voltage is supplied by internal 2V  (Note: ADC clock freq. must be equal or less than 250KHz)
	CLRR	_ADVREFH
	.line	679, "main.c"; 	ADR	  = C_Ckl_Div8;						// ADC clock=Fcpu/8, Clear ADIF, disable ADC interrupt	
	MOVIA	0x10
	MOVAR	_ADR
	.line	683, "main.c"; 	ADCR  = C_Sample_1clk | C_12BIT;		// Sample pulse width=1 adc clock, ADC select 12-bit conversion ( Note: ADC clock freq. must be equal or less than 500KHz)
	MOVIA	0x03
	MOVAR	_ADCR
	.line	690, "main.c"; 	ADMDbits.GCHS = 1;						// Enable global ADC channel	(SFR "ADMD")
	BSR	_ADMDbits,4
	.line	691, "main.c"; 	delay(50);								// Delay 0.56ms(Instruction clock=4MHz/2T) for waiting ADC stable 
	MOVIA	0x32
	MCALL	_delay
	.line	692, "main.c"; 	}
	RETURN	
...
;local variable name mapping:
	.debuginfo variable _kclick=r0x1049,enc=unsigned
_keyCtr:
; 2 exit points
	.line	613, "main.c"; 	char kclick = keyRead(0x80 & (~PORTA));
	BANKSEL	_PORTA
	COMR	_PORTA,W
	BANKSEL	r0x1049
	MOVAR	r0x1049
	...
	BANKSEL	r0x1049
	MOVAR	r0x1049
	.line	614, "main.c"; 	if(kclick == 1)
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00371_DS_
	.line	616, "main.c"; 	checkBat();
	MCALL	_checkBat
	.line	617, "main.c"; 	if(pwFlag && pwStep > 0)
	BANKSEL	_pwFlag
	MOVR	_pwFlag,W
	BTRSC	STATUS,2
	MGOTO	_00373_DS_
	...
	BTRSC	STATUS,2
	MGOTO	_00373_DS_
	.line	619, "main.c"; 	if(showFlag == 0)
	BANKSEL	_showFlag
	MOVR	_showFlag,W
	BTRSS	STATUS,2
	MGOTO	_00356_DS_
	.line	622, "main.c"; 	pwShowTime = 3;
	MOVIA	0x03
	BANKSEL	_pwShowTime
	MOVAR	_pwShowTime
	.line	623, "main.c"; 	offShowTime = 0;
	BANKSEL	_offShowTime
	CLRR	_offShowTime
	MGOTO	_00373_DS_
_00356_DS_:
	.line	625, "main.c"; 	else if(stepShowTime == 0)
	BANKSEL	_stepShowTime
	MOVR	_stepShowTime,W
	BTRSS	STATUS,2
	MGOTO	_00353_DS_
	.line	627, "main.c"; 	pwShowTime = 0;
	BANKSEL	_pwShowTime
	CLRR	_pwShowTime
	.line	628, "main.c"; 	stepShowTime = 2;
	MOVIA	0x02
	BANKSEL	_stepShowTime
	MOVAR	_stepShowTime
...
;;unsigned compare: left >= lit (0x4=4), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00351_DS_
	.line	635, "main.c"; 	workStep = 1;
	MOVIA	0x01
	MOVAR	_workStep
_00351_DS_:
	.line	636, "main.c"; 	stepShowTime = 2;
	MOVIA	0x02
	BANKSEL	_stepShowTime
	MOVAR	_stepShowTime
	...
	MGOTO	_00373_DS_
_00371_DS_:
	.line	641, "main.c"; 	else if(kclick == 2)
	BANKSEL	r0x1049
	MOVR	r0x1049,W
	XORIA	0x02
	BTRSS	STATUS,2
	MGOTO	_00373_DS_
	.line	643, "main.c"; 	checkBat();
	MCALL	_checkBat
	.line	644, "main.c"; 	if(pwFlag)
	BANKSEL	_pwFlag
	MOVR	_pwFlag,W
	BTRSC	STATUS,2
	MGOTO	_00366_DS_
	.line	646, "main.c"; 	pwFlag = 0;		//关机
	CLRR	_pwFlag
	.line	647, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	648, "main.c"; 	pwShowTime = 0;
	BANKSEL	_pwShowTime
	CLRR	_pwShowTime
	.line	649, "main.c"; 	stepShowTime = 0;
	BANKSEL	_stepShowTime
	CLRR	_stepShowTime
	.line	650, "main.c"; 	offShowTime = 5;
	MOVIA	0x05
	BANKSEL	_offShowTime
	MOVAR	_offShowTime
	MGOTO	_00373_DS_
_00366_DS_:
	.line	652, "main.c"; 	else if(pwStep > 0)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BTRSC	STATUS,2
	MGOTO	_00373_DS_
	.line	655, "main.c"; 	pwFlag = 1;		//开机
	MOVIA	0x01
	BANKSEL	_pwFlag
	MOVAR	_pwFlag
	.line	656, "main.c"; 	pwShowTime = 3;
	MOVIA	0x03
	BANKSEL	_pwShowTime
	MOVAR	_pwShowTime
	.line	657, "main.c"; 	stepShowTime = 2;
	MOVIA	0x02
	BANKSEL	_stepShowTime
	MOVAR	_stepShowTime
	.line	658, "main.c"; 	offShowTime = 0;
	BANKSEL	_offShowTime
	CLRR	_offShowTime
	.line	659, "main.c"; 	if(workStep == 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSS	STATUS,2
	MGOTO	_00373_DS_
	.line	660, "main.c"; 	workStep = 1;
	MOVIA	0x01
	MOVAR	_workStep
_00373_DS_:
	.line	663, "main.c"; 	}
...
;local variable name mapping:
	.debuginfo variable _keyStatus=r0x1048,enc=unsigned
_keyRead:
; 2 exit points
	.line	578, "main.c"; 	char keyRead(char keyStatus)	
	BANKSEL	r0x1048
	MOVAR	r0x1048
	.line	580, "main.c"; 	if(keyStatus)
	MOVR	r0x1048,W
	BTRSC	STATUS,2
	MGOTO	_00343_DS_
	.line	582, "main.c"; 	keyCount++;
	BANKSEL	_keyCount
	INCR	_keyCount,F
...
_pwmStop:
; 2 exit points
	.line	572, "main.c"; 	T2CR1 = C_TMR2_Dis;
	CLRA	
	SFUN	_T2CR1
	.line	573, "main.c"; 	}
	RETURN	
...
_pwmInit:
; 2 exit points
	.line	560, "main.c"; 	if(0x80&T2CR1)
	SFUNR	_T2CR1
	BANKSEL	r0x104A
	MOVAR	r0x104A
	BTRSC	r0x104A,7
	.line	561, "main.c"; 	return;
	MGOTO	_00324_DS_
	.line	562, "main.c"; 	TMRH = 0x00;
	CLRR	_TMRH
	.line	563, "main.c"; 	TMR2 = 100;							//频率为110K
	MOVIA	0x64
	SFUN	_TMR2
	.line	564, "main.c"; 	PWM2DUTY = 69;				// 		
	MOVIA	0x45
	SFUN	_PWM2DUTY
	.line	566, "main.c"; 	T2CR2 = C_TMR2_ClkSrc_Inst | C_PS2_Div256;	// Enable Prescaler1, Prescaler1 dividing rate = 1:2, Timer1 clock source is instruction clock 
	MOVIA	0x07
	SFUN	_T2CR2
	.line	567, "main.c"; 	T2CR1 = C_PWM2_En | C_TMR2_Reload | C_TMR2_En;	// PWM1 output will be present on PB6 , PWM1 output is active high, reloaded from TMR1, non-stop mode
	MOVIA	0x83
	SFUN	_T2CR1
_00324_DS_:
	.line	568, "main.c"; 	}
...
_gotoSleep:
; 2 exit points
	.line	527, "main.c"; 	sleepFlag = 0;
	BANKSEL	_sleepFlag
	CLRR	_sleepFlag
	.line	528, "main.c"; 	waitTime = 0;
	BANKSEL	_waitTime
	CLRR	_waitTime
	CLRR	(_waitTime + 1)
	...
	BANKSEL	_sleepTime
	CLRR	_sleepTime
	.line	531, "main.c"; 	pwFlag = 0;
	BANKSEL	_pwFlag
	CLRR	_pwFlag
	.line	532, "main.c"; 	pwmStop();
	MCALL	_pwmStop
	.line	533, "main.c"; 	AWUCON = 0xA0;
	MOVIA	0xa0
	MOVAR	_AWUCON
	.line	535, "main.c"; 	IOSTB = C_PB3_Input;
	MOVIA	0x08
	IOST	_IOSTB
	...
	CLRR	_PORTB
	.line	538, "main.c"; 	INTE =  C_INT_PABKey;
	MOVIA	0x02
	MOVAR	_INTE
	.line	539, "main.c"; 	PCON =  C_LVR_En | 0x10;	
	MOVIA	0x18
	MOVAR	_PCON
	.line	540, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	541, "main.c"; 	CLRWDT();
	clrwdt
	.line	542, "main.c"; 	ENI();
	ENI
	.line	543, "main.c"; 	if((0x20 & PORTA) == 0)
	BANKSEL	_PORTA
	BTRSC	_PORTA,5
	MGOTO	_00317_DS_
...
_00317_DS_:
	...
	CLRR	_AWUCON
	.line	546, "main.c"; 	IOSTA = C_PA7_Input  | C_PA5_Input;
	MOVIA	0xa0
	IOST	_IOSTA
	.line	547, "main.c"; 	IOSTB = C_PB3_Input ;
	MOVIA	0x08
	IOST	_IOSTB
	.line	548, "main.c"; 	PORTA = 0x00;
	BANKSEL	_PORTA
	CLRR	_PORTA
	.line	549, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_PABKey;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x03
	MOVAR	_INTE
...
_initSys:
; 2 exit points
	.line	495, "main.c"; 	DISI();
	DISI
	.line	496, "main.c"; 	IOSTA = C_PA7_Input  | C_PA5_Input;
	MOVIA	0xa0
	IOST	_IOSTA
	.line	497, "main.c"; 	IOSTB = C_PB3_Input;
	MOVIA	0x08
	IOST	_IOSTB
	.line	498, "main.c"; 	PORTB = 0x00;
	CLRR	_PORTB
	.line	499, "main.c"; 	PORTA = 0x00;
	BANKSEL	_PORTA
	CLRR	_PORTA
	.line	501, "main.c"; 	setInput();
	MCALL	_setInput
	.line	502, "main.c"; 	APHCON = 0x7F;
	MOVIA	0x7f
	IOST	_APHCON
	.line	503, "main.c"; 	BPHCON = 0xFF;		//PB3上拉
	MOVIA	0xff
	MOVAR	_BPHCON
	.line	504, "main.c"; 	ABPLCON = 0xFF;
	MOVAR	_ABPLCON
	.line	506, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_PABKey;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x03
	MOVAR	_INTE
	...
	MOVIA	0x37
	MOVAR	_TMR0
	.line	511, "main.c"; 	T0MD =  C_PS0_TMR0 | C_PS0_Div2;
	CLRA	
	T0MD	
	.line	513, "main.c"; 	PCON1 = C_TMR0_En;
	MOVIA	0x01
	IOST	_PCON1
	.line	516, "main.c"; 	PCON = C_WDT_En | C_LVR_En | 0x10;				// Enable WDT ,  Enable LVR
	MOVIA	0x98
	MOVAR	_PCON
...
_refreshNub:
; 2 exit points
	.line	486, "main.c"; 	showNubBaiwei(numArray[baiweiNum]);
	BANKSEL	_baiweiNum
	MOVR	_baiweiNum,W
	ADDIA	(_numArray + 0)
	BANKSEL	r0x104B
...
;;103	MOVAR	r0x104D
	...
	.line	487, "main.c"; 	showNubShiwei(numArray[shiweiNum]);
	BANKSEL	_shiweiNum
	MOVR	_shiweiNum,W
	ADDIA	(_numArray + 0)
	BANKSEL	r0x104B
...
;;102	MOVAR	r0x104D
	...
	.line	488, "main.c"; 	showNubGewei(numArray[geweiNum]);
	BANKSEL	_geweiNum
	MOVR	_geweiNum,W
	ADDIA	(_numArray + 0)
	BANKSEL	r0x104B
...
_checkIRKey:
; 2 exit points
	.line	429, "main.c"; 	if(pwFlag == 0)
	BANKSEL	_pwFlag
	MOVR	_pwFlag,W
	BTRSS	STATUS,2
	MGOTO	_00286_DS_
	.line	431, "main.c"; 	irStep = 0;
	BANKSEL	_irStep
	CLRR	_irStep
...
;;unsigned compare: left >= lit (0x6=6), size=1
_00286_DS_:
	.line	434, "main.c"; 	if(zhedangCount > 5)
	MOVIA	0x06
	BANKSEL	_zhedangCount
	SUBAR	_zhedangCount,W
	BTRSS	STATUS,0
	MGOTO	_00290_DS_
	.line	436, "main.c"; 	if(++revOKCount > 2)
	BANKSEL	_revOKCount
	INCR	_revOKCount,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x3=3), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00291_DS_
	.line	437, "main.c"; 	revOKCount = 3;
	MOVIA	0x03
	MOVAR	_revOKCount
	MGOTO	_00291_DS_
_00290_DS_:
	.line	441, "main.c"; 	revOKCount = 0;
	BANKSEL	_revOKCount
	CLRR	_revOKCount
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x3=3), size=1
_00291_DS_:
	.line	443, "main.c"; 	if(revOKCount > 2 && irStep == 0)
	MOVIA	0x03
	BANKSEL	_revOKCount
	SUBAR	_revOKCount,W
	BTRSS	STATUS,0
	...
	BTRSS	STATUS,2
	MGOTO	_00303_DS_
	.line	446, "main.c"; 	if(workStep == 1)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00298_DS_
	.line	448, "main.c"; 	workTime = 50;
	MOVIA	0x32
	BANKSEL	_workTime
	MOVAR	_workTime
	MGOTO	_00299_DS_
_00298_DS_:
	.line	450, "main.c"; 	else if(workStep == 2)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x02
	BTRSS	STATUS,2
	MGOTO	_00295_DS_
	.line	452, "main.c"; 	workTime = 80;
	MOVIA	0x50
	BANKSEL	_workTime
	MOVAR	_workTime
	MGOTO	_00299_DS_
_00295_DS_:
	...
	BTRSS	STATUS,2
	MGOTO	_00299_DS_
	.line	456, "main.c"; 	workTime = 120;
	MOVIA	0x78
	BANKSEL	_workTime
	MOVAR	_workTime
_00299_DS_:
	.line	458, "main.c"; 	waitBatTime = 120;
	MOVIA	0x78
	BANKSEL	_waitBatTime
	MOVAR	_waitBatTime
	.line	460, "main.c"; 	irStep = 1;
	MOVIA	0x01
	BANKSEL	_irStep
	MOVAR	_irStep
_00303_DS_:
...
_chrgCtr:
; 2 exit points
	.line	294, "main.c"; 	if((0x20 & PORTA) == 0)
	BANKSEL	_PORTA
	BTRSC	_PORTA,5
	MGOTO	_00187_DS_
	.line	296, "main.c"; 	fullFlag = 0;
	BANKSEL	_fullFlag
	CLRR	_fullFlag
_00187_DS_:
	.line	298, "main.c"; 	BPHCON |= 0x04;
	BSR	_BPHCON,2
	.line	299, "main.c"; 	IOSTB &= 0xFB;
	IOSTR	_IOSTB
	BANKSEL	r0x104E
	MOVAR	r0x104E
	BCR	r0x104E,2
	...
	MCALL	_pwmInit
	.line	303, "main.c"; 	workTime--;
	BANKSEL	_workTime
	DECR	_workTime,F
	MGOTO	_00190_DS_
_00189_DS_:
	.line	307, "main.c"; 	pwmStop();
	MCALL	_pwmStop
	.line	308, "main.c"; 	PORTB &= 0xFB;
	BCR	_PORTB,2
_00190_DS_:
	.line	310, "main.c"; 	if(startTime)
	BANKSEL	_startTime
	MOVR	_startTime,W
	BTRSC	STATUS,2
	MGOTO	_00225_DS_
	.line	312, "main.c"; 	checkBat();
	MCALL	_checkBat
	.line	313, "main.c"; 	startTime--;
	BANKSEL	_startTime
	DECR	_startTime,F
	...
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	315, "main.c"; 	baiweiNum = shiweiNum = 8;
	MOVIA	0x08
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	BANKSEL	_baiweiNum
	MOVAR	_baiweiNum
	.line	316, "main.c"; 	geweiNum = 8;
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	.line	316, "main.c"; 	}
	MGOTO	_00227_DS_
_00225_DS_:
	.line	318, "main.c"; 	else if(stepShowTime)
	BANKSEL	_stepShowTime
	MOVR	_stepShowTime,W
	BTRSC	STATUS,2
	MGOTO	_00222_DS_
	.line	320, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	321, "main.c"; 	baiweiNum = shiweiNum = 0;
	BANKSEL	_shiweiNum
	CLRR	_shiweiNum
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	322, "main.c"; 	geweiNum = workStep;
	BANKSEL	_workStep
	MOVR	_workStep,W
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	...
	MGOTO	_00227_DS_
_00222_DS_:
	.line	324, "main.c"; 	else if(pwShowTime || workTime)
	BANKSEL	_pwShowTime
	MOVR	_pwShowTime,W
	BTRSS	STATUS,2
	MGOTO	_00217_DS_
	...
	MGOTO	_00218_DS_
_00217_DS_:
	.line	326, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x64=100), size=1
	.line	327, "main.c"; 	if(pwStep > 99)
	MOVIA	0x64
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSS	STATUS,0
	MGOTO	_00192_DS_
	.line	329, "main.c"; 	baiweiNum = 1;
	MOVIA	0x01
	BANKSEL	_baiweiNum
	MOVAR	_baiweiNum
	.line	330, "main.c"; 	shiweiNum = geweiNum = 0;
	BANKSEL	_geweiNum
	CLRR	_geweiNum
	BANKSEL	_shiweiNum
	CLRR	_shiweiNum
...
_00192_DS_:
	...
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	335, "main.c"; 	shiweiNum = pwStep/10;
	MOVIA	0x0a
	MOVAR	STK00
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	...
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	336, "main.c"; 	geweiNum = pwStep%10;
	MOVIA	0x0a
	MOVAR	STK00
	BANKSEL	_pwStep
	MOVR	_pwStep,W
...
;;unsigned compare: left >= lit (0x6=6), size=1
_00218_DS_:
	.line	341, "main.c"; 	if(pwStep <= 5 && offShowTime == 0 && ((0x20 & PORTA) == 0) && pwFlag)
	MOVIA	0x06
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSC	STATUS,0
	...
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	344, "main.c"; 	if(++shanTime > 500)			//电量不足闪灯
	BANKSEL	_shanTime
	INCR	_shanTime,F
	BTRSC	STATUS,2
	INCR	(_shanTime + 1),F
...
_00279_DS_:
	BTRSS	STATUS,0
	MGOTO	_00195_DS_
	.line	346, "main.c"; 	shanTime = 0;
	BANKSEL	_shanTime
	CLRR	_shanTime
	CLRR	(_shanTime + 1)
	.line	347, "main.c"; 	showFlag = 0;
	BANKSEL	_showFlag
	CLRR	_showFlag
_00195_DS_:
	.line	350, "main.c"; 	if(shanTime % 100 < 50)
	MOVIA	0x64
	MOVAR	STK02
	MOVIA	0x00
	MOVAR	STK01
...
_00280_DS_:
	BTRSC	STATUS,0
	MGOTO	_00197_DS_
	.line	352, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	353, "main.c"; 	baiweiNum = 0;
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	354, "main.c"; 	shiweiNum = 0;
	BANKSEL	_shiweiNum
	CLRR	_shiweiNum
	.line	355, "main.c"; 	geweiNum = pwStep;
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	MGOTO	_00227_DS_
_00197_DS_:
	.line	359, "main.c"; 	showFlag = 0;
	BANKSEL	_showFlag
	CLRR	_showFlag
	.line	359, "main.c"; 	}
	MGOTO	_00227_DS_
_00212_DS_:
	.line	362, "main.c"; 	else if(offShowTime > 0)
	BANKSEL	_offShowTime
	MOVR	_offShowTime,W
	BTRSC	STATUS,2
	MGOTO	_00209_DS_
	...
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	366, "main.c"; 	shiweiNum = 10;
	MOVIA	0x0a
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	367, "main.c"; 	geweiNum = 10;
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	.line	367, "main.c"; 	}
	MGOTO	_00227_DS_
_00209_DS_:
	.line	369, "main.c"; 	else if(0x20 & PORTA)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	MGOTO	_00206_DS_
	...
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	379, "main.c"; 	if(fullFlag)
	BANKSEL	_fullFlag
	MOVR	_fullFlag,W
	BTRSC	STATUS,2
	MGOTO	_00203_DS_
	.line	381, "main.c"; 	fullFlag = 1;
	MOVIA	0x01
	MOVAR	_fullFlag
	.line	383, "main.c"; 	baiweiNum = 1;
	BANKSEL	_baiweiNum
	MOVAR	_baiweiNum
	.line	384, "main.c"; 	shiweiNum = geweiNum = 0;
	BANKSEL	_geweiNum
	CLRR	_geweiNum
	BANKSEL	_shiweiNum
	CLRR	_shiweiNum
	...
	MGOTO	_00227_DS_
_00203_DS_:
	.line	389, "main.c"; 	if(pwStep == 100)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	XORIA	0x64
	BTRSS	STATUS,2
	MGOTO	_00200_DS_
	.line	391, "main.c"; 	fullFlag = 1;
	MOVIA	0x01
	BANKSEL	_fullFlag
	MOVAR	_fullFlag
	.line	392, "main.c"; 	baiweiNum = 0;
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	393, "main.c"; 	shiweiNum = 9;
	MOVIA	0x09
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	394, "main.c"; 	geweiNum = 9;
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	MGOTO	_00227_DS_
_00200_DS_:
	.line	398, "main.c"; 	baiweiNum = 0;
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	399, "main.c"; 	shiweiNum = pwStep/10;
	MOVIA	0x0a
	MOVAR	STK00
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	...
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	400, "main.c"; 	geweiNum = pwStep%10;
	MOVIA	0x0a
	MOVAR	STK00
	BANKSEL	_pwStep
	MOVR	_pwStep,W
...
;	 1110+  370 =  1480 instructions ( 3700 byte)
