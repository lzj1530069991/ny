...
_delayms:
; 2 exit points
	.line	339, "number.c"; 	void delayms(u8t time)
	BANKSEL	r0x1000
	MOVAR	r0x1000
	.line	341, "number.c"; 	for(u8t i=0;i<time;i++)
	BANKSEL	r0x1001
	CLRR	r0x1001
_00400_DS_:
	BANKSEL	r0x1000
...
_setInput:
; 2 exit points
	.line	335, "number.c"; 	IOSTA = 0xFF;		//PA0-PA4 PA6设为输入脚
	MOVIA	0xff
	IOST	_IOSTA
	.line	337, "number.c"; 	}
	RETURN	
...
;local variable name mapping:
	.debuginfo variable _outPut=r0x1002,enc=unsigned
_setOutput:
; 2 exit points
	.line	308, "number.c"; 	void setOutput(char outPut)
	BANKSEL	r0x1002
	MOVAR	r0x1002
;;unsigned compare: left < lit (0x1=1), size=1
	.line	310, "number.c"; 	switch(outPut)
	MOVIA	0x01
	SUBAR	r0x1002,W
	BTRSS	STATUS,0
	MGOTO	_00379_DS_
...
_00372_DS_:
	...
	MOVR	r0x1002,W
	IOST	_IOSTA
	.line	314, "number.c"; 	break;
	MGOTO	_00379_DS_
_00373_DS_:
	.line	316, "number.c"; 	IOSTA &= 0xFE;
	IOSTR	_IOSTA
	BANKSEL	r0x1002
	MOVAR	r0x1002
	BCR	r0x1002,0
	MOVR	r0x1002,W
	IOST	_IOSTA
	.line	317, "number.c"; 	break;
	MGOTO	_00379_DS_
_00374_DS_:
	.line	319, "number.c"; 	IOSTA &= 0xFD;
	IOSTR	_IOSTA
	BANKSEL	r0x1002
	MOVAR	r0x1002
	BCR	r0x1002,1
	MOVR	r0x1002,W
	IOST	_IOSTA
	.line	320, "number.c"; 	break;
	MGOTO	_00379_DS_
_00375_DS_:
	.line	322, "number.c"; 	IOSTA &= 0xFB;
	IOSTR	_IOSTA
	BANKSEL	r0x1002
	MOVAR	r0x1002
	BCR	r0x1002,2
	MOVR	r0x1002,W
	IOST	_IOSTA
	.line	323, "number.c"; 	break;
	MGOTO	_00379_DS_
_00376_DS_:
	.line	325, "number.c"; 	IOSTA &= 0xF7;
	IOSTR	_IOSTA
	BANKSEL	r0x1002
	MOVAR	r0x1002
	BCR	r0x1002,3
	MOVR	r0x1002,W
	IOST	_IOSTA
	.line	326, "number.c"; 	break;
	MGOTO	_00379_DS_
_00377_DS_:
	.line	328, "number.c"; 	IOSTA &= 0xEF;
	IOSTR	_IOSTA
	BANKSEL	r0x1002
	MOVAR	r0x1002
	BCR	r0x1002,4
...
_setlowOutput:
; 2 exit points
	.line	282, "number.c"; 	void setlowOutput(char outPut)
	BANKSEL	r0x1003
	MOVAR	r0x1003
;;unsigned compare: left < lit (0x1=1), size=1
	.line	284, "number.c"; 	switch(outPut)
	MOVIA	0x01
	SUBAR	r0x1003,W
	BTRSS	STATUS,0
	MGOTO	_00357_DS_
...
_00367_DS_:
	...
	MGOTO	_00350_DS_
_00350_DS_:
	.line	287, "number.c"; 	PORTA &= 0xBF;
	BANKSEL	_PORTA
	BCR	_PORTA,6
	.line	288, "number.c"; 	break;
	MGOTO	_00357_DS_
_00351_DS_:
	.line	290, "number.c"; 	PORTA &= 0xFE;
	BANKSEL	_PORTA
	BCR	_PORTA,0
	.line	291, "number.c"; 	break;
	MGOTO	_00357_DS_
_00352_DS_:
	.line	293, "number.c"; 	PORTA &= 0xFD;
	BANKSEL	_PORTA
	BCR	_PORTA,1
	.line	294, "number.c"; 	break;
	MGOTO	_00357_DS_
_00353_DS_:
	.line	296, "number.c"; 	PORTA &= 0xFB;
	BANKSEL	_PORTA
	BCR	_PORTA,2
	.line	297, "number.c"; 	break;
	MGOTO	_00357_DS_
_00354_DS_:
	.line	299, "number.c"; 	PORTA &= 0xF7;
	BANKSEL	_PORTA
	BCR	_PORTA,3
	.line	300, "number.c"; 	break;
	MGOTO	_00357_DS_
_00355_DS_:
	.line	302, "number.c"; 	PORTA &=  0xEF;
	BANKSEL	_PORTA
	BCR	_PORTA,4
_00357_DS_:
	.line	305, "number.c"; 	}
...
_setHightOutput:
; 2 exit points
	.line	256, "number.c"; 	void setHightOutput(char outPut)
	BANKSEL	r0x1004
	MOVAR	r0x1004
;;unsigned compare: left < lit (0x1=1), size=1
	.line	258, "number.c"; 	switch(outPut)
	MOVIA	0x01
	SUBAR	r0x1004,W
	BTRSS	STATUS,0
	MGOTO	_00335_DS_
...
_00345_DS_:
	...
	MGOTO	_00328_DS_
_00328_DS_:
	.line	261, "number.c"; 	PORTA |= 0x40;
	BANKSEL	_PORTA
	BSR	_PORTA,6
	.line	262, "number.c"; 	break;
	MGOTO	_00335_DS_
_00329_DS_:
	.line	264, "number.c"; 	PORTA |= 0x01;
	BANKSEL	_PORTA
	BSR	_PORTA,0
	.line	265, "number.c"; 	break;
	MGOTO	_00335_DS_
_00330_DS_:
	.line	267, "number.c"; 	PORTA |= 0x02;
	BANKSEL	_PORTA
	BSR	_PORTA,1
	.line	268, "number.c"; 	break;
	MGOTO	_00335_DS_
_00331_DS_:
	.line	270, "number.c"; 	PORTA |= 0x04;
	BANKSEL	_PORTA
	BSR	_PORTA,2
	.line	271, "number.c"; 	break;
	MGOTO	_00335_DS_
_00332_DS_:
	.line	273, "number.c"; 	PORTA |= 0x08;
	BANKSEL	_PORTA
	BSR	_PORTA,3
	.line	274, "number.c"; 	break;
	MGOTO	_00335_DS_
_00333_DS_:
	.line	276, "number.c"; 	PORTA |= 0x10;
	BANKSEL	_PORTA
	BSR	_PORTA,4
_00335_DS_:
	.line	279, "number.c"; 	}
...
;local variable name mapping:
	.debuginfo variable _hight=r0x1005,enc=unsigned
	.debuginfo variable _low=r0x1006,enc=unsigned
_showNub:
; 2 exit points
	...
	MCALL	_setInput
	.line	245, "number.c"; 	IOSTA = 0X00;	
	CLRA	
	IOST	_IOSTA
	.line	246, "number.c"; 	setOutput(hight);	//设置输出方向
	BANKSEL	r0x1005
	MOVR	r0x1005,W
	MCALL	_setOutput
	.line	247, "number.c"; 	setHightOutput(hight);
	BANKSEL	r0x1005
	MOVR	r0x1005,W
	MCALL	_setHightOutput
	.line	248, "number.c"; 	setOutput(low);		//设置输出方向
	BANKSEL	r0x1006
	MOVR	r0x1006,W
	MCALL	_setOutput
	.line	249, "number.c"; 	setlowOutput(low);
	BANKSEL	r0x1006
	MOVR	r0x1006,W
	MCALL	_setlowOutput
	.line	250, "number.c"; 	delayms(10);
	MOVIA	0x0a
	MCALL	_delayms
	.line	251, "number.c"; 	CLRWDT(); 
	clrwdt
	.line	252, "number.c"; 	IOSTA = 0X00;
	CLRA	
	IOST	_IOSTA
	.line	253, "number.c"; 	}
	RETURN	
...
;local variable name mapping:
	.debuginfo variable _index=r0x1007,enc=unsigned
_showNubBaiwei2:
; 2 exit points
...
;local variable name mapping:
	.debuginfo variable _num=r0x1008,enc=unsigned
	.debuginfo variable _i=r0x1009,enc=unsigned
_showNubBaiwei:
; 2 exit points
...
;local variable name mapping:
	.debuginfo variable _index=r0x100B,enc=unsigned
_showNubGewei2:
; 2 exit points
...
;local variable name mapping:
	.debuginfo variable _num=r0x100C,enc=unsigned
	.debuginfo variable _i=r0x100D,enc=unsigned
_showNubGewei:
; 2 exit points
...
;local variable name mapping:
	.debuginfo variable _index=r0x100F,enc=unsigned
_showNubShiwei2:
; 2 exit points
...
;local variable name mapping:
	.debuginfo variable _num=r0x1010,enc=unsigned
	.debuginfo variable _i=r0x1011,enc=unsigned
_showNubShiwei:
; 2 exit points
...
;	  439+   65 =   504 instructions ( 1138 byte)
