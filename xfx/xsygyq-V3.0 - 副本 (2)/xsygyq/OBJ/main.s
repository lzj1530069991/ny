...
_00136_DS_:
	...
	BTRSS	STATUS,0
	DECR	(_waitTime + 1),F
	.line	172, "main.c"; 	else if(pwFlag)
	MGOTO	_00160_DS_
_00159_DS_:
	.line	173, "main.c"; 	{
	BANKSEL	_pwFlag
	...
	BTRSC	STATUS,2
	MGOTO	_00160_DS_
	.line	176, "main.c"; 	if(++count250ms >= 4)
	BANKSEL	_count250ms
	INCR	_count250ms,F
...
;;unsigned compare: left >= lit (0x5=5), size=1
	.line	233, "main.c"; 	if(zhedangCount > 4)
	MOVIA	0x05
	BANKSEL	_zhedangCount
	SUBAR	_zhedangCount,W
	BTRSS	STATUS,0
	MGOTO	_00147_DS_
	.line	235, "main.c"; 	if(++zhedangTime > 40)
...
;;unsigned compare: left >= lit (0x29=41), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00153_DS_
	.line	237, "main.c"; 	zhedangTime = 40;
	MOVIA	0x28
	MOVAR	_zhedangTime
	MGOTO	_00153_DS_
_00147_DS_:
...
_00152_DS_:
	.line	245, "main.c"; 	else if(revCount < 2)
	MOVIA	0x02
	BANKSEL	_revCount
	SUBAR	_revCount,W
	BTRSC	STATUS,0
	MGOTO	_00153_DS_
	.line	247, "main.c"; 	zhedangTime = 0;
	BANKSEL	_zhedangTime
	CLRR	_zhedangTime
	.line	248, "main.c"; 	irStep = 0;			//移开了
	BANKSEL	_irStep
	CLRR	_irStep
_00153_DS_:
	.line	250, "main.c"; 	delay(5);
	MOVIA	0x05
	MCALL	_delay
_00160_DS_:
	.line	255, "main.c"; 	keyCtr();
	MCALL	_keyCtr
	.line	256, "main.c"; 	if(++checkBatTime >= 20)
...
;;unsigned compare: left < lit (0x14=20), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00164_DS_
	.line	258, "main.c"; 	checkBatTime = 0;
	CLRR	_checkBatTime
	.line	259, "main.c"; 	if(workTime == 0)
	BANKSEL	_workTime
	MOVR	_workTime,W
	BTRSC	STATUS,2
	.line	260, "main.c"; 	checkBat();
	MCALL	_checkBat
_00164_DS_:
	.line	262, "main.c"; 	chrgCtr();
	MCALL	_chrgCtr
	.line	264, "main.c"; 	if((0x20 & ~PORTA) && keyCount == 0 && pwFlag == 0 && stepShowTime == 0 && pwShowTime == 0 && offShowTime == 0 && startTime == 0)
	BANKSEL	_PORTA
	MOVR	_PORTA,W
	BANKSEL	r0x104D
	MOVAR	r0x104D
	...
	BTRSS	STATUS,2
	MGOTO	_00168_DS_
	.line	267, "main.c"; 	if(++sleepTime > 100)
	BANKSEL	_sleepTime
	INCR	_sleepTime,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x65=101), size=1
	...
	MCALL	_gotoSleep
_00168_DS_:
	.line	270, "main.c"; 	if(sleepFlag)
	BANKSEL	_sleepFlag
	MOVR	_sleepFlag,W
	BTRSS	STATUS,2
	.line	272, "main.c"; 	gotoSleep();
	MCALL	_gotoSleep
	.line	274, "main.c"; 	delay(100);
	MOVIA	0x64
	MCALL	_delay
	.line	274, "main.c"; 	//    	if(getbit(PORTB, 3) == 0)
	MGOTO	_00178_DS_
	.line	296, "main.c"; 	}
	RETURN	
; exit point of _main
...
_delay:
; 2 exit points
	.line	837, "main.c"; 	void delay(u8t count)
	BANKSEL	r0x1037
	MOVAR	r0x1037
...
; 2 exit points
_00537_DS_:
	.line	833, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	MGOTO	_00537_DS_
	.line	835, "main.c"; 	}
	RETURN	
...
; 2 exit points
	.line	818, "main.c"; 	void F_Quarter_VDD_Convert(char count)
	BANKSEL	r0x1039
	MOVAR	r0x1039
	.line	821, "main.c"; 	ADMD  = 0x90 | C_Quarter_VDD;			// Select internal 1/4VDD as ADC input
	MOVIA	0x9b
	MOVAR	_ADMD
	.line	822, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x103A
	MOVAR	r0x103A
_00530_DS_:
	...
	BTRSS	STATUS,0
	MGOTO	_00532_DS_
	.line	824, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	825, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete	
	MCALL	_F_wait_eoc
	.line	826, "main.c"; 	R_Quarter_VDD_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x103B
	BANKSEL	_R_Quarter_VDD_DATA_LB
	ADDAR	_R_Quarter_VDD_DATA_LB,F
	.line	827, "main.c"; 	R_Quarter_VDD_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x103B
	MOVAR	r0x103B
;;1	CLRR	r0x103C
...
_checkBat:
; 2 exit points
	.line	698, "main.c"; 	R_Quarter_VDD_DATA=R_Quarter_VDD_DATA_LB=0x00;
	BANKSEL	_R_Quarter_VDD_DATA_LB
	CLRR	_R_Quarter_VDD_DATA_LB
	BANKSEL	_R_Quarter_VDD_DATA
	CLRR	_R_Quarter_VDD_DATA
	CLRR	(_R_Quarter_VDD_DATA + 1)
	.line	699, "main.c"; 	F_Quarter_VDD_Convert(8);			// execute 1/4VDD input channel ADC converting 8 times
	MOVIA	0x08
	MCALL	_F_Quarter_VDD_Convert
	.line	700, "main.c"; 	R_Quarter_VDD_DATA <<= 4;			// R_Quarter_VDD_DATA shift left 4 bit
	BANKSEL	_R_Quarter_VDD_DATA
	...
	.line	701, "main.c"; 	R_Quarter_VDD_DATA_LB &= 0xF0;		// Only get Bit7~4
	MOVIA	0xf0
	BANKSEL	_R_Quarter_VDD_DATA_LB
	ANDAR	_R_Quarter_VDD_DATA_LB,F
	.line	702, "main.c"; 	R_Quarter_VDD_DATA += R_Quarter_VDD_DATA_LB; //// R_Quarter_VDD_DATA + R_Quarter_VDD_DATA_LB
...
_00002_DS_:
	.line	703, "main.c"; 	R_Quarter_VDD_DATA >>=3;			// R_Quarter_VDD_DATA dividing 8
	BCR	STATUS,0
	BANKSEL	_R_Quarter_VDD_DATA
...
;;unsigned compare: left >= lit (0x835=2101), size=2
	.line	704, "main.c"; 	if(R_Quarter_VDD_DATA > 2100)
	MOVIA	0x08
...
_00505_DS_:
	BTRSS	STATUS,0
	MGOTO	_00435_DS_
	.line	706, "main.c"; 	if(++fullTime > 200)
	BANKSEL	_fullTime
	INCR	_fullTime,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0xC9=201), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00437_DS_
	.line	708, "main.c"; 	fullFlag = 1;
	MOVIA	0x01
	BANKSEL	_fullFlag
	MOVAR	_fullFlag
	.line	709, "main.c"; 	pwStep = 100;
	MOVIA	0x64
	BANKSEL	_pwStep
	MOVAR	_pwStep
	MGOTO	_00437_DS_
...
_00435_DS_:
	.line	712, "main.c"; 	else if(R_Quarter_VDD_DATA < 1550)
	MOVIA	0x06
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00507_DS_:
	BTRSC	STATUS,0
	MGOTO	_00432_DS_
	.line	714, "main.c"; 	pwStep = 0;
	BANKSEL	_pwStep
	CLRR	_pwStep
	.line	715, "main.c"; 	fullTime = 0;
	BANKSEL	_fullTime
	CLRR	_fullTime
	.line	716, "main.c"; 	if((0x20 & PORTA) == 0)
	BANKSEL	_PORTA
	BTRSC	_PORTA,5
	MGOTO	_00437_DS_
	.line	718, "main.c"; 	pwFlag = 0;		//关机
	BANKSEL	_pwFlag
	CLRR	_pwFlag
	.line	719, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	720, "main.c"; 	pwShowTime = 0;
	BANKSEL	_pwShowTime
	CLRR	_pwShowTime
	.line	721, "main.c"; 	stepShowTime = 0;
	BANKSEL	_stepShowTime
	CLRR	_stepShowTime
	.line	722, "main.c"; 	offShowTime = 0;
	BANKSEL	_offShowTime
	CLRR	_offShowTime
	MGOTO	_00437_DS_
_00432_DS_:
...
;;unsigned compare: left < lit (0x802=2050), size=2
	.line	729, "main.c"; 	if(R_Quarter_VDD_DATA >= 2050)
	MOVIA	0x08
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00508_DS_:
	BTRSS	STATUS,0
	MGOTO	_00394_DS_
	.line	731, "main.c"; 	tempValue = (R_Quarter_VDD_DATA - 2050) + 75;
	MOVIA	0x49
	BANKSEL	_R_Quarter_VDD_DATA
...
_00394_DS_:
	.line	733, "main.c"; 	else if(R_Quarter_VDD_DATA >= 1998)
	MOVIA	0x07
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00509_DS_:
	BTRSS	STATUS,0
	MGOTO	_00391_DS_
	.line	735, "main.c"; 	tempValue = (R_Quarter_VDD_DATA - 1998)/2 + 49;
	MOVIA	0x32
	BANKSEL	_R_Quarter_VDD_DATA
	ADDAR	_R_Quarter_VDD_DATA,W
	BANKSEL	r0x1041
...
_00391_DS_:
	.line	737, "main.c"; 	else if(R_Quarter_VDD_DATA >= 1886)
	MOVIA	0x07
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00510_DS_:
	BTRSS	STATUS,0
	MGOTO	_00388_DS_
	.line	739, "main.c"; 	tempValue = ((R_Quarter_VDD_DATA - 1886)/4) + 21;
	MOVIA	0xa2
	BANKSEL	_R_Quarter_VDD_DATA
	ADDAR	_R_Quarter_VDD_DATA,W
	BANKSEL	r0x1041
...
_00388_DS_:
	.line	741, "main.c"; 	else if(R_Quarter_VDD_DATA > 1550)
	MOVIA	0x06
	BANKSEL	_R_Quarter_VDD_DATA
	SUBAR	(_R_Quarter_VDD_DATA + 1),W
	BTRSS	STATUS,2
...
_00511_DS_:
	BTRSS	STATUS,0
	MGOTO	_00385_DS_
	.line	743, "main.c"; 	tempValue = (R_Quarter_VDD_DATA - 1550)/16;
	MOVIA	0xf2
	BANKSEL	_R_Quarter_VDD_DATA
	ADDAR	_R_Quarter_VDD_DATA,W
	BANKSEL	r0x1041
...
_00006_DS_:
	...
	MGOTO	_00395_DS_
_00385_DS_:
	.line	747, "main.c"; 	tempValue = 0;
	BANKSEL	r0x103F
	CLRR	r0x103F
	BANKSEL	r0x1040
	CLRR	r0x1040
_00395_DS_:
	.line	749, "main.c"; 	if(0x20 & PORTA)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	MGOTO	_00429_DS_
;;unsigned compare: left < lit (0x5=5), size=2
	.line	753, "main.c"; 	if(tempValue < 5)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00414_DS_:
	.line	757, "main.c"; 	else if(tempValue < 20)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00513_DS_:
	BTRSC	STATUS,0
	MGOTO	_00411_DS_
	.line	759, "main.c"; 	tempValue = tempValue - 5;
	MOVIA	0xfb
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00411_DS_:
	.line	761, "main.c"; 	else if(tempValue < 30)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00514_DS_:
	BTRSC	STATUS,0
	MGOTO	_00408_DS_
	.line	763, "main.c"; 	tempValue = tempValue - 10;
	MOVIA	0xf6
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00408_DS_:
	.line	765, "main.c"; 	else if(tempValue < 40)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00515_DS_:
	BTRSC	STATUS,0
	MGOTO	_00405_DS_
	.line	767, "main.c"; 	tempValue = tempValue - 15;
	MOVIA	0xf1
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00405_DS_:
	.line	769, "main.c"; 	else if(tempValue < 50)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00516_DS_:
	BTRSC	STATUS,0
	MGOTO	_00402_DS_
	.line	771, "main.c"; 	tempValue = tempValue - 21;
	MOVIA	0xeb
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00402_DS_:
	.line	773, "main.c"; 	else if(tempValue < 70)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00517_DS_:
	BTRSC	STATUS,0
	MGOTO	_00399_DS_
	.line	775, "main.c"; 	tempValue = tempValue - 22;
	MOVIA	0xea
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00399_DS_:
	.line	777, "main.c"; 	else if(tempValue < 120)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00518_DS_:
	BTRSC	STATUS,0
	MGOTO	_00012_DS_
	.line	779, "main.c"; 	tempValue = tempValue - 23;
	MOVIA	0xe9
	BANKSEL	r0x103F
	ADDAR	r0x103F,F
	BTRSC	STATUS,0
...
_00012_DS_:
	.line	781, "main.c"; 	if(tempValue >= 100)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00519_DS_:
	...
	CLRR	r0x1040
_00417_DS_:
	.line	786, "main.c"; 	if(pwStep < tempValue)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BANKSEL	r0x1041
	MOVAR	r0x1041
...
_00429_DS_:
	.line	795, "main.c"; 	if(tempValue > 100)
	MOVIA	0x00
	BANKSEL	r0x1040
	SUBAR	r0x1040,W
	BTRSS	STATUS,2
...
_00521_DS_:
	...
	CLRR	r0x1040
_00421_DS_:
	.line	797, "main.c"; 	if(pwStep == 0)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BTRSS	STATUS,2
	MGOTO	_00423_DS_
	.line	799, "main.c"; 	pwStep = tempValue;
	BANKSEL	r0x103F
	MOVR	r0x103F,W
	BANKSEL	_pwStep
	MOVAR	_pwStep
_00423_DS_:
	.line	801, "main.c"; 	if(pwStep > tempValue)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BANKSEL	r0x1041
	MOVAR	r0x1041
...
_00523_DS_:
	BTRSS	STATUS,0
	MGOTO	_00437_DS_
	.line	805, "main.c"; 	count5s = 0;
	BANKSEL	_count5s
	CLRR	_count5s
	CLRR	(_count5s + 1)
	.line	806, "main.c"; 	pwStep--;
	BANKSEL	_pwStep
	DECR	_pwStep,F
_00437_DS_:
	.line	814, "main.c"; 	}
...
_initAD:
; 2 exit points
	.line	670, "main.c"; 	ADMD  = C_ADC_En | C_ADC_CH_Dis;	// Enable ADC power, Disable global ADC input channel, Select PA0 pad as ADC input (SFR "ADMD")
	MOVIA	0x80
	MOVAR	_ADMD
	.line	675, "main.c"; 	ADVREFH = C_Vrefh_2V;					// ADC reference high voltage is supplied by internal 2V  (Note: ADC clock freq. must be equal or less than 250KHz)
	CLRR	_ADVREFH
	.line	680, "main.c"; 	ADR	  = C_Ckl_Div8;						// ADC clock=Fcpu/8, Clear ADIF, disable ADC interrupt	
	MOVIA	0x10
	MOVAR	_ADR
	.line	684, "main.c"; 	ADCR  = C_Sample_1clk | C_12BIT;		// Sample pulse width=1 adc clock, ADC select 12-bit conversion ( Note: ADC clock freq. must be equal or less than 500KHz)
	MOVIA	0x03
	MOVAR	_ADCR
	.line	691, "main.c"; 	ADMDbits.GCHS = 1;						// Enable global ADC channel	(SFR "ADMD")
	BSR	_ADMDbits,4
	.line	692, "main.c"; 	delay(50);								// Delay 0.56ms(Instruction clock=4MHz/2T) for waiting ADC stable 
	MOVIA	0x32
	MCALL	_delay
	.line	693, "main.c"; 	}
	RETURN	
...
_keyCtr:
; 2 exit points
	.line	614, "main.c"; 	char kclick = keyRead(0x80 & (~PORTA));
	BANKSEL	_PORTA
	COMR	_PORTA,W
	BANKSEL	r0x1046
	MOVAR	r0x1046
	...
	BANKSEL	r0x1046
	MOVAR	r0x1046
	.line	615, "main.c"; 	if(kclick == 1)
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00369_DS_
	.line	617, "main.c"; 	checkBat();
	MCALL	_checkBat
	.line	618, "main.c"; 	if(pwFlag && pwStep > 0)
	BANKSEL	_pwFlag
	MOVR	_pwFlag,W
	BTRSC	STATUS,2
	MGOTO	_00371_DS_
	...
	BTRSC	STATUS,2
	MGOTO	_00371_DS_
	.line	620, "main.c"; 	if(showFlag == 0)
	BANKSEL	_showFlag
	MOVR	_showFlag,W
	BTRSS	STATUS,2
	MGOTO	_00354_DS_
	.line	623, "main.c"; 	pwShowTime = 3;
	MOVIA	0x03
	BANKSEL	_pwShowTime
	MOVAR	_pwShowTime
	.line	624, "main.c"; 	offShowTime = 0;
	BANKSEL	_offShowTime
	CLRR	_offShowTime
	MGOTO	_00371_DS_
_00354_DS_:
	.line	626, "main.c"; 	else if(stepShowTime == 0)
	BANKSEL	_stepShowTime
	MOVR	_stepShowTime,W
	BTRSS	STATUS,2
	MGOTO	_00351_DS_
	.line	628, "main.c"; 	pwShowTime = 0;
	BANKSEL	_pwShowTime
	CLRR	_pwShowTime
	.line	629, "main.c"; 	stepShowTime = 2;
	MOVIA	0x02
	BANKSEL	_stepShowTime
	MOVAR	_stepShowTime
	.line	630, "main.c"; 	offShowTime = 0;
	BANKSEL	_offShowTime
	CLRR	_offShowTime
	MGOTO	_00371_DS_
_00351_DS_:
	.line	634, "main.c"; 	pwShowTime = 0;
	BANKSEL	_pwShowTime
	CLRR	_pwShowTime
	.line	635, "main.c"; 	if(++workStep > 3)
	BANKSEL	_workStep
	INCR	_workStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x4=4), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00349_DS_
	.line	636, "main.c"; 	workStep = 1;
	MOVIA	0x01
	MOVAR	_workStep
_00349_DS_:
	.line	637, "main.c"; 	stepShowTime = 2;
	MOVIA	0x02
	BANKSEL	_stepShowTime
	MOVAR	_stepShowTime
	.line	638, "main.c"; 	offShowTime = 0;
	BANKSEL	_offShowTime
	CLRR	_offShowTime
	MGOTO	_00371_DS_
_00369_DS_:
	.line	642, "main.c"; 	else if(kclick == 2)
	BANKSEL	r0x1046
	MOVR	r0x1046,W
	XORIA	0x02
	BTRSS	STATUS,2
	MGOTO	_00371_DS_
	.line	644, "main.c"; 	checkBat();
	MCALL	_checkBat
	.line	645, "main.c"; 	if(pwFlag)
	BANKSEL	_pwFlag
	MOVR	_pwFlag,W
	BTRSC	STATUS,2
	MGOTO	_00364_DS_
	.line	647, "main.c"; 	pwFlag = 0;		//关机
	CLRR	_pwFlag
	.line	648, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	649, "main.c"; 	pwShowTime = 0;
	BANKSEL	_pwShowTime
	CLRR	_pwShowTime
	.line	650, "main.c"; 	stepShowTime = 0;
	BANKSEL	_stepShowTime
	CLRR	_stepShowTime
	.line	651, "main.c"; 	offShowTime = 5;
	MOVIA	0x05
	BANKSEL	_offShowTime
	MOVAR	_offShowTime
	MGOTO	_00371_DS_
_00364_DS_:
	.line	653, "main.c"; 	else if(pwStep > 0)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BTRSC	STATUS,2
	MGOTO	_00371_DS_
	.line	656, "main.c"; 	pwFlag = 1;		//开机
	MOVIA	0x01
	BANKSEL	_pwFlag
	MOVAR	_pwFlag
	.line	657, "main.c"; 	pwShowTime = 3;
	MOVIA	0x03
	BANKSEL	_pwShowTime
	MOVAR	_pwShowTime
	.line	658, "main.c"; 	stepShowTime = 2;
	MOVIA	0x02
	BANKSEL	_stepShowTime
	MOVAR	_stepShowTime
	.line	659, "main.c"; 	offShowTime = 0;
	BANKSEL	_offShowTime
	CLRR	_offShowTime
	.line	660, "main.c"; 	if(workStep == 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSS	STATUS,2
	MGOTO	_00371_DS_
	.line	661, "main.c"; 	workStep = 1;
	MOVIA	0x01
	MOVAR	_workStep
_00371_DS_:
	.line	664, "main.c"; 	}
...
;;unsigned compare: left < lit (0xC8=200), size=1
	.line	584, "main.c"; 	if(keyCount >= 200)
	MOVIA	0xc8
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	MGOTO	_00342_DS_
	.line	586, "main.c"; 	keyCount = 200;
	MOVIA	0xc8
	MOVAR	_keyCount
...
;;unsigned compare: left < lit (0xC8=200), size=1
_00341_DS_:
	.line	596, "main.c"; 	if(keyCount >= 200)
	MOVIA	0xc8
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
...
_pwmStop:
; 2 exit points
	.line	573, "main.c"; 	T2CR1 = C_TMR2_Dis;
	CLRA	
	SFUN	_T2CR1
	.line	574, "main.c"; 	}
	RETURN	
...
_pwmInit:
; 2 exit points
	.line	561, "main.c"; 	if(0x80&T2CR1)
	SFUNR	_T2CR1
	BANKSEL	r0x1047
	MOVAR	r0x1047
	BTRSC	r0x1047,7
	.line	562, "main.c"; 	return;
	MGOTO	_00322_DS_
	.line	563, "main.c"; 	TMRH = 0x00;
	CLRR	_TMRH
	.line	564, "main.c"; 	TMR2 = 100;							//频率为110K
	MOVIA	0x64
	SFUN	_TMR2
	.line	565, "main.c"; 	PWM2DUTY = 100;				// 		
	SFUN	_PWM2DUTY
	.line	567, "main.c"; 	T2CR2 = C_TMR2_ClkSrc_Inst | C_PS2_Div4;	// Enable Prescaler1, Prescaler1 dividing rate = 1:2, Timer1 clock source is instruction clock 
	MOVIA	0x01
	SFUN	_T2CR2
	.line	568, "main.c"; 	T2CR1 = C_PWM2_En | C_TMR2_Reload | C_TMR2_En;	// PWM1 output will be present on PB6 , PWM1 output is active high, reloaded from TMR1, non-stop mode
	MOVIA	0x83
	SFUN	_T2CR1
_00322_DS_:
	.line	569, "main.c"; 	}
...
_gotoSleep:
; 2 exit points
	.line	528, "main.c"; 	sleepFlag = 0;
	BANKSEL	_sleepFlag
	CLRR	_sleepFlag
	.line	529, "main.c"; 	waitTime = 0;
	BANKSEL	_waitTime
	CLRR	_waitTime
	CLRR	(_waitTime + 1)
	.line	530, "main.c"; 	setInput();
	MCALL	_setInput
	.line	531, "main.c"; 	sleepTime = 0;
	BANKSEL	_sleepTime
	CLRR	_sleepTime
	.line	532, "main.c"; 	pwFlag = 0;
	BANKSEL	_pwFlag
	CLRR	_pwFlag
	.line	533, "main.c"; 	pwmStop();
	MCALL	_pwmStop
	.line	534, "main.c"; 	AWUCON = 0xA0;
	MOVIA	0xa0
	MOVAR	_AWUCON
	.line	536, "main.c"; 	IOSTB = C_PB3_Input;
	MOVIA	0x08
	IOST	_IOSTB
	...
	.line	543, "main.c"; 	ENI();
	ENI
	.line	544, "main.c"; 	if((0x20 & PORTA) == 0)
	BANKSEL	_PORTA
	BTRSC	_PORTA,5
	MGOTO	_00315_DS_
	.line	545, "main.c"; 	SLEEP();
	sleep
_00315_DS_:
	.line	546, "main.c"; 	AWUCON = 0x00;
	CLRR	_AWUCON
	.line	547, "main.c"; 	IOSTA = C_PA7_Input  | C_PA5_Input;
	MOVIA	0xa0
	IOST	_IOSTA
	.line	548, "main.c"; 	IOSTB = C_PB3_Input ;
	MOVIA	0x08
	IOST	_IOSTB
	.line	549, "main.c"; 	PORTA = 0x00;
	BANKSEL	_PORTA
	CLRR	_PORTA
	.line	550, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_PABKey;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x03
	MOVAR	_INTE
...
_initSys:
; 2 exit points
	.line	496, "main.c"; 	DISI();
	DISI
	.line	497, "main.c"; 	IOSTA = C_PA7_Input  | C_PA5_Input;
	MOVIA	0xa0
	IOST	_IOSTA
	.line	498, "main.c"; 	IOSTB = C_PB3_Input;
	MOVIA	0x08
	IOST	_IOSTB
	.line	499, "main.c"; 	PORTB = 0x00;
	CLRR	_PORTB
	.line	500, "main.c"; 	PORTA = 0x00;
	BANKSEL	_PORTA
	CLRR	_PORTA
	.line	502, "main.c"; 	setInput();
	MCALL	_setInput
	.line	503, "main.c"; 	APHCON = 0x7F;
	MOVIA	0x7f
	IOST	_APHCON
	.line	504, "main.c"; 	BPHCON = 0xFF;		//PB3上拉
	MOVIA	0xff
	MOVAR	_BPHCON
	.line	505, "main.c"; 	ABPLCON = 0xFF;
	MOVAR	_ABPLCON
	.line	507, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_PABKey;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x03
	MOVAR	_INTE
	.line	509, "main.c"; 	PCON1 = C_TMR0_Dis;
	CLRA	
	IOST	_PCON1
	.line	511, "main.c"; 	TMR0 = 55;
	MOVIA	0x37
	MOVAR	_TMR0
	.line	512, "main.c"; 	T0MD =  C_PS0_TMR0 | C_PS0_Div2;
	CLRA	
	T0MD	
	.line	514, "main.c"; 	PCON1 = C_TMR0_En;
	MOVIA	0x01
	IOST	_PCON1
	.line	517, "main.c"; 	PCON = C_WDT_En | C_LVR_En | 0x10;				// Enable WDT ,  Enable LVR
	MOVIA	0x98
	MOVAR	_PCON
	.line	520, "main.c"; 	PCON1 = C_TMR0_En;						// Enable Timer0
	MOVIA	0x01
	IOST	_PCON1
	.line	521, "main.c"; 	ENI();
	ENI
...
_refreshNub:
; 2 exit points
	.line	487, "main.c"; 	showNubBaiwei(numArray[baiweiNum]);
	BANKSEL	_baiweiNum
	MOVR	_baiweiNum,W
	ADDIA	(_numArray + 0)
	BANKSEL	r0x1048
...
;;103	MOVAR	r0x104A
	...
	.line	488, "main.c"; 	showNubShiwei(numArray[shiweiNum]);
	BANKSEL	_shiweiNum
	MOVR	_shiweiNum,W
	ADDIA	(_numArray + 0)
	BANKSEL	r0x1048
...
;;102	MOVAR	r0x104A
	...
	.line	489, "main.c"; 	showNubGewei(numArray[geweiNum]);
	BANKSEL	_geweiNum
	MOVR	_geweiNum,W
	ADDIA	(_numArray + 0)
	BANKSEL	r0x1048
...
_checkIRKey:
; 2 exit points
	.line	439, "main.c"; 	if(pwFlag == 0)
	BANKSEL	_pwFlag
	MOVR	_pwFlag,W
	BTRSS	STATUS,2
	MGOTO	_00288_DS_
	.line	441, "main.c"; 	irStep = 0;
	BANKSEL	_irStep
	CLRR	_irStep
...
;;unsigned compare: left >= lit (0x5=5), size=1
_00288_DS_:
	.line	444, "main.c"; 	if(zhedangCount > 4 && zhedangTime == 2 && irStep == 0)
	MOVIA	0x05
	BANKSEL	_zhedangCount
	SUBAR	_zhedangCount,W
	BTRSS	STATUS,0
	...
	BTRSS	STATUS,2
	MGOTO	_00295_DS_
	.line	449, "main.c"; 	workTime = 50;
	MOVIA	0x32
	BANKSEL	_workTime
	MOVAR	_workTime
	MGOTO	_00296_DS_
_00295_DS_:
	.line	451, "main.c"; 	else if(workStep == 2)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x02
	BTRSS	STATUS,2
	MGOTO	_00292_DS_
	.line	453, "main.c"; 	workTime = 80;
	MOVIA	0x50
	BANKSEL	_workTime
	MOVAR	_workTime
	MGOTO	_00296_DS_
_00292_DS_:
	.line	455, "main.c"; 	else if(workStep == 3)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x03
	BTRSS	STATUS,2
	MGOTO	_00296_DS_
	.line	457, "main.c"; 	workTime = 120;
	MOVIA	0x78
	BANKSEL	_workTime
	MOVAR	_workTime
_00296_DS_:
	.line	459, "main.c"; 	waitBatTime = 100;
	MOVIA	0x64
	BANKSEL	_waitBatTime
	MOVAR	_waitBatTime
	.line	461, "main.c"; 	irStep = 1;
	MOVIA	0x01
	BANKSEL	_irStep
	MOVAR	_irStep
_00301_DS_:
...
_chrgCtr:
; 2 exit points
	.line	304, "main.c"; 	if((0x20 & PORTA) == 0)
	BANKSEL	_PORTA
	BTRSC	_PORTA,5
	MGOTO	_00189_DS_
	.line	306, "main.c"; 	fullFlag = 0;
	BANKSEL	_fullFlag
	CLRR	_fullFlag
_00189_DS_:
	.line	308, "main.c"; 	BPHCON |= 0x04;
	BSR	_BPHCON,2
	.line	309, "main.c"; 	IOSTB &= 0xFB;
	IOSTR	_IOSTB
	BANKSEL	r0x104B
	MOVAR	r0x104B
	BCR	r0x104B,2
	MOVR	r0x104B,W
	IOST	_IOSTB
	.line	310, "main.c"; 	if(workTime > 0)
	BANKSEL	_workTime
	MOVR	_workTime,W
	BTRSC	STATUS,2
	MGOTO	_00191_DS_
	.line	312, "main.c"; 	pwmInit();
	MCALL	_pwmInit
	.line	313, "main.c"; 	workTime--;
	BANKSEL	_workTime
	DECR	_workTime,F
	MGOTO	_00192_DS_
_00191_DS_:
	.line	317, "main.c"; 	pwmStop();
	MCALL	_pwmStop
	.line	318, "main.c"; 	PORTB &= 0xFB;
	BCR	_PORTB,2
_00192_DS_:
	.line	320, "main.c"; 	if(startTime)
	BANKSEL	_startTime
	MOVR	_startTime,W
	BTRSC	STATUS,2
	MGOTO	_00227_DS_
	.line	322, "main.c"; 	checkBat();
	MCALL	_checkBat
	.line	323, "main.c"; 	startTime--;
	BANKSEL	_startTime
	DECR	_startTime,F
	.line	324, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	325, "main.c"; 	baiweiNum = shiweiNum = 8;
	MOVIA	0x08
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	BANKSEL	_baiweiNum
	MOVAR	_baiweiNum
	.line	326, "main.c"; 	geweiNum = 8;
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	.line	326, "main.c"; 	}
	MGOTO	_00229_DS_
_00227_DS_:
	.line	328, "main.c"; 	else if(stepShowTime)
	BANKSEL	_stepShowTime
	MOVR	_stepShowTime,W
	BTRSC	STATUS,2
	MGOTO	_00224_DS_
	.line	330, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	331, "main.c"; 	baiweiNum = shiweiNum = 0;
	BANKSEL	_shiweiNum
	CLRR	_shiweiNum
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	332, "main.c"; 	geweiNum = workStep;
	BANKSEL	_workStep
	MOVR	_workStep,W
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	...
	MGOTO	_00229_DS_
_00224_DS_:
	.line	334, "main.c"; 	else if(pwShowTime || workTime)
	BANKSEL	_pwShowTime
	MOVR	_pwShowTime,W
	BTRSS	STATUS,2
	MGOTO	_00219_DS_
	...
	MGOTO	_00220_DS_
_00219_DS_:
	.line	336, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x64=100), size=1
	.line	337, "main.c"; 	if(pwStep > 99)
	MOVIA	0x64
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSS	STATUS,0
	MGOTO	_00194_DS_
	.line	339, "main.c"; 	baiweiNum = 1;
	MOVIA	0x01
	BANKSEL	_baiweiNum
	MOVAR	_baiweiNum
	.line	340, "main.c"; 	shiweiNum = geweiNum = 0;
	BANKSEL	_geweiNum
	CLRR	_geweiNum
	BANKSEL	_shiweiNum
	CLRR	_shiweiNum
...
_00194_DS_:
	...
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	345, "main.c"; 	shiweiNum = pwStep/10;
	MOVIA	0x0a
	MOVAR	STK00
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	...
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	346, "main.c"; 	geweiNum = pwStep%10;
	MOVIA	0x0a
	MOVAR	STK00
	BANKSEL	_pwStep
	MOVR	_pwStep,W
...
;;unsigned compare: left >= lit (0x6=6), size=1
_00220_DS_:
	.line	351, "main.c"; 	if(pwStep <= 5 && offShowTime == 0 && ((0x20 & PORTA) == 0) && pwFlag)
	MOVIA	0x06
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSC	STATUS,0
	...
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	354, "main.c"; 	if(++shanTime > 500)			//电量不足闪灯
	BANKSEL	_shanTime
	INCR	_shanTime,F
	BTRSC	STATUS,2
	INCR	(_shanTime + 1),F
...
_00281_DS_:
	BTRSS	STATUS,0
	MGOTO	_00197_DS_
	.line	356, "main.c"; 	shanTime = 0;
	BANKSEL	_shanTime
	CLRR	_shanTime
	CLRR	(_shanTime + 1)
	.line	357, "main.c"; 	showFlag = 0;
	BANKSEL	_showFlag
	CLRR	_showFlag
_00197_DS_:
	.line	360, "main.c"; 	if(shanTime % 100 < 50)
	MOVIA	0x64
	MOVAR	STK02
	MOVIA	0x00
	MOVAR	STK01
...
_00282_DS_:
	BTRSC	STATUS,0
	MGOTO	_00199_DS_
	.line	362, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	363, "main.c"; 	baiweiNum = 0;
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	364, "main.c"; 	shiweiNum = 0;
	BANKSEL	_shiweiNum
	CLRR	_shiweiNum
	.line	365, "main.c"; 	geweiNum = pwStep;
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	MGOTO	_00229_DS_
_00199_DS_:
	.line	369, "main.c"; 	showFlag = 0;
	BANKSEL	_showFlag
	CLRR	_showFlag
	.line	369, "main.c"; 	}
	MGOTO	_00229_DS_
_00214_DS_:
	.line	372, "main.c"; 	else if(offShowTime > 0)
	BANKSEL	_offShowTime
	MOVR	_offShowTime,W
	BTRSC	STATUS,2
	MGOTO	_00211_DS_
	.line	374, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	375, "main.c"; 	baiweiNum = 0;
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	376, "main.c"; 	shiweiNum = 10;
	MOVIA	0x0a
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	377, "main.c"; 	geweiNum = 10;
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	.line	377, "main.c"; 	}
	MGOTO	_00229_DS_
_00211_DS_:
	.line	379, "main.c"; 	else if(0x20 & PORTA)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	MGOTO	_00208_DS_
	.line	385, "main.c"; 	showFlag = 1;
	MOVIA	0x01
	BANKSEL	_showFlag
	MOVAR	_showFlag
	.line	389, "main.c"; 	if(fullFlag)
	BANKSEL	_fullFlag
	MOVR	_fullFlag,W
	BTRSC	STATUS,2
	MGOTO	_00205_DS_
	...
	MOVIA	0x01
	MOVAR	_fullFlag
	.line	393, "main.c"; 	baiweiNum = 1;
	BANKSEL	_baiweiNum
	MOVAR	_baiweiNum
	.line	394, "main.c"; 	shiweiNum = geweiNum = 0;
	BANKSEL	_geweiNum
	CLRR	_geweiNum
	BANKSEL	_shiweiNum
	CLRR	_shiweiNum
	...
	MGOTO	_00229_DS_
_00205_DS_:
	.line	399, "main.c"; 	if(pwStep == 100)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	XORIA	0x64
	BTRSS	STATUS,2
	MGOTO	_00202_DS_
	.line	401, "main.c"; 	fullFlag = 1;
	MOVIA	0x01
	BANKSEL	_fullFlag
	MOVAR	_fullFlag
	.line	402, "main.c"; 	baiweiNum = 0;
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	403, "main.c"; 	shiweiNum = 9;
	MOVIA	0x09
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	404, "main.c"; 	geweiNum = 9;
	BANKSEL	_geweiNum
	MOVAR	_geweiNum
	MGOTO	_00229_DS_
_00202_DS_:
	.line	408, "main.c"; 	baiweiNum = 0;
	BANKSEL	_baiweiNum
	CLRR	_baiweiNum
	.line	409, "main.c"; 	shiweiNum = pwStep/10;
	MOVIA	0x0a
	MOVAR	STK00
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	...
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	410, "main.c"; 	geweiNum = pwStep%10;
	MOVIA	0x0a
	MOVAR	STK00
	BANKSEL	_pwStep
	MOVR	_pwStep,W
...
;	 1113+  367 =  1480 instructions ( 3694 byte)
