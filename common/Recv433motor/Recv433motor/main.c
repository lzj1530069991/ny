...
#define HeadCont_L 562       //4.5ms
 
//实测逻辑1为高电平0.45ms+低电平0.08ms
#define OneCode_H 52        //420us
#define OneCode_L 13        //120us
 
//假设0码为高电平0.21ms+低电平0.3ms
#define Zero_H 23  		//170us
#define Zero_L 40  		//340us
 
//容错范围
#define FaultTolerant 5
...
void proLow()
{
	...
	if(RemoteStart)
		...
		{
			if((T1Counter > (HeadCont_L - (FaultTolerant*2)))&&(T1Counter < (HeadCont_L + (FaultTolerant*2))))
            {
...
//;Initial GPIO  
	...
	TMRH = 0x30;
	TMR1 = 0xFF;
	T1CR2 = C_PS1_Div32 | C_PS1_EN | C_TMR1_ClkSrc_Inst;
	T1CR1 = C_TMR1_En | C_TMR1_Reload;
	//INT1 下降沿触发
