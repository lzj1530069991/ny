...
; 2 exit points
	...
	MOVIA	0xdf
	MOVAR	_BPHCON
	.line	52, "main.c"; 	IOSTB =  C_PB5_Input | C_PB0_Input | C_PB1_Input;	// Set PB4 & PB1 to input mode,others set to output mode
	MOVIA	0x23
	IOST	_IOSTB
...
_00128_DS_:
	...
	LGOTO	_00117_DS_
_00116_DS_:
	.line	73, "main.c"; 	IOSTB =  C_PB5_Input | C_PB0_Input | C_PB1_Input;
	MOVIA	0x23
	IOST	_IOSTB
	.line	74, "main.c"; 	PORTB = 0x00;
	CLRR	_PORTB
_00117_DS_:
...
_gotoSleep:
; 2 exit points
	.line	200, "main.c"; 	sleepTime = 0;
	CLRR	_sleepTime
	.line	201, "main.c"; 	IOSTB =  C_PB5_Input | C_PB0_Input | C_PB1_Input;
	MOVIA	0x23
	IOST	_IOSTB
	.line	202, "main.c"; 	PORTB = 0x00;
	CLRR	_PORTB
	.line	203, "main.c"; 	BWUCON = 0x20;
	MOVIA	0x20
	MOVAR	_BWUCON
	.line	204, "main.c"; 	INTE =  C_INT_TMR0 | C_INT_PBKey;
	MOVIA	0x03
	MOVAR	_INTE
	.line	205, "main.c"; 	PCON =  C_LVR_En;	
	MOVIA	0x08
	MOVAR	_PCON
	.line	206, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	207, "main.c"; 	CLRWDT();
	clrwdt
	.line	208, "main.c"; 	ENI();
	ENI
	.line	209, "main.c"; 	SLEEP();
	sleep
	.line	210, "main.c"; 	BWUCON = 0x00;
	CLRR	_BWUCON
	.line	211, "main.c"; 	INTE =  C_INT_TMR0 ;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x01
	MOVAR	_INTE
	.line	212, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	214, "main.c"; 	PCON = C_WDT_En | C_LVR_En;				// Enable WDT ,  Enable LVR
	MOVIA	0x88
	MOVAR	_PCON
	.line	216, "main.c"; 	}
	RETURN	
...
_setLedduty:
; 0 exit points
	.line	173, "main.c"; 	if(ledCount >= duty0)
	MOVR	_duty0,W
	SUBAR	_ledCount,W
	BTRSS	STATUS,0
	LGOTO	_00231_DS_
	.line	175, "main.c"; 	IOSTB |= 0x01;
	IOSTR	_IOSTB
	MOVAR	r0x100D
	BSR	r0x100D,0
	MOVR	r0x100D,W
	IOST	_IOSTB
	.line	176, "main.c"; 	PORTB |= 0x01;
	BSR	_PORTB,0
	LGOTO	_00232_DS_
_00231_DS_:
	.line	180, "main.c"; 	IOSTB &= 0xFE;
	IOSTR	_IOSTB
	MOVAR	r0x100D
	BCR	r0x100D,0
	MOVR	r0x100D,W
	IOST	_IOSTB
	.line	181, "main.c"; 	PORTB &= 0xFE;
	BCR	_PORTB,0
_00232_DS_:
	.line	183, "main.c"; 	if(ledCount >= duty1)
	MOVR	_duty1,W
	SUBAR	_ledCount,W
	BTRSS	STATUS,0
	LGOTO	_00234_DS_
	.line	185, "main.c"; 	IOSTB |= 0x02;
	IOSTR	_IOSTB
	MOVAR	r0x100D
	BSR	r0x100D,1
	MOVR	r0x100D,W
	IOST	_IOSTB
	.line	186, "main.c"; 	PORTB |= 0x02;
	BSR	_PORTB,1
	LGOTO	_00235_DS_
_00234_DS_:
	.line	190, "main.c"; 	IOSTB &= 0xFD;
	IOSTR	_IOSTB
	MOVAR	r0x100D
	BCR	r0x100D,1
	MOVR	r0x100D,W
	IOST	_IOSTB
	.line	191, "main.c"; 	PORTB &= 0xFD;
	BCR	_PORTB,1
_00235_DS_:
	.line	193, "main.c"; 	if(++ledCount >= MAXDUTY)
	INCR	_ledCount,F
;;unsigned compare: left < lit (0x96=150), size=1
	MOVIA	0x96
	SUBAR	_ledCount,W
	BTRSC	STATUS,0
	.line	194, "main.c"; 	ledCount = 0;
	CLRR	_ledCount
	.line	195, "main.c"; 	}
	RETURN	
...
_keyCtr:
; 2 exit points
	.line	153, "main.c"; 	if(keyRead(0x20 & ~PORTB))
	COMR	_PORTB,W
	MOVAR	r0x100F
	MOVIA	0x20
	ANDAR	r0x100F,F
	...
	BTRSC	STATUS,2
	LGOTO	_00225_DS_
	.line	155, "main.c"; 	workTime = 0;
	CLRR	_workTime
	CLRR	(_workTime + 1)
	.line	156, "main.c"; 	duty0 = duty1 = 0;
	CLRR	_duty1
	CLRR	_duty0
	.line	157, "main.c"; 	ledCount = 0;
	CLRR	_ledCount
	.line	158, "main.c"; 	if(powerFlag)
	MOVR	_powerFlag,W
	BTRSC	STATUS,2
	LGOTO	_00221_DS_
	.line	160, "main.c"; 	powerFlag = 0;
	CLRR	_powerFlag
	LGOTO	_00225_DS_
_00221_DS_:
	.line	164, "main.c"; 	powerFlag = 1;
	MOVIA	0x01
	MOVAR	_powerFlag
_00225_DS_:
	.line	167, "main.c"; 	}
...
_keyRead:
; 2 exit points
	.line	126, "main.c"; 	char keyRead(char keyStatus)	
	MOVAR	r0x100E
	.line	128, "main.c"; 	if(keyStatus)
	MOVR	r0x100E,W
	BTRSC	STATUS,2
	LGOTO	_00213_DS_
	.line	130, "main.c"; 	sleepTime = 0;
	CLRR	_sleepTime
	.line	131, "main.c"; 	keyCount++;
	INCR	_keyCount,F
;;unsigned compare: left < lit (0xC8=200), size=1
	.line	132, "main.c"; 	if(keyCount >= 200)
	MOVIA	0xc8
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00214_DS_
	.line	134, "main.c"; 	keyCount = 200;
	MOVIA	0xc8
	MOVAR	_keyCount
	LGOTO	_00214_DS_
;;unsigned compare: left < lit (0x8=8), size=1
_00213_DS_:
	.line	139, "main.c"; 	if(keyCount >= 8)
	MOVIA	0x08
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00211_DS_
	...
	CLRR	_keyCount
	.line	142, "main.c"; 	return	1;
	MOVIA	0x01
	LGOTO	_00215_DS_
_00211_DS_:
	.line	144, "main.c"; 	keyCount = 0;
	CLRR	_keyCount
_00214_DS_:
	.line	146, "main.c"; 	return 0;
	MOVIA	0x00
_00215_DS_:
	.line	147, "main.c"; 	}
	RETURN	
...
_workCtr:
; 0 exit points
	.line	95, "main.c"; 	if(++workTime >= 800)
	INCR	_workTime,F
	BTRSC	STATUS,2
	INCR	(_workTime + 1),F
...
_00134_DS_:
	.line	97, "main.c"; 	if(workTime < 150)
	MOVIA	0x00
	SUBAR	(_workTime + 1),W
	BTRSS	STATUS,2
	LGOTO	_00196_DS_
...
_00196_DS_:
	BTRSC	STATUS,0
	LGOTO	_00158_DS_
	.line	99, "main.c"; 	duty1 = 0;
	CLRR	_duty1
;;unsigned compare: left < lit (0x96=150), size=1
	.line	100, "main.c"; 	if(duty0 < MAXDUTY)
	MOVIA	0x96
	SUBAR	_duty0,W
	BTRSC	STATUS,0
	LGOTO	_00160_DS_
	.line	101, "main.c"; 	++duty0;
	INCR	_duty0,F
	LGOTO	_00160_DS_
;;unsigned compare: left < lit (0xFA=250), size=2
_00158_DS_:
	.line	103, "main.c"; 	else if(workTime < 250)
	MOVIA	0x00
	SUBAR	(_workTime + 1),W
	BTRSS	STATUS,2
	LGOTO	_00198_DS_
...
_00199_DS_:
	BTRSC	STATUS,0
	LGOTO	_00152_DS_
	.line	107, "main.c"; 	if(duty0 > 0)
	MOVR	_duty0,W
	BTRSC	STATUS,2
	LGOTO	_00160_DS_
	.line	108, "main.c"; 	--duty0;
	DECR	_duty0,F
	LGOTO	_00160_DS_
;;unsigned compare: left < lit (0x226=550), size=2
_00152_DS_:
	.line	110, "main.c"; 	else if(workTime < 550)
	MOVIA	0x02
	SUBAR	(_workTime + 1),W
	BTRSS	STATUS,2
	LGOTO	_00200_DS_
...
_00200_DS_:
	BTRSC	STATUS,0
	LGOTO	_00149_DS_
	.line	112, "main.c"; 	duty0 = 0;
	CLRR	_duty0
;;unsigned compare: left < lit (0x96=150), size=1
	.line	113, "main.c"; 	if(duty1 < MAXDUTY)
	MOVIA	0x96
	SUBAR	_duty1,W
	BTRSC	STATUS,0
	LGOTO	_00160_DS_
	.line	114, "main.c"; 	++duty1;
	INCR	_duty1,F
	LGOTO	_00160_DS_
;;unsigned compare: left < lit (0x28A=650), size=2
_00149_DS_:
	.line	116, "main.c"; 	else if(workTime < 650)
	MOVIA	0x02
	SUBAR	(_workTime + 1),W
	BTRSS	STATUS,2
	LGOTO	_00202_DS_
...
_00202_DS_:
	BTRSC	STATUS,0
	LGOTO	_00146_DS_
	.line	117, "main.c"; 	duty1 = MAXDUTY;
	MOVIA	0x96
	MOVAR	_duty1
	LGOTO	_00160_DS_
;;unsigned compare: left < lit (0x320=800), size=2
_00146_DS_:
	.line	118, "main.c"; 	else if(workTime < 800)
	MOVIA	0x03
	SUBAR	(_workTime + 1),W
	BTRSS	STATUS,2
	LGOTO	_00203_DS_
...
_00203_DS_:
	BTRSC	STATUS,0
	LGOTO	_00160_DS_
	.line	120, "main.c"; 	if(duty1 > 0)
	MOVR	_duty1,W
	BTRSS	STATUS,2
	.line	121, "main.c"; 	--duty1;
	DECR	_duty1,F
_00160_DS_:
	.line	123, "main.c"; 	}
	RETURN	
...
;	  285+    0 =   285 instructions (  570 byte)
