...
_main:
; 2 exit points
	.line	562, "main.c"; 	initSys();
	LCALL	_initSys
	.line	563, "main.c"; 	PORTB = 0xFF;
	MOVIA	0xff
	MOVAR	_PORTB
	.line	564, "main.c"; 	PORTA = 0xFF;
	MOVAR	_PORTA
	.line	565, "main.c"; 	gotoSleep();
	LCALL	_gotoSleep
	.line	566, "main.c"; 	initAD();
	LCALL	_initAD
_00314_DS_:
	.line	569, "main.c"; 	CLRWDT();	
	clrwdt
	.line	570, "main.c"; 	if(!INTFLAG)
	BANKSEL	_INTFLAG
	MOVR	_INTFLAG,W
	BTRSC	STATUS,2
	LGOTO	_00314_DS_
	.line	572, "main.c"; 	INTFLAG = 0;
	CLRR	_INTFLAG
	.line	573, "main.c"; 	if(checkLVD())
	LCALL	_checkLVD
	BANKSEL	r0x103A
	MOVAR	r0x103A
	MOVR	r0x103A,W
	BTRSC	STATUS,2
	LGOTO	_00303_DS_
	.line	575, "main.c"; 	if(++lvdCount >= 30)
	BANKSEL	_lvdCount
	INCR	_lvdCount,F
;;unsigned compare: left < lit (0x1E=30), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00304_DS_
	.line	576, "main.c"; 	lvdFlag = 1;	//电压低电压
	MOVIA	0x01
	BANKSEL	_lvdFlag
	MOVAR	_lvdFlag
	LGOTO	_00304_DS_
_00303_DS_:
	.line	580, "main.c"; 	lvdFlag = 0;	//电压正常
	BANKSEL	_lvdFlag
	CLRR	_lvdFlag
	.line	581, "main.c"; 	lvdCount = 0;
	BANKSEL	_lvdCount
	CLRR	_lvdCount
_00304_DS_:
	.line	586, "main.c"; 	powerFlag = getbit(PORTB,1);
	MOVR	_PORTB,W
	ANDIA	0x02
	BTRSS	STATUS,2
	MOVIA	0x01
	BANKSEL	_powerFlag
	MOVAR	_powerFlag
	.line	588, "main.c"; 	powerFullFlag = getbit(PORTB,0);
	MOVR	_PORTB,W
	ANDIA	0x01
	BANKSEL	_powerFullFlag
	MOVAR	_powerFullFlag
	.line	590, "main.c"; 	checkAD();
	LCALL	_checkAD
	.line	592, "main.c"; 	KeyStatus = KeyScan() & 0x1F;	// Get PB4 ~ PB0 Key Status
	LCALL	_KeyScan
	BANKSEL	r0x103A
	MOVAR	r0x103A
	MOVIA	0x1f
	...
	BTRSC	STATUS,2
	LGOTO	_00314_DS_
	.line	596, "main.c"; 	nextorSleep();
	LCALL	_nextorSleep
;;unsigned compare: left < lit (0x1=1), size=1
	.line	599, "main.c"; 	switch(workStep)
	MOVIA	0x01
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSS	STATUS,0
...
_00342_DS_:
	...
	LGOTO	_00309_DS_
_00305_DS_:
	.line	602, "main.c"; 	pwmwaitTime = 2;
	MOVIA	0x02
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	.line	603, "main.c"; 	pwmLmax = pwm2Lmax = 16;
	MOVIA	0x10
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	604, "main.c"; 	break;
	LGOTO	_00314_DS_
_00306_DS_:
	.line	606, "main.c"; 	pwmwaitTime = 4;
	MOVIA	0x04
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	.line	607, "main.c"; 	pwmLmax = pwm2Lmax = 16;
	MOVIA	0x10
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	608, "main.c"; 	break;
	LGOTO	_00314_DS_
_00307_DS_:
	.line	610, "main.c"; 	pwmwaitTime = 6;
	MOVIA	0x06
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	.line	611, "main.c"; 	pwmLmax = pwm2Lmax = 16;
	MOVIA	0x10
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	612, "main.c"; 	break;
	LGOTO	_00314_DS_
_00308_DS_:
	.line	614, "main.c"; 	pwmwaitTime = 9;
	MOVIA	0x09
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	.line	615, "main.c"; 	pwmLmax = pwm2Lmax = 8;
	MOVIA	0x08
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	616, "main.c"; 	break;
	LGOTO	_00314_DS_
_00309_DS_:
	.line	618, "main.c"; 	pwmwaitTime = 12;
	MOVIA	0x0c
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	.line	619, "main.c"; 	pwmLmax = pwm2Lmax = 8;
	MOVIA	0x08
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	BANKSEL	_pwmLmax
...
_checkAD:
; 2 exit points
	.line	780, "main.c"; 	R_AIN1_DATA=R_AIN1_DATA_LB=0x00;            
	BANKSEL	_R_AIN1_DATA_LB
	CLRR	_R_AIN1_DATA_LB
	BANKSEL	_R_AIN1_DATA
	CLRR	_R_AIN1_DATA
	CLRR	(_R_AIN1_DATA + 1)
	.line	782, "main.c"; 	F_AIN1_Convert(8);					// execute AIN0 ADC converting 8 times
	MOVIA	0x08
	LCALL	_F_AIN1_Convert
	.line	784, "main.c"; 	R_AIN1_DATA <<= 4;					// R_AIN0_DATA shift left 4 bit
	BANKSEL	_R_AIN1_DATA
	...
	.line	786, "main.c"; 	R_AIN1_DATA_LB &= 0xF0;				// Only get Bit7~4
	MOVIA	0xf0
	BANKSEL	_R_AIN1_DATA_LB
	ANDAR	_R_AIN1_DATA_LB,F
	.line	788, "main.c"; 	R_AIN1_DATA += R_AIN1_DATA_LB;		// R_AIN0_DATA + R_AIN0_DATA_LB
...
_00001_DS_:
	.line	790, "main.c"; 	R_AIN1_DATA >>=3;					// R_AIN0_DATA divided 8
	BCR	STATUS,0
	BANKSEL	_R_AIN1_DATA
...
;;unsigned compare: left >= lit (0x21D=541), size=2
	.line	794, "main.c"; 	if(R_AIN1_DATA > 540)			//电流大于1.2A     (1.2*0.22/2)*4096  = 540
	MOVIA	0x02
...
;;unsigned compare: left < lit (0x14=20), size=1
	...
	BTRSS	STATUS,0
	LGOTO	_00411_DS_
	.line	799, "main.c"; 	adCount = 0;
	CLRR	_adCount
	.line	800, "main.c"; 	gotoSleep();
	LCALL	_gotoSleep
	LGOTO	_00411_DS_
_00409_DS_:
	.line	806, "main.c"; 	adCount = 0;
	BANKSEL	_adCount
	CLRR	_adCount
_00411_DS_:
	.line	809, "main.c"; 	}
...
; 2 exit points
_00401_DS_:
	.line	769, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	LGOTO	_00401_DS_
	.line	773, "main.c"; 	}
	RETURN	
...
_F_AIN1_Convert:
; 2 exit points
	.line	740, "main.c"; 	void F_AIN1_Convert(char count)
	BANKSEL	r0x1028
	MOVAR	r0x1028
	.line	743, "main.c"; 	R_AIN1_DATA=R_AIN1_DATA_LB=0x00;   
	BANKSEL	_R_AIN1_DATA_LB
	CLRR	_R_AIN1_DATA_LB
	BANKSEL	_R_AIN1_DATA
	CLRR	_R_AIN1_DATA
	CLRR	(_R_AIN1_DATA + 1)
	.line	747, "main.c"; 	ADMD  = 0x90 | C_ADC_PA1;				// Select AIN0(PA0) pad as ADC input
	MOVIA	0x91
	MOVAR	_ADMD
...
_00394_DS_:
	...
	BTRSS	STATUS,0
	LGOTO	_00396_DS_
	.line	753, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	755, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete
	LCALL	_F_wait_eoc
	.line	757, "main.c"; 	R_AIN1_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x102A
	BANKSEL	_R_AIN1_DATA_LB
...
_initAD:
; 2 exit points
	.line	698, "main.c"; 	ADMD  = C_ADC_En | C_ADC_CH_Dis | C_ADC_PA1 ;	// Enable ADC power, Disable global ADC input channel, Select PA0 pad as ADC input (SFR "ADMD")
	MOVIA	0x81
	MOVAR	_ADMD
	.line	704, "main.c"; 	ADVREFH = C_Vrefh_2V;					// ADC reference high voltage is supplied by internal 4V  (Note: ADC clock freq. must be equal or less than 1MHz)
	CLRR	_ADVREFH
	.line	718, "main.c"; 	ADR	  = C_Ckl_Div8;						// ADC clock=Fcpu/8, Clear ADIF, disable ADC interrupt	
	MOVIA	0x10
	MOVAR	_ADR
	.line	722, "main.c"; 	ADCR  = C_Sample_1clk | C_12BIT;
	MOVIA	0x03
	MOVAR	_ADCR
	.line	726, "main.c"; 	PACON = C_PA1_AIN1;						// Set AIN0(PA0) as pure ADC input for reduce power consumption (SFR "PACON")
	MOVIA	0x02
	MOVAR	_PACON
	.line	728, "main.c"; 	ADMDbits.GCHS = 1;						// Enable global ADC channel	(SFR "ADMD")
	BSR	_ADMDbits,4
	.line	730, "main.c"; 	delay(100);								// Delay 0.56ms(Instruction clock=4MHz/2T) for waiting ADC stable 
	MOVIA	0x64
	MOVAR	STK00
	MOVIA	0x00
	LCALL	_delay
...
_checkLVD:
; 2 exit points
	.line	678, "main.c"; 	PCON1 = C_LVD_2P4V;
	MOVIA	0x08
	IOST	_PCON1
	.line	679, "main.c"; 	delay(80);
	MOVIA	0x50
	MOVAR	STK00
	MOVIA	0x00
	LCALL	_delay
	.line	680, "main.c"; 	if((PCON1 >> 6)&1)
	IOSTR	_PCON1
	BANKSEL	r0x1037
	MOVAR	r0x1037
	ANDIA	0x40
	...
	BTRSC	STATUS,2
	LGOTO	_00382_DS_
	.line	682, "main.c"; 	lvdFlag = 0;
	BANKSEL	r0x1037
	CLRR	r0x1037
	LGOTO	_00383_DS_
_00382_DS_:
	.line	686, "main.c"; 	lvdFlag = 1;
	MOVIA	0x01
	BANKSEL	r0x1037
	MOVAR	r0x1037
_00383_DS_:
	.line	688, "main.c"; 	return lvdFlag;
	BANKSEL	r0x1037
	MOVR	r0x1037,W
	.line	689, "main.c"; 	}
	RETURN	
...
_delay:
; 2 exit points
	.line	663, "main.c"; 	void delay(int count)
	BANKSEL	r0x1032
	MOVAR	r0x1032
	MOVR	STK00,W
	BANKSEL	r0x1033
	MOVAR	r0x1033
	.line	666, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x1034
	MOVAR	r0x1034
	BANKSEL	r0x1035
...
_keyRead:
; 2 exit points
	.line	645, "main.c"; 	if (KeyStatus & 0x1)
	BANKSEL	_KeyStatus
	BTRSS	_KeyStatus,0
	LGOTO	_00356_DS_
	.line	647, "main.c"; 	keyCount++;
	BANKSEL	_keyCount
	INCR	_keyCount,F
;;unsigned compare: left < lit (0xA=10), size=1
	.line	648, "main.c"; 	if(keyCount >= 10)
	MOVIA	0x0a
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00357_DS_
	.line	649, "main.c"; 	keyCount = 10;
	MOVIA	0x0a
	MOVAR	_keyCount
	LGOTO	_00357_DS_
;;unsigned compare: left < lit (0xA=10), size=1
_00356_DS_:
	.line	653, "main.c"; 	if(keyCount >= 10)
	MOVIA	0x0a
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	LGOTO	_00354_DS_
	.line	655, "main.c"; 	keyCount = 0;
	CLRR	_keyCount
	.line	656, "main.c"; 	return 1;
	MOVIA	0x01
	LGOTO	_00358_DS_
_00354_DS_:
	.line	658, "main.c"; 	keyCount = 0;
	BANKSEL	_keyCount
	CLRR	_keyCount
_00357_DS_:
	.line	660, "main.c"; 	return 0;
	MOVIA	0x00
_00358_DS_:
	.line	661, "main.c"; 	}
	RETURN	
...
_KeyScan:
; 2 exit points
	.line	636, "main.c"; 	KeyStatus = ~PORTA;
	COMR	_PORTA,W
;;1	MOVAR	r0x1039
	.line	639, "main.c"; 	}
	RETURN	
...
_initSys:
; 2 exit points
	.line	519, "main.c"; 	IOSTA = C_PA0_Input | C_PA1_Input;	 					//PA0输入模式，其他输出模式
	MOVIA	0x03
	IOST	_IOSTA
	.line	520, "main.c"; 	IOSTB = C_PB0_Input | C_PB1_Input;		//PB输出模式
	IOST	_IOSTB
	.line	521, "main.c"; 	PORTB = 0xFF;                           // PB0、PB1 & PB2 are output High
	MOVIA	0xff
	MOVAR	_PORTB
	.line	522, "main.c"; 	PORTA = 0xFF;						
	MOVAR	_PORTA
	.line	523, "main.c"; 	ABPLCON = 0xDF;							//PB1开启下拉
	MOVIA	0xdf
	MOVAR	_ABPLCON
	.line	524, "main.c"; 	APHCON  = 0xFE;							//PA0开启上拉
	MOVIA	0xfe
	IOST	_APHCON
	.line	525, "main.c"; 	BPHCON  = 0x02;							//PB1关闭下拉,PB0打开上拉
	MOVIA	0x02
	MOVAR	_BPHCON
	.line	526, "main.c"; 	DISI();
	DISI
	.line	528, "main.c"; 	PCON1 = C_TMR0_Dis;						// Disable Timer0
	CLRA	
	IOST	_PCON1
	.line	536, "main.c"; 	TMRH = 0x00;
	CLRR	_TMRH
	.line	537, "main.c"; 	TMR1 = 0x17;							// Load 0xFF to TMR1 (Initial Timer1 register)
	MOVIA	0x17
	SFUN	_TMR1
	.line	539, "main.c"; 	T1CR1 = C_TMR1_Reload | C_TMR1_En;      // Enable Timer1, Initial value reloaded from TMR1, Non-stop mode 
	MOVIA	0x03
	SFUN	_T1CR1
	.line	540, "main.c"; 	T1CR2 = C_TMR1_ClkSrc_Inst | C_PS1_Div16;	// Enable Prescaler1, Prescaler1 dividing rate = 1:4, Timer1 clock source is instruction clock
	SFUN	_T1CR2
	.line	543, "main.c"; 	INTE = C_INT_WDT | C_INT_TMR1;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x48
	MOVAR	_INTE
	.line	544, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	546, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En;				// Enable WDT ,  Enable LVR
	MOVIA	0xa8
	MOVAR	_PCON
	.line	549, "main.c"; 	PCON1 = 0x08;
	MOVIA	0x08
	IOST	_PCON1
	.line	550, "main.c"; 	ENI();									// Enable all unmasked interrupts										// Enable all unmasked interrupts	
	ENI
	.line	552, "main.c"; 	}
	RETURN	
...
_Level3Change:
; 2 exit points
	.line	420, "main.c"; 	threeStep++;
	BANKSEL	_threeStep
	INCR	_threeStep,F
;;unsigned compare: left < lit (0xC=12), size=1
	.line	421, "main.c"; 	if(threeStep >= 12)
	MOVIA	0x0c
	SUBAR	_threeStep,W
	BTRSS	STATUS,0
	LGOTO	_00247_DS_
	.line	423, "main.c"; 	threeStep = 0;
	CLRR	_threeStep
	.line	424, "main.c"; 	threeChangeFlag = ~threeChangeFlag;
...
;;unsigned compare: left >= lit (0xC=12), size=1
_00247_DS_:
	.line	427, "main.c"; 	switch(threeStep)
	MOVIA	0x0c
	BANKSEL	_threeStep
	SUBAR	_threeStep,W
	BTRSC	STATUS,0
...
_00289_DS_:
	...
	LGOTO	_00259_DS_
_00248_DS_:
	.line	430, "main.c"; 	pwmLmax = 2;
	MOVIA	0x02
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	431, "main.c"; 	pwm2Lmax = 4;
	MOVIA	0x04
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	432, "main.c"; 	pwmwaitTime = 12;
	MOVIA	0x0c
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	...
	LGOTO	_00260_DS_
_00249_DS_:
	.line	435, "main.c"; 	pwmLmax = 2;
	MOVIA	0x02
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	436, "main.c"; 	pwm2Lmax = 4;
	MOVIA	0x04
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	437, "main.c"; 	pwmwaitTime = 10;
	MOVIA	0x0a
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	...
	LGOTO	_00260_DS_
_00251_DS_:
	.line	441, "main.c"; 	pwmLmax = 6;
	MOVIA	0x06
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	442, "main.c"; 	pwm2Lmax = 8;
	MOVIA	0x08
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	443, "main.c"; 	pwmwaitTime = 8;
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	.line	444, "main.c"; 	break;
	LGOTO	_00260_DS_
_00253_DS_:
	.line	447, "main.c"; 	pwmLmax = 10;
	MOVIA	0x0a
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	448, "main.c"; 	pwm2Lmax = 8;
	MOVIA	0x08
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	449, "main.c"; 	pwmwaitTime = 8;
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	.line	450, "main.c"; 	break;
	LGOTO	_00260_DS_
_00254_DS_:
	.line	453, "main.c"; 	pwmLmax = 14;
	MOVIA	0x0e
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	454, "main.c"; 	pwm2Lmax = 18;
	MOVIA	0x12
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	455, "main.c"; 	pwmwaitTime = 4;
	MOVIA	0x04
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	...
	LGOTO	_00260_DS_
_00255_DS_:
	.line	458, "main.c"; 	pwmLmax = 14;
	MOVIA	0x0e
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	459, "main.c"; 	pwm2Lmax = 18;
	MOVIA	0x12
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	460, "main.c"; 	pwmwaitTime = 7;
	MOVIA	0x07
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	...
	LGOTO	_00260_DS_
_00256_DS_:
	.line	463, "main.c"; 	pwmLmax = 15;
	MOVIA	0x0f
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	464, "main.c"; 	pwm2Lmax = 12;
	MOVIA	0x0c
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	465, "main.c"; 	pwmwaitTime = 10;
	MOVIA	0x0a
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	...
	LGOTO	_00260_DS_
_00257_DS_:
	.line	468, "main.c"; 	pwmLmax = 15;
	MOVIA	0x0f
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	469, "main.c"; 	pwm2Lmax = 12;
	MOVIA	0x0c
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	470, "main.c"; 	pwmwaitTime = 14;
	MOVIA	0x0e
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	...
	LGOTO	_00260_DS_
_00258_DS_:
	.line	473, "main.c"; 	pwmLmax = 9;
	MOVIA	0x09
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	474, "main.c"; 	pwm2Lmax = 2;
	MOVIA	0x02
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	475, "main.c"; 	pwmwaitTime = 42;
	MOVIA	0x2a
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
	...
	LGOTO	_00260_DS_
_00259_DS_:
	.line	478, "main.c"; 	pwmLmax = 9;
	MOVIA	0x09
	BANKSEL	_pwmLmax
	MOVAR	_pwmLmax
	.line	479, "main.c"; 	pwm2Lmax = 2;
	MOVIA	0x02
	BANKSEL	_pwm2Lmax
	MOVAR	_pwm2Lmax
	.line	480, "main.c"; 	pwmwaitTime = 14;
	MOVIA	0x0e
	BANKSEL	_pwmwaitTime
	MOVAR	_pwmwaitTime
_00260_DS_:
	.line	488, "main.c"; 	if(pwmStep)
	BANKSEL	_pwmStep
	MOVR	_pwmStep,W
	BTRSC	STATUS,2
	LGOTO	_00268_DS_
	.line	490, "main.c"; 	if(threeChangeFlag)
	BANKSEL	_threeChangeFlag
	MOVR	_threeChangeFlag,W
	BTRSC	STATUS,2
	LGOTO	_00262_DS_
	.line	492, "main.c"; 	pwm1L = pwm2Lmax;
	BANKSEL	_pwm2Lmax
	MOVR	_pwm2Lmax,W
	BANKSEL	_pwm1L
	MOVAR	_pwm1L
	LGOTO	_00263_DS_
_00262_DS_:
	.line	496, "main.c"; 	pwm1L = pwmLmax;
	BANKSEL	_pwmLmax
	MOVR	_pwmLmax,W
	BANKSEL	_pwm1L
	MOVAR	_pwm1L
_00263_DS_:
	.line	498, "main.c"; 	pwmStep = 0;
	BANKSEL	_pwmStep
	CLRR	_pwmStep
	LGOTO	_00270_DS_
_00268_DS_:
	.line	502, "main.c"; 	if(threeChangeFlag)
	BANKSEL	_threeChangeFlag
	MOVR	_threeChangeFlag,W
	BTRSC	STATUS,2
	LGOTO	_00265_DS_
	.line	504, "main.c"; 	pwm2L = pwm2Lmax;
	BANKSEL	_pwm2Lmax
	MOVR	_pwm2Lmax,W
	BANKSEL	_pwm2L
	MOVAR	_pwm2L
	LGOTO	_00266_DS_
_00265_DS_:
	.line	508, "main.c"; 	pwm2L = pwmLmax;
	BANKSEL	_pwmLmax
	MOVR	_pwmLmax,W
	BANKSEL	_pwm2L
	MOVAR	_pwm2L
_00266_DS_:
	.line	510, "main.c"; 	pwmStep = 1;
	MOVIA	0x01
	BANKSEL	_pwmStep
	MOVAR	_pwmStep
_00270_DS_:
...
_00239_DS_:
	...
	LGOTO	_00241_DS_
_00236_DS_:
	.line	384, "main.c"; 	PORTA &= 0xE7;
	MOVIA	0xe7
	ANDAR	_PORTA,F
	.line	385, "main.c"; 	pwmwait++;
	BANKSEL	_pwmwait
	INCR	_pwmwait,F
	.line	386, "main.c"; 	if(pwmwait == pwmwaitTime)
	BANKSEL	_pwmwaitTime
	MOVR	_pwmwaitTime,W
	BANKSEL	_pwmwait
	XORAR	_pwmwait,W
	BTRSS	STATUS,2
	LGOTO	_00241_DS_
	.line	388, "main.c"; 	if(workStep == 3)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x03
	BTRSS	STATUS,2
	LGOTO	_00231_DS_
	.line	390, "main.c"; 	Level3Change();
	LCALL	_Level3Change
	LGOTO	_00241_DS_
_00231_DS_:
	.line	395, "main.c"; 	if(pwmStep)
	BANKSEL	_pwmStep
	MOVR	_pwmStep,W
	BTRSC	STATUS,2
	LGOTO	_00228_DS_
	.line	397, "main.c"; 	pwm1L = pwmLmax;
	BANKSEL	_pwmLmax
	MOVR	_pwmLmax,W
	BANKSEL	_pwm1L
	MOVAR	_pwm1L
	.line	398, "main.c"; 	pwmStep = 0;
	BANKSEL	_pwmStep
	CLRR	_pwmStep
	LGOTO	_00241_DS_
_00228_DS_:
	.line	402, "main.c"; 	pwm2L = pwm2Lmax;
	BANKSEL	_pwm2Lmax
	MOVR	_pwm2Lmax,W
	BANKSEL	_pwm2L
	MOVAR	_pwm2L
	.line	403, "main.c"; 	pwmStep = 1;
	MOVIA	0x01
	BANKSEL	_pwmStep
	MOVAR	_pwmStep
_00241_DS_:
...
;	  743+  191 =   934 instructions ( 2250 byte)
