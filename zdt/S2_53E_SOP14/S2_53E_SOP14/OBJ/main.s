...
_delay:
; 2 exit points
	.line	275, "main.c"; 	void delay(u8t time)
	BANKSEL	r0x100F
	MOVAR	r0x100F
	.line	277, "main.c"; 	for(u8t i=0;i<time;i++)
	BANKSEL	r0x1010
	CLRR	r0x1010
_00256_DS_:
	BANKSEL	r0x100F
...
_initSys:
; 2 exit points
	.line	254, "main.c"; 	PORTA = 0x00;
	BANKSEL	_PORTA
	CLRR	_PORTA
	.line	255, "main.c"; 	PORTB = 0x00;
	CLRR	_PORTB
	.line	256, "main.c"; 	BPHCON = 0x7F;		//PA0上拉
	MOVIA	0x7f
	MOVAR	_BPHCON
	.line	258, "main.c"; 	IOSTA =  0x00;					//PA0输入
	CLRA	
	IOST	_IOSTA
	.line	259, "main.c"; 	IOSTB = C_PB7_Input;
	MOVIA	0x80
	IOST	_IOSTB
	.line	260, "main.c"; 	PORTA = 0x00;
	CLRR	_PORTA
	.line	261, "main.c"; 	PORTB = 0x00;                       	
	CLRR	_PORTB
	.line	262, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En;				// Enable WDT & LVR
	MOVIA	0xa8
	MOVAR	_PCON
	.line	264, "main.c"; 	PCON1 = C_TMR0_Dis;
	CLRA	
	IOST	_PCON1
	.line	266, "main.c"; 	TMR0 = 55;
	MOVIA	0x37
	MOVAR	_TMR0
	.line	267, "main.c"; 	T0MD =  C_PS0_TMR0 | C_PS0_Div2;
	CLRA	
	T0MD	
	.line	268, "main.c"; 	INTE =  C_INT_TMR0;
	MOVIA	0x01
	MOVAR	_INTE
	.line	269, "main.c"; 	PCON1 = C_TMR0_En;
	IOST	_PCON1
	.line	270, "main.c"; 	P2CR1 = 0x00;
	CLRA	
	SFUN	_P2CR1
	.line	271, "main.c"; 	ENI();
	ENI
...
_gotoSleep:
; 2 exit points
	.line	232, "main.c"; 	pwmStop();
	MCALL	_pwmStop
	.line	233, "main.c"; 	count900s = 0;
	BANKSEL	_count900s
	CLRR	_count900s
	CLRR	(_count900s + 1)
	.line	234, "main.c"; 	sleepDelay = 0;
	BANKSEL	_sleepDelay
	CLRR	_sleepDelay
	.line	235, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	236, "main.c"; 	PORTA = 0x00;
	BANKSEL	_PORTA
	CLRR	_PORTA
	.line	237, "main.c"; 	PORTB = 0x00;
	CLRR	_PORTB
	.line	238, "main.c"; 	BWUCON = 0x80;
	MOVIA	0x80
	MOVAR	_BWUCON
	.line	239, "main.c"; 	INTE =  C_INT_PBKey;
	MOVIA	0x02
	MOVAR	_INTE
	.line	240, "main.c"; 	PCON =  C_LVR_En;	
	MOVIA	0x08
	MOVAR	_PCON
	.line	241, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	242, "main.c"; 	CLRWDT();
	clrwdt
	.line	243, "main.c"; 	SLEEP();
	sleep
	.line	244, "main.c"; 	INTE =  C_INT_TMR0;	// Enable Timer0、Timer1、WDT overflow interrupt
	MOVIA	0x01
	MOVAR	_INTE
	.line	245, "main.c"; 	INTF = 0;
	CLRR	_INTF
	.line	247, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En;				// Enable WDT ,  Enable LVR
	MOVIA	0xa8
	MOVAR	_PCON
	.line	248, "main.c"; 	}
	RETURN	
...
_00231_DS_:
	...
	BTRSS	STATUS,2
	MGOTO	_00233_DS_
	.line	217, "main.c"; 	duty = 90;
	MOVIA	0x5a
	BANKSEL	_duty
	MOVAR	_duty
	.line	218, "main.c"; 	PWM2DUTY = 90;
	SFUN	_PWM2DUTY
_00233_DS_:
	...
	BTRSC	STATUS,2
	MGOTO	_00001_DS_
	.line	221, "main.c"; 	pwmInit();
	MCALL	_pwmInit
	MGOTO	_00001_DS_
_00239_DS_:
	.line	223, "main.c"; 	else if(kclick == 2)
	BANKSEL	r0x1012
	MOVR	r0x1012,W
	XORIA	0x02
	BTRSS	STATUS,2
...
;	  302+   50 =   352 instructions (  804 byte)
