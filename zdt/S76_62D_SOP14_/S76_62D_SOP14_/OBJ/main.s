...
_00175_DS_:
	...
	MCALL	_ledShow
	.line	182, "main.c"; 	if(workStep > 0 && tempDuty >= 20)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSC	STATUS,2
	MGOTO	_00139_DS_
;;unsigned compare: left < lit (0x14=20), size=1
	...
	BANKSEL	_cDuty
	DECR	_cDuty,F
	.line	187, "main.c"; 	PWM1DUTY = cDuty;
	MOVR	_cDuty,W
	SFUN	_PWM1DUTY
	MGOTO	_00139_DS_
_00136_DS_:
	...
	INCR	_cDuty,F
	.line	192, "main.c"; 	PWM1DUTY = cDuty;
	MOVR	_cDuty,W
	SFUN	_PWM1DUTY
_00139_DS_:
	...
	BANKSEL	_currentDuty
	DECR	_currentDuty,F
	.line	198, "main.c"; 	PWM1DUTY = currentDuty;
	MOVR	_currentDuty,W
	SFUN	_PWM1DUTY
...
_00160_DS_:
	...
	MCALL	_chrgCtr
	.line	244, "main.c"; 	if(workStep == 0 && keyCount == 0 && (PORTA & 0x20) == 0 && ledLightTime == 0 && ledDeadTime == 0 && shanshuoTime == 0)
	BANKSEL	_workStep
	MOVR	_workStep,W
	BTRSS	STATUS,2
	MGOTO	_00166_DS_
...
; 2 exit points
	...
	CLRR	_R_AIN2_DATA
	CLRR	(_R_AIN2_DATA + 1)
	.line	926, "main.c"; 	ADMD  = 0x90 | C_ADC_PA4;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x94
	MOVAR	_ADMD
...
; 2 exit points
	...
	CLRR	_R_AIN4_DATA
	CLRR	(_R_AIN4_DATA + 1)
	.line	911, "main.c"; 	ADMD  = 0x90 | C_ADC_PA0;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x90
	MOVAR	_ADMD
...
;;shiftRight_Left2ResultLit:5590: shCount=1, size=2, sign=0, same=1, offr=0
	...
	RRR	(_R_AIN4_DATA + 1),F
	RRR	_R_AIN4_DATA,F
	.line	817, "main.c"; 	tempSum += R_AIN4_DATA;
	MOVR	_R_AIN4_DATA,W
	BANKSEL	_tempSum
	ADDAR	_tempSum,F
	BANKSEL	_R_AIN4_DATA
...
;;unsigned compare: left < lit (0x3=3), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00691_DS_
	.line	820, "main.c"; 	count100 = 0;
	CLRR	_count100
	.line	821, "main.c"; 	tempResult = tempSum/3;
	MOVIA	0x03
	MOVAR	STK02
	MOVIA	0x00
	MOVAR	STK01
	...
	MOVR	STK00,W
	MOVAR	_tempResult
	.line	822, "main.c"; 	tempSum = 0;
	BANKSEL	_tempSum
	CLRR	_tempSum
	CLRR	(_tempSum + 1)
;;unsigned compare: left < lit (0x6=6), size=1
_00691_DS_:
	.line	825, "main.c"; 	if(workStep < 6 && tempResult > 200)
	MOVIA	0x06
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
_00791_DS_:
	BTRSS	STATUS,0
	MGOTO	_00728_DS_
	.line	827, "main.c"; 	if(++overCount > 5)
	BANKSEL	_overCount
	INCR	_overCount,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x6=6), size=1
...
_00728_DS_:
	.line	832, "main.c"; 	else if(tempResult > 400)
	MOVIA	0x01
	BANKSEL	_tempResult
	SUBAR	(_tempResult + 1),W
	BTRSS	STATUS,2
...
_00793_DS_:
	BTRSS	STATUS,0
	MGOTO	_00725_DS_
	.line	834, "main.c"; 	if(++overCount > 5)
	BANKSEL	_overCount
	INCR	_overCount,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x6=6), size=1
...
_00725_DS_:
	.line	844, "main.c"; 	else if(tempResult > 88)
	MOVIA	0x00
	BANKSEL	_tempResult
	SUBAR	(_tempResult + 1),W
	BTRSS	STATUS,2
...
_00795_DS_:
	BTRSS	STATUS,0
	MGOTO	_00722_DS_
	.line	846, "main.c"; 	if(overCount > 0)
	BANKSEL	_overCount
	MOVR	_overCount,W
	BTRSS	STATUS,2
	.line	848, "main.c"; 	overCount--;
	DECR	_overCount,F
	.line	851, "main.c"; 	tempDuty = 70 + workStep*5;
	MOVIA	0x05
	MOVAR	STK00
	BANKSEL	_workStep
	MOVR	_workStep,W
	...
	MGOTO	_00729_DS_
_00722_DS_:
	.line	856, "main.c"; 	u8t maxAout = 75;
	MOVIA	0x4b
	BANKSEL	r0x1048
	MOVAR	r0x1048
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x4=4), size=1
	.line	857, "main.c"; 	if(pwStep > 3)
	MOVIA	0x04
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSS	STATUS,0
	MGOTO	_00699_DS_
	.line	858, "main.c"; 	maxAout = 80;
	MOVIA	0x50
	BANKSEL	r0x1048
	MOVAR	r0x1048
_00699_DS_:
	.line	859, "main.c"; 	if(workStep == 1)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00712_DS_
	.line	861, "main.c"; 	maxAout = maxAout - 15;
	MOVIA	0xf1
	BANKSEL	r0x1048
	ADDAR	r0x1048,F
	MGOTO	_00713_DS_
_00712_DS_:
	.line	863, "main.c"; 	else if(workStep == 2)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x02
	BTRSS	STATUS,2
	MGOTO	_00709_DS_
	.line	865, "main.c"; 	maxAout = maxAout - 11;
	MOVIA	0xf5
	BANKSEL	r0x1048
	ADDAR	r0x1048,F
	MGOTO	_00713_DS_
...
_00713_DS_:
	...
	DECR	_overCount,F
	.line	883, "main.c"; 	if(tempResult > maxAout)
	BANKSEL	r0x1048
	MOVR	r0x1048,W
	BANKSEL	r0x1049
	MOVAR	r0x1049
...
_00719_DS_:
	.line	888, "main.c"; 	else if(tempResult < 100)
	MOVIA	0x00
	BANKSEL	_tempResult
	SUBAR	(_tempResult + 1),W
	BTRSS	STATUS,2
...
_chrgCtr:
; 2 exit points
	.line	612, "main.c"; 	if(PORTA & 0x20)
	BANKSEL	_PORTA
	BTRSS	_PORTA,5
	MGOTO	_00507_DS_
	.line	615, "main.c"; 	chrgFlag = 1;
	BANKSEL	_Status
	BSR	_Status,3
	.line	616, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	617, "main.c"; 	ledLightTime = 0;
	BANKSEL	_ledLightTime
	CLRR	_ledLightTime
	.line	618, "main.c"; 	pwmStop();
	MCALL	_pwmStop
;;unsigned compare: left < lit (0x8=8), size=1
	.line	620, "main.c"; 	if(pwStep >= 8 || chrgFullFlag)
	MOVIA	0x08
	BANKSEL	_pwStep
	SUBAR	_pwStep,W
	BTRSC	STATUS,0
	...
	MGOTO	_00501_DS_
_00500_DS_:
	.line	622, "main.c"; 	chrgStep = 6;
	MOVIA	0x06
	BANKSEL	_chrgStep
	MOVAR	_chrgStep
	.line	624, "main.c"; 	ledStep = 6;
	BANKSEL	_ledStep
	MOVAR	_ledStep
	.line	625, "main.c"; 	if(++fullCount >= 2000)
	BANKSEL	_fullCount
	INCR	_fullCount,F
	BTRSC	STATUS,2
	INCR	(_fullCount + 1),F
...
_00572_DS_:
	BTRSS	STATUS,0
	MGOTO	_00509_DS_
	.line	627, "main.c"; 	fullCount = 2000;
	MOVIA	0xd0
	BANKSEL	_fullCount
	MOVAR	_fullCount
	MOVIA	0x07
	MOVAR	(_fullCount + 1)
	.line	628, "main.c"; 	chrgFullFlag = 1;
	MOVIA	0x01
	BANKSEL	_chrgFullFlag
	MOVAR	_chrgFullFlag
	.line	629, "main.c"; 	pwm1Stop();
	MCALL	_pwm1Stop
	.line	630, "main.c"; 	PORTB &= 0xF7;
	BCR	_PORTB,3
	.line	631, "main.c"; 	IOSTB |= 0X08;
	IOSTR	_IOSTB
	BANKSEL	r0x1051
	MOVAR	r0x1051
	BSR	r0x1051,3
...
_00501_DS_:
	...
	MOVR	r0x1051,W
	IOST	_IOSTB
	.line	640, "main.c"; 	fullCount = 0;
	BANKSEL	_fullCount
	CLRR	_fullCount
	CLRR	(_fullCount + 1)
	.line	641, "main.c"; 	if(count500ms == 0 && pwStep <= 7 && lockLedStep < 6)
	BANKSEL	_count500ms
	MOVR	_count500ms,W
	BTRSS	STATUS,2
	MGOTO	_00478_DS_
...
;;unsigned compare: left < lit (0x6=6), size=1
	...
	BTRSC	STATUS,0
	MGOTO	_00478_DS_
	.line	644, "main.c"; 	if(lockLedStep < pwStep - 1)
	BANKSEL	_pwStep
	MOVR	_pwStep,W
	BANKSEL	r0x1051
	MOVAR	r0x1051
...
_00575_DS_:
	BTRSC	STATUS,0
	MGOTO	_00473_DS_
	.line	646, "main.c"; 	if(lockLedStep == 0)
	BANKSEL	_lockLedStep
	MOVR	_lockLedStep,W
	BTRSS	STATUS,2
	MGOTO	_00469_DS_
	.line	647, "main.c"; 	lockLedStep = pwStep - 1;
	BANKSEL	_pwStep
	DECR	_pwStep,W
	BANKSEL	_lockLedStep
	MOVAR	_lockLedStep
_00469_DS_:
	.line	648, "main.c"; 	if(++ledCount > 100)
	BANKSEL	_ledCount
	INCR	_ledCount,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x65=101), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00474_DS_
	.line	649, "main.c"; 	lockLedStep = pwStep - 1;
	BANKSEL	_pwStep
	DECR	_pwStep,W
	BANKSEL	_lockLedStep
	MOVAR	_lockLedStep
	MGOTO	_00474_DS_
_00473_DS_:
	.line	654, "main.c"; 	ledCount = 0;
	BANKSEL	_ledCount
	CLRR	_ledCount
_00474_DS_:
	.line	656, "main.c"; 	if(++ledStep > 6)
	BANKSEL	_ledStep
	INCR	_ledStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x7=7), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00478_DS_
	.line	657, "main.c"; 	ledStep = lockLedStep;
	BANKSEL	_lockLedStep
	MOVR	_lockLedStep,W
	BANKSEL	_ledStep
	MOVAR	_ledStep
;;unsigned compare: left < lit (0x6=6), size=1
_00478_DS_:
	.line	659, "main.c"; 	if(lockLedStep >= 6)
	MOVIA	0x06
	BANKSEL	_lockLedStep
	SUBAR	_lockLedStep,W
	BTRSS	STATUS,0
	MGOTO	_00482_DS_
	.line	661, "main.c"; 	ledStep = 6;	//亮灯不闪了
	MOVIA	0x06
	BANKSEL	_ledStep
	MOVAR	_ledStep
_00482_DS_:
	.line	663, "main.c"; 	PWM2DUTY = maxduty;
	BANKSEL	_maxduty
	MOVR	_maxduty,W
	SFUN	_PWM2DUTY
	.line	664, "main.c"; 	pwm1Init();
	MCALL	_pwm1Init
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x6=6), size=1
	.line	665, "main.c"; 	if(count200ms > 5)
	MOVIA	0x06
	BANKSEL	_count200ms
	SUBAR	_count200ms,W
	BTRSS	STATUS,0
...
;;unsigned compare: left >= lit (0x24=36), size=2
	.line	667, "main.c"; 	if(R_AIN4_DATA <= 35 && R_AIN4_DATA >=subMin)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
...
_00581_DS_:
	BTRSS	STATUS,0
	MGOTO	_00484_DS_
	.line	669, "main.c"; 	addTime = subTime = 0;
	BANKSEL	_subTime
	CLRR	_subTime
	BANKSEL	_addTime
	CLRR	_addTime
...
;;unsigned compare: left >= lit (0x24=36), size=2
_00484_DS_:
	.line	671, "main.c"; 	if(R_AIN4_DATA > 35)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
_00582_DS_:
	BTRSS	STATUS,0
	MGOTO	_00493_DS_
	.line	673, "main.c"; 	if(++subTime > chrgWaitTime)
	BANKSEL	_subTime
	INCR	_subTime,F
	MOVR	_subTime,W
	...
	BANKSEL	_maxduty
	DECR	_maxduty,F
	.line	676, "main.c"; 	subTime = 0;
	BANKSEL	_subTime
	CLRR	_subTime
	.line	677, "main.c"; 	subMin = 34;
	MOVIA	0x22
	BANKSEL	_subMin
	MOVAR	_subMin
	.line	678, "main.c"; 	chrgWaitTime = 250;
	MOVIA	0xfa
	BANKSEL	_chrgWaitTime
	MOVAR	_chrgWaitTime
_00487_DS_:
	.line	680, "main.c"; 	addTime = 0;
	BANKSEL	_addTime
	CLRR	_addTime
	MGOTO	_00494_DS_
_00493_DS_:
	.line	682, "main.c"; 	else if(R_AIN4_DATA < subMin)
	BANKSEL	_subMin
	MOVR	_subMin,W
	BANKSEL	r0x1051
	MOVAR	r0x1051
...
_00584_DS_:
	BTRSC	STATUS,0
	MGOTO	_00494_DS_
	.line	684, "main.c"; 	if(++addTime > chrgWaitTime)
	BANKSEL	_addTime
	INCR	_addTime,F
	MOVR	_addTime,W
	BANKSEL	_chrgWaitTime
	...
	BTRSC	STATUS,0
	MGOTO	_00489_DS_
	.line	686, "main.c"; 	maxduty = maxduty + 1;
	BANKSEL	_maxduty
	INCR	_maxduty,F
	.line	687, "main.c"; 	addTime = 0;
	BANKSEL	_addTime
	CLRR	_addTime
_00489_DS_:
	.line	689, "main.c"; 	subTime = 0;
	BANKSEL	_subTime
	CLRR	_subTime
_00494_DS_:
	.line	691, "main.c"; 	if(chrgduty < maxduty)
	BANKSEL	_maxduty
	MOVR	_maxduty,W
	BANKSEL	_chrgduty
	SUBAR	_chrgduty,W
	BTRSC	STATUS,0
	MGOTO	_00496_DS_
	.line	692, "main.c"; 	chrgduty++;
	INCR	_chrgduty,F
	MGOTO	_00509_DS_
_00496_DS_:
	.line	694, "main.c"; 	chrgduty = maxduty;
	BANKSEL	_maxduty
	MOVR	_maxduty,W
	BANKSEL	_chrgduty
	MOVAR	_chrgduty
	MGOTO	_00509_DS_
_00507_DS_:
	.line	703, "main.c"; 	chrgWaitTime = 20;
	MOVIA	0x14
	BANKSEL	_chrgWaitTime
	MOVAR	_chrgWaitTime
	.line	704, "main.c"; 	subMin = 33;
	MOVIA	0x21
	BANKSEL	_subMin
	MOVAR	_subMin
...
_keyRead:
; 2 exit points
	.line	575, "main.c"; 	char keyRead(char keyStatus)	
	BANKSEL	r0x1056
	MOVAR	r0x1056
	.line	577, "main.c"; 	if(keyStatus)
	MOVR	r0x1056,W
	BTRSC	STATUS,2
	MGOTO	_00459_DS_
	.line	579, "main.c"; 	keyCount++;
	BANKSEL	_keyCount
	INCR	_keyCount,F
;;unsigned compare: left < lit (0x64=100), size=1
	...
	BTRSS	STATUS,0
	MGOTO	_00460_DS_
	.line	582, "main.c"; 	keyCount = 100;
	MOVIA	0x64
	MOVAR	_keyCount
	.line	583, "main.c"; 	if(!longPressFlag)
	BANKSEL	_Status
	BTRSC	_Status,1
	MGOTO	_00460_DS_
	.line	585, "main.c"; 	longPressFlag = 1;
	BSR	_Status,1
	.line	586, "main.c"; 	return 2;
	MOVIA	0x02
	MGOTO	_00461_DS_
;;unsigned compare: left < lit (0x64=100), size=1
_00459_DS_:
	.line	592, "main.c"; 	if(keyCount >= 100)
	MOVIA	0x64
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
	...
	CLRR	_keyCount
	.line	595, "main.c"; 	longPressFlag = 0;
	BANKSEL	_Status
	BCR	_Status,1
...
;;unsigned compare: left < lit (0x4=4), size=1
_00456_DS_:
	.line	598, "main.c"; 	else if(keyCount >= 4)
	MOVIA	0x04
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
...
_gotoSleep:
; 2 exit points
	.line	542, "main.c"; 	LedInput();
	MCALL	_LedInput
	.line	543, "main.c"; 	sleepTime = 0;
	BANKSEL	_sleepTime
	CLRR	_sleepTime
	CLRR	(_sleepTime + 1)
	.line	545, "main.c"; 	pwmStop();
	MCALL	_pwmStop
	.line	546, "main.c"; 	pwm1Stop();
	MCALL	_pwm1Stop
	.line	547, "main.c"; 	PORTA = 0x00;
	BANKSEL	_PORTA
	CLRR	_PORTA
	.line	548, "main.c"; 	PORTB = 0x00;
	CLRR	_PORTB
	.line	549, "main.c"; 	workStep = 0;
	BANKSEL	_workStep
	CLRR	_workStep
	.line	550, "main.c"; 	AWUCON = 0x60;
	MOVIA	0x60
	MOVAR	_AWUCON
	.line	551, "main.c"; 	BWUCON = 0x00;
	CLRR	_BWUCON
	.line	552, "main.c"; 	redLedFlag = 0;
	BANKSEL	_Status
	BCR	_Status,2
	.line	555, "main.c"; 	INTE =  C_INT_PABKey;
	MOVIA	0x02
	MOVAR	_INTE
	.line	556, "main.c"; 	PCON =  C_LVR_En | 0x10;	
	MOVIA	0x18
	MOVAR	_PCON
	.line	557, "main.c"; 	INTF = 0;								// Clear all interrupt flags
	CLRR	_INTF
	.line	558, "main.c"; 	CLRWDT();
	clrwdt
	.line	559, "main.c"; 	ENI();
	ENI
	.line	560, "main.c"; 	SLEEP();
	sleep
	.line	561, "main.c"; 	AWUCON = 0x00;
	CLRR	_AWUCON
	.line	562, "main.c"; 	IOSTA = C_PA6_Input | C_PA5_Input | C_PA4_Input | C_PA3_Input | C_PA2_Input | C_PA0_Input;
	MOVIA	0x7d
	IOST	_IOSTA
	.line	563, "main.c"; 	IOSTB = 0x00;
	CLRA	
	IOST	_IOSTB
	.line	564, "main.c"; 	PORTA = 0x00;
	BANKSEL	_PORTA
	CLRR	_PORTA
	.line	565, "main.c"; 	APHCON = 0x3F;
	MOVIA	0x3f
	IOST	_APHCON
	...
	CLRR	_INTF
	.line	569, "main.c"; 	PCON = C_WDT_En | C_LVR_En | C_LVD_En | 0x10;				// Enable WDT ,  Enable LVR
	MOVIA	0xb8
	MOVAR	_PCON
	.line	572, "main.c"; 	}
	RETURN	
...
_pwmStop:
; 2 exit points
	.line	534, "main.c"; 	T1CR1 = C_TMR1_Dis;
	CLRA	
	SFUN	_T1CR1
	.line	535, "main.c"; 	}
	RETURN	
...
; 2 exit points
	...
	CLRR	_TMRH
	.line	525, "main.c"; 	TMR1 = 100;							//频率为110K
	MOVIA	0x64
	SFUN	_TMR1
	.line	528, "main.c"; 	T1CR2 = C_TMR1_ClkSrc_Inst | C_PS1_Div4;	// Enable Prescaler1, Prescaler1 dividing rate = 1:2, Timer1 clock source is instruction clock 
	MOVIA	0x01
	SFUN	_T1CR2
	.line	529, "main.c"; 	T1CR1 = C_PWM1_En | C_TMR1_Reload | C_TMR1_En;	// PWM1 output will be present on PB6 , PWM1 output is active high, reloaded from TMR1, non-stop mode
	MOVIA	0x83
	SFUN	_T1CR1
_00436_DS_:
	.line	530, "main.c"; 	}
...
_pwm1Stop:
; 2 exit points
	.line	515, "main.c"; 	T2CR1 = C_TMR2_Dis;
	CLRA	
	SFUN	_T2CR1
	.line	516, "main.c"; 	}
	RETURN	
...
; 2 exit points
	...
	CLRR	_TMRH
	.line	505, "main.c"; 	TMR1 = 48;							//频率为110K
	MOVIA	0x30
	SFUN	_TMR1
	.line	508, "main.c"; 	T2CR2 = C_TMR2_ClkSrc_Inst | C_PS2_Div2;	// Enable Prescaler1, Prescaler1 dividing rate = 1:2, Timer1 clock source is instruction clock 
	CLRA	
	SFUN	_T2CR2
	.line	509, "main.c"; 	T2CR2 = C_TMR2_ClkSrc_Inst | C_PS2_Dis;
	MOVIA	0x08
	SFUN	_T2CR2
	.line	510, "main.c"; 	T2CR1 = C_PWM2_En | C_TMR2_Reload | C_TMR2_En;	// PWM1 output will be present on PB6 , PWM1 output is active high, reloaded from TMR1, non-stop mode
	MOVIA	0x83
	SFUN	_T2CR1
_00425_DS_:
	.line	511, "main.c"; 	}
...
; 2 exit points
	...
	MOVR	r0x1057,W
	IOST	_IOSTB
	.line	434, "main.c"; 	PORTB &= 0xFC;
	MOVIA	0xfc
	ANDAR	_PORTB,F
	.line	435, "main.c"; 	PORTA &= 0x7F;
	BANKSEL	_PORTA
	BCR	_PORTA,7
	.line	436, "main.c"; 	}
	RETURN	
...
; 2 exit points
	...
	DISI
	.line	343, "main.c"; 	IOSTA = C_PA6_Input | C_PA5_Input | C_PA4_Input | C_PA3_Input | C_PA2_Input | C_PA0_Input;
	MOVIA	0x7d
	IOST	_IOSTA
...
_keyCtr:
; 2 exit points
	.line	263, "main.c"; 	char kclick = keyRead(0x40 & (~PORTA));
	BANKSEL	_PORTA
	COMR	_PORTA,W
	BANKSEL	r0x105F
	MOVAR	r0x105F
...
_00290_DS_:
	...
	BTRSC	STATUS,2
	MGOTO	_00292_DS_
	.line	297, "main.c"; 	PWM1DUTY = maxDuty;
	BANKSEL	_maxDuty
	MOVR	_maxDuty,W
	SFUN	_PWM1DUTY
...
_00294_DS_:
	...
	BANKSEL	_workStep
	MOVAR	_workStep
	.line	318, "main.c"; 	PWM1DUTY = 70;
	MOVIA	0x46
	SFUN	_PWM1DUTY
	.line	319, "main.c"; 	currentDuty = 70;
	BANKSEL	_currentDuty
	MOVAR	_currentDuty
	.line	320, "main.c"; 	maxDuty = 30;
	MOVIA	0x1e
	BANKSEL	_maxDuty
	MOVAR	_maxDuty
...
;	 1324+  373 =  1697 instructions ( 4140 byte)
