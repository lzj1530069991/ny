...
{	
       ...
       tempBatValue = R_AIN2_DATA;
        ...
        if(R_AIN2_DATA >= 1560 || chrgFullFlag)
	    {
	    	R_AIN2_DATA = 1560;		//4.2V 100%
	    	 if(preBatValue < R_AIN2_DATA)
	        {
	        	preBatValue = R_AIN2_DATA;
	        	chrgFullCount = 0;
	        }
	    	if(++chrgFullCount > 10000)
	    	{
	    		chrgFullFlag = 1;
	    		batValue = 100;
	    		chrgFullCount = 10000;
	    ...
	    else if(R_AIN2_DATA > 1285)		//3.45V 5%
	    {
	    	batValue = (R_AIN2_DATA - 1285)/17;
	    	batValue += 5;
	    }
	   	else if(R_AIN2_DATA > 1200)		//3.2V 0%
	    {
	    	batValue = (R_AIN2_DATA - 1200)/17;
	    }
	    else
	    {
	    	batValue = 0;
