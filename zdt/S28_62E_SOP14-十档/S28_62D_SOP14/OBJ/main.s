...
; 2 exit points
_00789_DS_:
	.line	836, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	MGOTO	_00789_DS_
	.line	838, "main.c"; 	}
	RETURN	
...
_F_AIN2_Convert:
; 2 exit points
	.line	819, "main.c"; 	void F_AIN2_Convert(char count)
	BANKSEL	r0x103F
	MOVAR	r0x103F
	.line	821, "main.c"; 	R_AIN2_DATA=R_AIN2_DATA_LB=0x00;   
	BANKSEL	_R_AIN2_DATA_LB
	CLRR	_R_AIN2_DATA_LB
	BANKSEL	_R_AIN2_DATA
	CLRR	_R_AIN2_DATA
	CLRR	(_R_AIN2_DATA + 1)
	.line	823, "main.c"; 	ADMD  = 0x90 | C_ADC_PA2;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x92
	MOVAR	_ADMD
	.line	824, "main.c"; 	delayms(200);	
	MOVIA	0xc8
	MCALL	_delayms
...
_00782_DS_:
	...
	MCALL	_F_wait_eoc
	.line	829, "main.c"; 	R_AIN2_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x1041
	BANKSEL	_R_AIN2_DATA_LB
	ADDAR	_R_AIN2_DATA_LB,F
	.line	830, "main.c"; 	R_AIN2_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x1041
	MOVAR	r0x1041
;;1	CLRR	r0x1042
...
_F_AIN4_Convert:
; 2 exit points
	.line	804, "main.c"; 	void F_AIN4_Convert(char count)
	BANKSEL	r0x1045
	MOVAR	r0x1045
	.line	806, "main.c"; 	R_AIN4_DATA=R_AIN4_DATA_LB=0x00;   
	BANKSEL	_R_AIN4_DATA_LB
	CLRR	_R_AIN4_DATA_LB
	BANKSEL	_R_AIN4_DATA
	CLRR	_R_AIN4_DATA
	CLRR	(_R_AIN4_DATA + 1)
	.line	808, "main.c"; 	ADMD  = 0x90 | C_ADC_PA4;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x94
	MOVAR	_ADMD
	.line	809, "main.c"; 	delayms(200);	
	MOVIA	0xc8
	MCALL	_delayms
...
_00773_DS_:
	...
	MCALL	_F_wait_eoc
	.line	814, "main.c"; 	R_AIN4_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x1047
	BANKSEL	_R_AIN4_DATA_LB
	ADDAR	_R_AIN4_DATA_LB,F
	.line	815, "main.c"; 	R_AIN4_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x1047
	MOVAR	r0x1047
;;1	CLRR	r0x1048
...
;;unsigned compare: left >= lit (0x6=6), size=1
	...
	MGOTO	_00708_DS_
_00702_DS_:
	.line	747, "main.c"; 	u8t maxAout = 45;
	MOVIA	0x2d
	BANKSEL	r0x104B
	MOVAR	r0x104B
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x1F=31), size=1
	.line	748, "main.c"; 	if(batValue > 30)
	MOVIA	0x1f
	BANKSEL	_batValue
	SUBAR	_batValue,W
	BTRSS	STATUS,0
	MGOTO	_00673_DS_
	.line	749, "main.c"; 	maxAout = 52;
	MOVIA	0x34
	BANKSEL	r0x104B
	MOVAR	r0x104B
_00673_DS_:
	.line	750, "main.c"; 	if(workStep == 1)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x01
	BTRSS	STATUS,2
	MGOTO	_00692_DS_
	.line	752, "main.c"; 	maxAout = maxAout - 10;
	MOVIA	0xf6
	BANKSEL	r0x104B
	ADDAR	r0x104B,F
	MGOTO	_00693_DS_
_00692_DS_:
	.line	754, "main.c"; 	else if(workStep == 2)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x02
	BTRSS	STATUS,2
	MGOTO	_00689_DS_
	.line	756, "main.c"; 	maxAout = maxAout - 8;
	MOVIA	0xf8
	BANKSEL	r0x104B
	ADDAR	r0x104B,F
	MGOTO	_00693_DS_
_00689_DS_:
	.line	758, "main.c"; 	else if(workStep == 3)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x03
	BTRSS	STATUS,2
	MGOTO	_00686_DS_
	.line	760, "main.c"; 	maxAout = maxAout - 3;
	MOVIA	0xfd
	BANKSEL	r0x104B
	ADDAR	r0x104B,F
	MGOTO	_00693_DS_
_00686_DS_:
	.line	762, "main.c"; 	else if(workStep == 4)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x04
	BTRSS	STATUS,2
	MGOTO	_00683_DS_
	.line	764, "main.c"; 	maxAout = maxAout + 2;
	BANKSEL	r0x104B
	INCR	r0x104B,F
	INCR	r0x104B,F
	MGOTO	_00693_DS_
_00683_DS_:
	.line	766, "main.c"; 	else if(workStep == 5)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x05
	BTRSS	STATUS,2
	MGOTO	_00680_DS_
	.line	768, "main.c"; 	maxAout = maxAout + 7;
	MOVIA	0x07
	BANKSEL	r0x104B
	ADDAR	r0x104B,F
	MGOTO	_00693_DS_
_00680_DS_:
	.line	770, "main.c"; 	else if(workStep == 6)
	BANKSEL	_workStep
	MOVR	_workStep,W
	XORIA	0x06
	BTRSS	STATUS,2
	MGOTO	_00677_DS_
	.line	772, "main.c"; 	maxAout = maxAout + 15;
	MOVIA	0x0f
	BANKSEL	r0x104B
	ADDAR	r0x104B,F
	MGOTO	_00693_DS_
...
_00677_DS_:
	.line	774, "main.c"; 	else if(workStep >= 7)
	MOVIA	0x07
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSS	STATUS,0
	MGOTO	_00693_DS_
	.line	776, "main.c"; 	maxAout = maxAout + 18;
	MOVIA	0x12
	BANKSEL	r0x104B
	ADDAR	r0x104B,F
_00693_DS_:
	.line	778, "main.c"; 	if(overCount > 0)
	BANKSEL	_overCount
	MOVR	_overCount,W
	BTRSS	STATUS,2
	.line	780, "main.c"; 	overCount--;
	DECR	_overCount,F
	.line	782, "main.c"; 	if(R_AIN4_DATA > maxAout)
	BANKSEL	r0x104B
	MOVR	r0x104B,W
	BANKSEL	r0x104C
	MOVAR	r0x104C
...
_00765_DS_:
	BTRSC	STATUS,0
	MGOTO	_00699_DS_
	.line	784, "main.c"; 	tempDuty = 70 + workStep*3;
	MOVIA	0x03
	MOVAR	STK00
	BANKSEL	_workStep
	MOVR	_workStep,W
...
_00699_DS_:
	.line	787, "main.c"; 	else if(R_AIN4_DATA < 75)
	MOVIA	0x00
	BANKSEL	_R_AIN4_DATA
	SUBAR	(_R_AIN4_DATA + 1),W
	BTRSS	STATUS,2
...
_00766_DS_:
	BTRSC	STATUS,0
	MGOTO	_00708_DS_
	.line	790, "main.c"; 	tempDuty = maxDuty;
	BANKSEL	_maxDuty
	MOVR	_maxDuty,W
	BANKSEL	_tempDuty
	MOVAR	_tempDuty
...
_00547_DS_:
	.line	603, "main.c"; 	else if(keyCount >= 2)
	MOVIA	0x02
	BANKSEL	_keyCount
	SUBAR	_keyCount,W
	BTRSS	STATUS,0
...
; 2 exit points
	...
	MOVIA	0x64
	SFUN	_TMR2
	.line	534, "main.c"; 	T2CR2 = C_TMR2_ClkSrc_Inst | C_PS2_Div4;	// Enable Prescaler1, Prescaler1 dividing rate = 1:2, Timer1 clock source is instruction clock 
	MOVIA	0x01
	SFUN	_T2CR2
...
_00485_DS_:
	...
	MGOTO	_00501_DS_
_00487_DS_:
	.line	435, "main.c"; 	if(++workStep > 10)
	BANKSEL	_workStep
	INCR	_workStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0xB=11), size=1
	...
	MOVAR	_workStep
_00489_DS_:
	.line	437, "main.c"; 	maxDuty = 38 + workStep*2;
	MOVIA	0x02
	MOVAR	STK00
	BANKSEL	_workStep
	MOVR	_workStep,W
...
_00491_DS_:
	...
	BANKSEL	_workStep
	MOVAR	_workStep
	.line	458, "main.c"; 	PWM2DUTY = 80;
	MOVIA	0x50
	SFUN	_PWM2DUTY
	.line	459, "main.c"; 	cDuty = 80;
	BANKSEL	_cDuty
	MOVAR	_cDuty
	.line	460, "main.c"; 	currentDuty = 80;
	BANKSEL	_currentDuty
	MOVAR	_currentDuty
	.line	461, "main.c"; 	maxDuty = 40;
	MOVIA	0x28
	BANKSEL	_maxDuty
	MOVAR	_maxDuty
...
;;unsigned compare: left < lit (0xA=10), size=1
	...
	MGOTO	_00313_DS_
_00310_DS_:
	.line	273, "main.c"; 	shiweiNum = 1;
	MOVIA	0x01
	BANKSEL	_shiweiNum
	MOVAR	_shiweiNum
	.line	274, "main.c"; 	geweiNum = 0;
	BANKSEL	_geweiNum
	CLRR	_geweiNum
_00313_DS_:
...
;	 1200+  372 =  1572 instructions ( 3888 byte)
