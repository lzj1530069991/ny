...
{	
        ...
        else if(R_AIN2_DATA < 1155)
        {
       	...
       	if(0x08 & PORTA)
       		batValue = batValue - 11 +  shiweiNum;
       	else if(batValue > 1)
       		batValue = batValue + 5 +  shiweiNum;
}
