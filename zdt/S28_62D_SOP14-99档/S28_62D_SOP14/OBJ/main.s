...
; 2 exit points
_00808_DS_:
	.line	843, "main.c"; 	while(ADMDbits.EOC==0)
	BTRSS	_ADMDbits,5
	MGOTO	_00808_DS_
	.line	845, "main.c"; 	}
	RETURN	
...
_F_AIN2_Convert:
; 2 exit points
	.line	826, "main.c"; 	void F_AIN2_Convert(char count)
	BANKSEL	r0x103F
	MOVAR	r0x103F
	.line	828, "main.c"; 	R_AIN2_DATA=R_AIN2_DATA_LB=0x00;   
	BANKSEL	_R_AIN2_DATA_LB
	CLRR	_R_AIN2_DATA_LB
	BANKSEL	_R_AIN2_DATA
	CLRR	_R_AIN2_DATA
	CLRR	(_R_AIN2_DATA + 1)
	.line	830, "main.c"; 	ADMD  = 0x90 | C_ADC_PA2;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x92
	MOVAR	_ADMD
	.line	831, "main.c"; 	delayms(200);	
	MOVIA	0xc8
	MCALL	_delayms
	.line	832, "main.c"; 	for(i=1;i<=count;i++)
	MOVIA	0x01
	BANKSEL	r0x1040
	MOVAR	r0x1040
_00801_DS_:
	...
	BTRSS	STATUS,0
	MGOTO	_00803_DS_
	.line	834, "main.c"; 	ADMDbits.START = 1;					// Start a ADC conversion session
	BSR	_ADMDbits,6
	.line	835, "main.c"; 	F_wait_eoc();							// Wait for ADC conversion complete
	MCALL	_F_wait_eoc
	.line	836, "main.c"; 	R_AIN2_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x1041
	BANKSEL	_R_AIN2_DATA_LB
	ADDAR	_R_AIN2_DATA_LB,F
	.line	837, "main.c"; 	R_AIN2_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x1041
	MOVAR	r0x1041
;;1	CLRR	r0x1042
...
_F_AIN4_Convert:
; 2 exit points
	.line	811, "main.c"; 	void F_AIN4_Convert(char count)
	BANKSEL	r0x1045
	MOVAR	r0x1045
	.line	813, "main.c"; 	R_AIN4_DATA=R_AIN4_DATA_LB=0x00;   
	BANKSEL	_R_AIN4_DATA_LB
	CLRR	_R_AIN4_DATA_LB
	BANKSEL	_R_AIN4_DATA
	CLRR	_R_AIN4_DATA
	CLRR	(_R_AIN4_DATA + 1)
	.line	815, "main.c"; 	ADMD  = 0x90 | C_ADC_PA4;				// Select AIN6(PB1) pad as ADC input
	MOVIA	0x94
	MOVAR	_ADMD
	.line	816, "main.c"; 	delayms(200);	
	MOVIA	0xc8
	MCALL	_delayms
...
_00792_DS_:
	...
	MCALL	_F_wait_eoc
	.line	821, "main.c"; 	R_AIN4_DATA_LB += ( 0x0F & ADR); 
	MOVIA	0x0f
	ANDAR	_ADR,W
;;3	MOVAR	r0x1047
	BANKSEL	_R_AIN4_DATA_LB
	ADDAR	_R_AIN4_DATA_LB,F
	.line	822, "main.c"; 	R_AIN4_DATA    += ADD; 
	MOVR	_ADD,W
	BANKSEL	r0x1047
	MOVAR	r0x1047
;;1	CLRR	r0x1048
...
_00673_DS_:
	.line	745, "main.c"; 	if(workStep < 10)
	MOVIA	0x0a
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
;;unsigned compare: left < lit (0x14=20), size=1
_00695_DS_:
	.line	749, "main.c"; 	else if(workStep < 20)
	MOVIA	0x14
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
_00692_DS_:
	.line	753, "main.c"; 	else if(workStep < 30)
	MOVIA	0x1e
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
;;unsigned compare: left < lit (0x28=40), size=1
_00689_DS_:
	.line	757, "main.c"; 	else if(workStep < 40)
	MOVIA	0x28
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
_00686_DS_:
	.line	761, "main.c"; 	else if(workStep < 50)
	MOVIA	0x32
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
_00683_DS_:
	.line	765, "main.c"; 	else if(workStep < 78)
	MOVIA	0x4e
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
_00680_DS_:
	.line	769, "main.c"; 	else if(workStep < 90)
	MOVIA	0x5a
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
;;unsigned compare: left < lit (0x64=100), size=1
_00677_DS_:
	.line	773, "main.c"; 	else if(workStep < 100)
	MOVIA	0x64
	BANKSEL	_workStep
	SUBAR	_workStep,W
	BTRSC	STATUS,0
...
;;shiftRight_Left2ResultLit:5673: shCount=1, size=1, sign=0, same=0, offr=0
	.line	783, "main.c"; 	tempDuty = 204 + workStep/2;
	BCR	STATUS,0
	BANKSEL	_workStep
	RRR	_workStep,W
	BANKSEL	r0x104B
...
_00785_DS_:
	...
	MOVAR	_tempDuty
_00709_DS_:
	.line	793, "main.c"; 	if(workStep%2 == 0)
	BANKSEL	_workStep
	BTRSC	_workStep,0
	MGOTO	_00712_DS_
	.line	795, "main.c"; 	TMRH = 0x00;
	CLRR	_TMRH
	.line	796, "main.c"; 	TMR2 = 255;
	MOVIA	0xff
	SFUN	_TMR2
	MGOTO	_00714_DS_
_00712_DS_:
	.line	800, "main.c"; 	TMR2 = 254;
	MOVIA	0xfe
	SFUN	_TMR2
_00714_DS_:
	.line	805, "main.c"; 	}
...
; 2 exit points
	...
	CLRR	_TMRH
	.line	531, "main.c"; 	TMR2 = 254;							//频率为110K
	MOVIA	0xfe
	SFUN	_TMR2
...
_00485_DS_:
	...
	MGOTO	_00501_DS_
_00487_DS_:
	.line	435, "main.c"; 	if(++workStep > 99)
	BANKSEL	_workStep
	INCR	_workStep,F
;;swapping arguments (AOP_TYPEs 1/3)
;;unsigned compare: left >= lit (0x64=100), size=1
...
;;shiftRight_Left2ResultLit:5673: shCount=1, size=1, sign=0, same=0, offr=0
_00489_DS_:
	.line	437, "main.c"; 	maxDuty = 100 + workStep/2;
	BCR	STATUS,0
	BANKSEL	_workStep
	RRR	_workStep,W
	BANKSEL	r0x1058
...
_00491_DS_:
	...
	BANKSEL	_workStep
	MOVAR	_workStep
	.line	458, "main.c"; 	PWM2DUTY = 210;
	MOVIA	0xd2
	SFUN	_PWM2DUTY
	.line	459, "main.c"; 	cDuty = 210;
	BANKSEL	_cDuty
	MOVAR	_cDuty
	.line	460, "main.c"; 	currentDuty = 210;
	BANKSEL	_currentDuty
	MOVAR	_currentDuty
	.line	461, "main.c"; 	maxDuty = 100;
	MOVIA	0x64
	BANKSEL	_maxDuty
	MOVAR	_maxDuty
...
;	 1218+  377 =  1595 instructions ( 3944 byte)
